...
class Edit_Agenda(qw, Ui_Form):
    ...
    def populate_agenda_table_row(self, row, agenda_item, base):
        ...
        if (
            ...
            and (
                sufffact_need_x == f"{self.deal_x._cure_handle},time,jajatime"
                or sufffact_need_x[:21] == f"{self.deal_x._cure_handle},time,jajatime"
            )
        ):
            ...
            text_x = f"{self.deal_x._cure_handle},time,jajatime"
            legible_x_text = (
