...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ally2tribe_weight_edit = QtWidgets.QLineEdit(Form)
        self.ally2tribe_weight_edit.setGeometry(QtCore.QRect(240, 690, 113, 21))
        self.ally2tribe_weight_edit.setObjectName("ally2tribe_weight_edit")
    ...
    def retranslateUi(self, Form):
        ...
        self.bd_add_button.setText(_translate("Form", "Add Tribe"))
        self.bd_remove_button.setText(_translate("Form", "Remove Tribe"))
        self.label.setText(_translate("Form", "Ally is member of these Tribes"))
        self.label_2.setText(_translate("Form", "Ally is not member of these Tribes"))
        ...
        self.update_weight_button.setText(
            _translate("Form", "Update Ally's Weight in Tribe to:")
        )
        self.bd_insert_button.setText(_translate("Form", "Create Tribe"))
        self.bd_delete_button.setText(_translate("Form", "Delete Tribe"))
        self.label_3.setText(_translate("Form", "New Tribe Name:"))
        self.label_4.setText(_translate("Form", "Change Tribe Name:"))
        self.bd_update_button.setText(_translate("Form", "Update Tribe"))
