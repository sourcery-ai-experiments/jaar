...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.display_problem_facts_cb = QtWidgets.QCheckBox(self.centralwidget)
        self.display_problem_facts_cb.setGeometry(QtCore.QRect(1520, 90, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.display_problem_facts_cb.setText(
            _translate("MainWindow", "Only Problem Facts")
        )
