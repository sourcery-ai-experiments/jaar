...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.problem_pid_text = QtWidgets.QLineEdit(Form)
        self.problem_pid_text.setGeometry(QtCore.QRect(80, 100, 391, 31))
        self.problem_pid_text.setObjectName("problem_pid_text")
        ...
        self.problem_pid_combo = QtWidgets.QComboBox(Form)
        self.problem_pid_combo.setGeometry(QtCore.QRect(80, 60, 391, 31))
        self.problem_pid_combo.setObjectName("problem_pid_combo")
        ...
        self.group1_pid_combo = QtWidgets.QComboBox(Form)
        self.group1_pid_combo.setGeometry(QtCore.QRect(80, 281, 291, 31))
        self.group1_pid_combo.setObjectName("group1_pid_combo")
        ...
        self.group2_pid_combo = QtWidgets.QComboBox(Form)
        self.group2_pid_combo.setGeometry(QtCore.QRect(80, 320, 291, 31))
        self.group2_pid_combo.setObjectName("group2_pid_combo")
        self.group3_pid_combo = QtWidgets.QComboBox(Form)
        self.group3_pid_combo.setGeometry(QtCore.QRect(80, 360, 291, 31))
        self.group3_pid_combo.setObjectName("group3_pid_combo")
