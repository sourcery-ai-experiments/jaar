...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.add_tribe_button = QtWidgets.QPushButton(Form)
        self.add_tribe_button.setGeometry(QtCore.QRect(500, 310, 161, 28))
        self.add_tribe_button.setObjectName("add_tribe_button")
        self.tribe1_name_combo = QtWidgets.QComboBox(Form)
        self.tribe1_name_combo.setGeometry(QtCore.QRect(80, 281, 291, 31))
        self.tribe1_name_combo.setObjectName("tribe1_name_combo")
        self.add_tribe_text = QtWidgets.QLineEdit(Form)
        self.add_tribe_text.setGeometry(QtCore.QRect(500, 280, 161, 31))
        self.add_tribe_text.setObjectName("add_tribe_text")
        ...
        self.tribe2_name_combo = QtWidgets.QComboBox(Form)
        self.tribe2_name_combo.setGeometry(QtCore.QRect(80, 320, 291, 31))
        self.tribe2_name_combo.setObjectName("tribe2_name_combo")
        self.tribe3_name_combo = QtWidgets.QComboBox(Form)
        self.tribe3_name_combo.setGeometry(QtCore.QRect(80, 360, 291, 31))
        self.tribe3_name_combo.setObjectName("tribe3_name_combo")
        self.label_9 = QtWidgets.QLabel(Form)
        self.label_9.setGeometry(QtCore.QRect(500, 350, 171, 41))
        self.label_9.setWordWrap(True)
        self.label_9.setObjectName("label_9")
        self.tribe1_weight_text = QtWidgets.QLineEdit(Form)
        self.tribe1_weight_text.setGeometry(QtCore.QRect(380, 280, 91, 31))
        self.tribe1_weight_text.setObjectName("tribe1_weight_text")
        self.label_10 = QtWidgets.QLabel(Form)
        self.label_10.setGeometry(QtCore.QRect(400, 260, 81, 21))
        self.label_10.setWordWrap(True)
        self.label_10.setObjectName("label_10")
        self.tribe2_weight_text = QtWidgets.QLineEdit(Form)
        self.tribe2_weight_text.setGeometry(QtCore.QRect(380, 320, 91, 31))
        self.tribe2_weight_text.setObjectName("tribe2_weight_text")
        self.tribe3_weight_text = QtWidgets.QLineEdit(Form)
        self.tribe3_weight_text.setGeometry(QtCore.QRect(380, 360, 91, 31))
        self.tribe3_weight_text.setObjectName("tribe3_weight_text")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "Which tribe is this for?"))
        self.add_tribe_button.setText(_translate("Form", "add Tribe"))
        self.label_6.setText(_translate("Form", "1."))
        self.label_7.setText(_translate("Form", "2."))
        self.label_8.setText(_translate("Form", "3."))
        self.label_9.setText(
            _translate("Form", "Add people to tribes in oter interface")
        )
