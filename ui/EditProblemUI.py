...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.problem_context_text.setObjectTitle("problem_context_text")
        self.agenda_table = QtWidgets.QTableWidget(Form)
        self.agenda_table.setGeometry(QtCore.QRect(750, 50, 651, 631))
        self.agenda_table.setObjectTitle("agenda_table")
        ...
        self.problem_title_text = QtWidgets.QLineEdit(Form)
        self.problem_title_text.setGeometry(QtCore.QRect(80, 100, 391, 31))
        self.problem_title_text.setObjectTitle("problem_title_text")
        ...
        self.problem_context_combo.setObjectTitle("problem_context_combo")
        self.problem_title_combo = QtWidgets.QComboBox(Form)
        self.problem_title_combo.setGeometry(QtCore.QRect(80, 60, 391, 31))
        self.problem_title_combo.setObjectTitle("problem_title_combo")
        self.add_group_button = QtWidgets.QPushButton(Form)
        self.add_group_button.setGeometry(QtCore.QRect(500, 310, 161, 28))
        self.add_group_button.setObjectTitle("add_group_button")
        self.group1_title_combo = QtWidgets.QComboBox(Form)
        self.group1_title_combo.setGeometry(QtCore.QRect(80, 281, 291, 31))
        self.group1_title_combo.setObjectTitle("group1_title_combo")
        self.add_group_text = QtWidgets.QLineEdit(Form)
        self.add_group_text.setGeometry(QtCore.QRect(500, 280, 161, 31))
        self.add_group_text.setObjectTitle("add_group_text")
        ...
        self.group2_title_combo = QtWidgets.QComboBox(Form)
        self.group2_title_combo.setGeometry(QtCore.QRect(80, 320, 291, 31))
        self.group2_title_combo.setObjectTitle("group2_title_combo")
        self.group3_title_combo = QtWidgets.QComboBox(Form)
        self.group3_title_combo.setGeometry(QtCore.QRect(80, 360, 291, 31))
        self.group3_title_combo.setObjectTitle("group3_title_combo")
        ...
        self.group1_weight_text.setObjectTitle("group1_weight_text")
        ...
        self.group2_weight_text.setObjectTitle("group2_weight_text")
        self.group3_weight_text = QtWidgets.QLineEdit(Form)
        self.group3_weight_text.setGeometry(QtCore.QRect(380, 360, 91, 31))
        self.group3_weight_text.setObjectTitle("group3_weight_text")
        ...
        self.load_problem_button.setObjectTitle("load_problem_button")
        ...
        self.view_problems_cb.setObjectTitle("view_problems_cb")
