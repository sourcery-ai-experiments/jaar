...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_agenda_tool_id_header = QtWidgets.QLabel(self.centralwidget)
        self.label_agenda_tool_id_header.setGeometry(QtCore.QRect(30, 750, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_agenda_tool_id_header.setFont(font)
        self.label_agenda_tool_id_header.setObjectName("label_agenda_tool_id_header")
        ...
        self.label_agenda_tool_id_data = QtWidgets.QLabel(self.centralwidget)
        self.label_agenda_tool_id_data.setGeometry(QtCore.QRect(130, 750, 221, 41))
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        font.setWeight(75)
        self.label_agenda_tool_id_data.setFont(font)
        self.label_agenda_tool_id_data.setObjectName("label_agenda_tool_id_data")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_agenda_tool_id_header.setText(_translate("MainWindow", "Tool_id:"))
        ...
        self.label_agenda_tool_id_data.setText(_translate("MainWindow", "Tool_id:"))
