...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_goal_deescription_header = QtWidgets.QLabel(self.centralwidget)
        self.label_goal_deescription_header.setGeometry(QtCore.QRect(30, 310, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_goal_deescription_header.setFont(font)
        self.label_goal_deescription_header.setObjectName(
            "label_goal_deescription_header"
        )
        ...
        self.goal_current = QtWidgets.QPushButton(self.centralwidget)
        self.goal_current.setGeometry(QtCore.QRect(250, 270, 141, 30))
        self.goal_current.setObjectName("goal_current")
        ...
        self.label_goal_idea_id_header = QtWidgets.QLabel(self.centralwidget)
        self.label_goal_idea_id_header.setGeometry(QtCore.QRect(30, 750, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_goal_idea_id_header.setFont(font)
        self.label_goal_idea_id_header.setObjectName("label_goal_idea_id_header")
        self.label_goal_deescription_data = QtWidgets.QLabel(self.centralwidget)
        self.label_goal_deescription_data.setGeometry(QtCore.QRect(80, 350, 681, 71))
        font = QtGui.QFont()
        font.setPointSize(36)
        self.label_goal_deescription_data.setFont(font)
        self.label_goal_deescription_data.setText("")
        self.label_goal_deescription_data.setWordWrap(True)
        self.label_goal_deescription_data.setObjectName("label_goal_deescription_data")
        ...
        self.label_goal_idea_id_data = QtWidgets.QLabel(self.centralwidget)
        self.label_goal_idea_id_data.setGeometry(QtCore.QRect(130, 750, 221, 41))
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        font.setWeight(75)
        self.label_goal_idea_id_data.setFont(font)
        self.label_goal_idea_id_data.setObjectName("label_goal_idea_id_data")
        ...
        self.goal_states.setGeometry(QtCore.QRect(1290, 30, 381, 621))
        self.goal_states.setSizeAdjustPolicy(
            QtWidgets.QAbstractScrollArea.AdjustToContents
        )
        self.goal_states.setObjectName("goal_states")
        self.goal_states.setColumnCount(5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_goal_deescription_header.setText(
        ...
        self.goal_current.setText(_translate("MainWindow", "view current goal"))
        ...
        self.label_goal_idea_id_header.setText(_translate("MainWindow", "Idea_id:"))
        ...
        self.label_goal_idea_id_data.setText(_translate("MainWindow", "Idea_id:"))
