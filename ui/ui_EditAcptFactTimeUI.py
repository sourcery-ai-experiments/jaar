...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(
            _translate(
                "Form", "Reset Current Date for entire toolunit (American calendar)"
            )
        )
        ...
        self.label_7.setText(
            _translate(
                "Form", "Reset Current Date for entire toolunit (My Day Listing)"
            )
        )
        ...
        self.label_10.setText(
            _translate(
                "Form", "Reset Previous Date for entire toolunit (My Day Listing)"
            )
        )
        ...
        self.label_14.setText(
            _translate(
                "Form", "Reset Previous Date for entire toolunit (American calendar)"
            )
        )
