...
# Form implementation generated from reading ui file 'c:\dev\reddibrush\ui\EditBeliefTimeUI.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(663, 702)
        self.now_year = QtWidgets.QComboBox(Form)
        self.now_year.setGeometry(QtCore.QRect(20, 100, 73, 22))
        self.now_year.setObjectName("now_year")
        ...
        self.now_american_update = QtWidgets.QPushButton(Form)
        self.now_american_update.setGeometry(QtCore.QRect(100, 140, 381, 41))
        self.now_american_update.setObjectName("now_american_update")
        self.now_month = QtWidgets.QComboBox(Form)
        self.now_month.setGeometry(QtCore.QRect(100, 100, 141, 22))
        self.now_month.setObjectName("now_month")
        self.now_monthday = QtWidgets.QComboBox(Form)
        self.now_monthday.setGeometry(QtCore.QRect(250, 100, 73, 22))
        self.now_monthday.setObjectName("now_monthday")
        self.now_hour = QtWidgets.QComboBox(Form)
        self.now_hour.setGeometry(QtCore.QRect(330, 100, 73, 22))
        self.now_hour.setObjectName("now_hour")
        self.now_min = QtWidgets.QComboBox(Form)
        self.now_min.setGeometry(QtCore.QRect(410, 100, 73, 22))
        self.now_min.setObjectName("now_min")
        ...
        self.now_local_update = QtWidgets.QPushButton(self.frame)
        self.now_local_update.setGeometry(QtCore.QRect(100, 80, 381, 41))
        self.now_local_update.setObjectName("now_local_update")
        self.label_9 = QtWidgets.QLabel(self.frame)
        self.label_9.setGeometry(QtCore.QRect(150, 30, 121, 16))
        self.label_9.setObjectName("label_9")
        self.now_day_id = QtWidgets.QComboBox(self.frame)
        self.now_day_id.setGeometry(QtCore.QRect(20, 50, 101, 22))
        self.now_day_id.setObjectName("now_day_id")
        self.now_daymin_id = QtWidgets.QComboBox(self.frame)
        self.now_daymin_id.setGeometry(QtCore.QRect(150, 50, 81, 22))
        self.now_daymin_id.setObjectName("now_daymin_id")
        ...
        self.label_5.raise_()
        self.label_6.raise_()
        self.now_american_update.raise_()
        self.now_month.raise_()
        self.now_monthday.raise_()
        self.now_hour.raise_()
        self.now_min.raise_()
        self.label_7.raise_()
        self.label_8.raise_()
    ...
    def retranslateUi(self, Form):
        ...
        self.now_american_update.setText(
            _translate("Form", "Use American Dates to modify Current Date")
        )
        ...
        self.now_local_update.setText(
            _translate("Form", "Use Local Structure Dates to modify Current Date")
        )
        ...
        self.prev_local_update.setText(
            _translate("Form", "Use Local Structure Dates to modify Previous Date")
        )
        ...
        self.prev_american_update.setText(
            _translate("Form", "Use American Dates to modify Previous Date")
        )
