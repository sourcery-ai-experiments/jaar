...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.oaths_table.setGeometry(QtCore.QRect(10, 310, 171, 381))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oaths_table.setFont(font)
        ...
        self.oath_update_button.setGeometry(QtCore.QRect(10, 240, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath_update_button.setFont(font)
        self.oath_update_button.setObjectName("oath_update_button")
        self.oath_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_insert_button.setGeometry(QtCore.QRect(10, 210, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath_insert_button.setFont(font)
        self.oath_insert_button.setObjectName("oath_insert_button")
        self.oath_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_delete_button.setGeometry(QtCore.QRect(80, 270, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath_delete_button.setFont(font)
        self.oath_delete_button.setObjectName("oath_delete_button")
        self.oath_healer = QtWidgets.QLineEdit(self.centralwidget)
        self.oath_healer.setGeometry(QtCore.QRect(10, 180, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath_healer.setFont(font)
        ...
        self.oath_edit_button.setGeometry(QtCore.QRect(10, 270, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath_edit_button.setFont(font)
        ...
        self.set_public_oath_button = QtWidgets.QPushButton(self.centralwidget)
        self.set_public_oath_button.setGeometry(QtCore.QRect(190, 640, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.set_public_oath_button.setFont(font)
        self.set_public_oath_button.setObjectName("set_public_oath_button")
        self.reload_all_src_oaths_button = QtWidgets.QPushButton(self.centralwidget)
        self.reload_all_src_oaths_button.setGeometry(QtCore.QRect(190, 620, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.reload_all_src_oaths_button.setFont(font)
        self.reload_all_src_oaths_button.setObjectName("reload_all_src_oaths_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.oath_delete_button.setText(_translate("MainWindow", "Delete"))
        ...
        self.depotlink_update_button.setText(
            _translate("MainWindow", "Update OathLink")
        )
        self.refresh_all_button.setText(_translate("MainWindow", "refresh"))
        self.oath_edit_button.setText(_translate("MainWindow", "Edit "))
        ...
        self.label.setText(_translate("MainWindow", "Oathlink Weight:"))
        ...
        self.set_public_oath_button.setText(
            _translate("MainWindow", "output_oath to public_dir")
        )
        self.reload_all_src_oaths_button.setText(
            _translate("MainWindow", "refresh_all_src_oaths")
        )
