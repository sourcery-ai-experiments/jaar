...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gp_party2belief_delete_button = QtWidgets.QPushButton(Form)
        self.gp_party2belief_delete_button.setGeometry(QtCore.QRect(500, 200, 111, 61))
        self.gp_party2belief_delete_button.setObjectName(
            "gp_party2belief_delete_button"
        )
        ...
        self.party2belief_weight_edit = QtWidgets.QLineEdit(Form)
        self.party2belief_weight_edit.setGeometry(QtCore.QRect(240, 690, 113, 21))
        self.party2belief_weight_edit.setObjectName("party2belief_weight_edit")
    ...
    def retranslateUi(self, Form):
        ...
        self.gp_party2belief_delete_button.setText(_translate("Form", "Abolish Belief"))
        self.label.setText(_translate("Form", "Party is party of these Beliefs"))
        self.label_2.setText(_translate("Form", "Party is not party of these Beliefs"))
        ...
        self.update_weight_button.setText(
            _translate("Form", "Update Party's Weight in Belief to:")
        )
