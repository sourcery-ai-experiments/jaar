...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gp_party2group_delete_button = QtWidgets.QPushButton(Form)
        self.gp_party2group_delete_button.setGeometry(QtCore.QRect(500, 200, 111, 61))
        self.gp_party2group_delete_button.setObjectName("gp_party2group_delete_button")
    ...
    def retranslateUi(self, Form):
        ...
        self.gp_party2group_delete_button.setText(_translate("Form", "Abolish Group"))
        ...
        self.label_3.setText(_translate("Form", "New Group PID:"))
        self.label_4.setText(_translate("Form", "Modification Group PID:"))
