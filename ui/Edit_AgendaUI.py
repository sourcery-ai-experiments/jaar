...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cb_beliefbase_display = QtWidgets.QCheckBox(Form)
        self.cb_beliefbase_display.setGeometry(QtCore.QRect(910, 20, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.cb_beliefbase_display.setFont(font)
        self.cb_beliefbase_display.setObjectName("cb_beliefbase_display")
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "BeliefBase_display"))
        self.label_13.setText(
            _translate("Form", "Select what it to be done immediately")
        )
        self.label_6.setText(_translate("Form", "Belief Base:"))
        self.cb_beliefbase_display.setText(
            _translate("Form", "Display beliefbase/open/nigh")
        )
