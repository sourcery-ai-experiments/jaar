...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.intent_table.setColumnCount(9)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.intent_table.setHorizontalHeaderItem(8, item)
        ...
        self.cb_factbase_display = QtWidgets.QCheckBox(Form)
        self.cb_factbase_display.setGeometry(QtCore.QRect(910, 20, 211, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.cb_factbase_display.setFont(font)
        self.cb_factbase_display.setObjectName("cb_factbase_display")
    ...
    def retranslateUi(self, Form):
        ...
        item = self.intent_table.horizontalHeaderItem(8)
        item.setText(_translate("Form", "FactBase_display"))
        self.label_13.setText(
            _translate("Form", "Select what it to be done immediately")
        )
        self.label_6.setText(_translate("Form", "Fact Base:"))
        self.cb_factbase_display.setText(
            _translate("Form", "Display factbase/open/nigh")
        )
