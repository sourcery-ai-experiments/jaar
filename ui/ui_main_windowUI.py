...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_intent_oath_id_header = QtWidgets.QLabel(self.centralwidget)
        self.label_intent_oath_id_header.setGeometry(QtCore.QRect(30, 750, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_intent_oath_id_header.setFont(font)
        self.label_intent_oath_id_header.setObjectName("label_intent_oath_id_header")
        ...
        self.label_intent_oath_id_data = QtWidgets.QLabel(self.centralwidget)
        self.label_intent_oath_id_data.setGeometry(QtCore.QRect(130, 750, 221, 41))
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        font.setWeight(75)
        self.label_intent_oath_id_data.setFont(font)
        self.label_intent_oath_id_data.setObjectName("label_intent_oath_id_data")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Manuparty modification"))
        ...
        self.label_intent_oath_id_header.setText(_translate("MainWindow", "Oath_id:"))
        ...
        self.label_intent_oath_id_data.setText(_translate("MainWindow", "Oath_id:"))
