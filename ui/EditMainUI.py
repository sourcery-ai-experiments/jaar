...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.open_brandedit_button = QtWidgets.QPushButton(Form)
        self.open_brandedit_button.setGeometry(QtCore.QRect(430, 60, 161, 31))
        self.open_brandedit_button.setObjectName("open_brandedit_button")
    ...
    def retranslateUi(self, Form):
        ...
        self.open_brandedit_button.setText(_translate("Form", "Open Brand Edit"))
