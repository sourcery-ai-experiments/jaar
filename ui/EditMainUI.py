...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.guy_list = QtWidgets.QTableWidget(Form)
        self.guy_list.setGeometry(QtCore.QRect(420, 100, 261, 591))
        self.guy_list.setObjectName("guy_list")
        self.guy_list.setColumnCount(0)
        self.guy_list.setRowCount(0)
