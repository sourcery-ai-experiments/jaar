...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ally_list = QtWidgets.QTableWidget(Form)
        self.ally_list.setGeometry(QtCore.QRect(420, 100, 261, 591))
        self.ally_list.setObjectName("ally_list")
        self.ally_list.setColumnCount(0)
        self.ally_list.setRowCount(0)
        self.open_tribeedit_button = QtWidgets.QPushButton(Form)
        self.open_tribeedit_button.setGeometry(QtCore.QRect(430, 60, 161, 31))
        self.open_tribeedit_button.setObjectName("open_tribeedit_button")
    ...
    def retranslateUi(self, Form):
        ...
        self.open_tribeedit_button.setText(_translate("Form", "Open Tribe Edit"))
