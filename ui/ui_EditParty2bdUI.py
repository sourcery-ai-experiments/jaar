...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gp_party2idea_delete_button = QtWidgets.QPushButton(Form)
        self.gp_party2idea_delete_button.setGeometry(QtCore.QRect(500, 200, 111, 61))
        self.gp_party2idea_delete_button.setObjectName("gp_party2idea_delete_button")
        ...
        self.party2idea_weight_edit = QtWidgets.QLineEdit(Form)
        self.party2idea_weight_edit.setGeometry(QtCore.QRect(240, 690, 113, 21))
        self.party2idea_weight_edit.setObjectName("party2idea_weight_edit")
    ...
    def retranslateUi(self, Form):
        ...
        self.gp_add_button.setText(_translate("Form", "Add Idea"))
        self.gp_party2idea_delete_button.setText(_translate("Form", "Abolish Idea"))
        self.label.setText(_translate("Form", "Party is party of these Ideas"))
        self.label_2.setText(_translate("Form", "Party is not party of these Ideas"))
        ...
        self.update_weight_button.setText(
            _translate("Form", "Update Party's Weight in Idea to:")
        )
        self.gp_insert_button.setText(_translate("Form", "Create Idea"))
        self.gp_delete_button.setText(_translate("Form", "Delete Idea"))
        self.label_3.setText(_translate("Form", "New Idea PID:"))
        self.label_4.setText(_translate("Form", "Modification Idea PID:"))
        self.gp_update_button.setText(_translate("Form", "Update Idea"))
