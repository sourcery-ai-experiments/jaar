...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actors_table = QtWidgets.QTableWidget(self.centralwidget)
        self.actors_table.setGeometry(QtCore.QRect(190, 190, 141, 430))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.actors_table.setFont(font)
        self.actors_table.setObjectName("actors_table")
        self.actors_table.setColumnCount(2)
        self.actors_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.actors_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.actors_table.setHorizontalHeaderItem(1, item)
        ...
        self.economy_name = QtWidgets.QLineEdit(self.centralwidget)
        self.economy_name.setGeometry(QtCore.QRect(20, 20, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.economy_name.setFont(font)
        self.economy_name.setObjectName("economy_name")
        ...
        self.contract_name = QtWidgets.QLineEdit(self.centralwidget)
        self.contract_name.setGeometry(QtCore.QRect(10, 180, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.contract_name.setFont(font)
        self.contract_name.setObjectName("contract_name")
        self.actor_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.actor_update_button.setGeometry(QtCore.QRect(190, 130, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.actor_update_button.setFont(font)
        self.actor_update_button.setObjectName("actor_update_button")
        self.actor_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.actor_insert_button.setGeometry(QtCore.QRect(190, 100, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.actor_insert_button.setFont(font)
        self.actor_insert_button.setObjectName("actor_insert_button")
        self.actor_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.actor_delete_button.setGeometry(QtCore.QRect(240, 40, 91, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.actor_delete_button.setFont(font)
        self.actor_delete_button.setObjectName("actor_delete_button")
        self.actor_name = QtWidgets.QLineEdit(self.centralwidget)
        self.actor_name.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.actor_edit_button = QtWidgets.QPushButton(self.centralwidget)
        self.actor_edit_button.setGeometry(QtCore.QRect(190, 160, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.actor_edit_button.setFont(font)
        self.actor_edit_button.setObjectName("actor_edit_button")
        ...
        self.economy_name_combo = QtWidgets.QComboBox(self.centralwidget)
        self.economy_name_combo.setGeometry(QtCore.QRect(20, 110, 141, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.economy_name_combo.setFont(font)
        self.economy_name_combo.setObjectName("economy_name_combo")
        ...
        self.economy_copy_button.setObjectName("economy_copy_button")
        ...
        self.economy_load_button.setObjectName("economy_load_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.actors_table.horizontalHeaderItem(0)
        ...
        self.economy_update_button.setText(_translate("MainWindow", "Change Name"))
        self.contract_update_button.setText(
            _translate("MainWindow", "Change Contract Name")
        )
        ...
        self.actor_update_button.setText(_translate("MainWindow", "Change Actor Name"))
        self.actor_insert_button.setText(_translate("MainWindow", "Add new Actor"))
        self.actor_delete_button.setText(_translate("MainWindow", "delete Actor"))
