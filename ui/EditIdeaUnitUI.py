...
# Form implementation generated from reading ui file 'ui\EditIdeaUnitUI.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.submit_child_insert.setObjectTitle("submit_child_insert")
        self.submit_node_update = QtWidgets.QPushButton(Form)
        self.submit_node_update.setGeometry(QtCore.QRect(700, 800, 171, 26))
        self.submit_node_update.setObjectTitle("submit_node_update")
        ...
        self.label_parent_id.setObjectTitle("label_parent_id")
        ...
        self.submit_node_delete.setObjectTitle("submit_node_delete")
        ...
        self.idea2group_table.setObjectTitle("idea2group_table")
        ...
        self.idea2group_delete_button.setObjectTitle("idea2group_delete_button")
        ...
        self.idea2group_insert_button.setObjectTitle("idea2group_insert_button")
        ...
        self.idea2group_insert_combo.setObjectTitle("idea2group_insert_combo")
        self.cb_rootrank = QtWidgets.QCheckBox(Form)
        self.cb_rootrank.setGeometry(QtCore.QRect(100, 20, 100, 20))
        self.cb_rootrank.setObjectTitle("cb_rootrank")
        self.cb_yo_id = QtWidgets.QCheckBox(Form)
        self.cb_yo_id.setGeometry(QtCore.QRect(100, 40, 100, 20))
        self.cb_yo_id.setObjectTitle("cb_yo_id")
        self.cb_yo2bd_count = QtWidgets.QCheckBox(Form)
        self.cb_yo2bd_count.setGeometry(QtCore.QRect(100, 60, 100, 20))
        self.cb_yo2bd_count.setObjectTitle("cb_yo2bd_count")
        self.cb_yo_agenda = QtWidgets.QCheckBox(Form)
        self.cb_yo_agenda.setGeometry(QtCore.QRect(320, 40, 91, 20))
        self.cb_yo_agenda.setObjectTitle("cb_yo_agenda")
        ...
        self.required_base_combo.setObjectTitle("required_base_combo")
        self.required_table = QtWidgets.QTableWidget(Form)
        self.required_table.setGeometry(QtCore.QRect(580, 520, 841, 250))
        self.required_table.setObjectTitle("required_table")
        self.required_table.setColumnCount(11)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.required_table.setHorizontalHeaderItem(10, item)
        self.cb_requiredheir_count = QtWidgets.QCheckBox(Form)
        self.cb_requiredheir_count.setGeometry(QtCore.QRect(430, 20, 121, 20))
        self.cb_requiredheir_count.setObjectTitle("cb_requiredheir_count")
        self.cb_required_count = QtWidgets.QCheckBox(Form)
        self.cb_required_count.setGeometry(QtCore.QRect(430, 40, 121, 20))
        self.cb_required_count.setObjectTitle("cb_required_count")
        self.cb_required_view = QtWidgets.QCheckBox(Form)
        self.cb_required_view.setGeometry(QtCore.QRect(10, 70, 61, 20))
        self.cb_required_view.setObjectTitle("cb_required_view")
        self.combo_dim_root = QtWidgets.QComboBox(Form)
        self.combo_dim_root.setGeometry(QtCore.QRect(80, 80, 481, 22))
        self.combo_dim_root.setObjectTitle("combo_dim_root")
        self.prom_l_03 = QtWidgets.QLabel(Form)
        self.prom_l_03.setGeometry(QtCore.QRect(580, 400, 41, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.prom_l_03.setFont(font)
        self.prom_l_03.setObjectTitle("prom_l_03")
        ...
        self.prom_l_02.setObjectTitle("prom_l_02")
        ...
        self.button_required_upsert.setObjectTitle("button_required_upsert")
        ...
        self.yo_begin.setObjectTitle("yo_begin")
        ...
        self.yo_close.setObjectTitle("yo_close")
        ...
        self.yo_walk = QtWidgets.QTextEdit(Form)
        self.yo_walk.setGeometry(QtCore.QRect(680, 70, 341, 51))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.yo_walk.setFont(font)
        self.yo_walk.setObjectTitle("yo_walk")
        ...
        self.create_hreg_button.setObjectTitle("create_hreg_button")
        ...
        self.required_sufffact_combo.setObjectTitle("required_sufffact_combo")
        ...
        self.required_sufffact_open.setObjectTitle("required_sufffact_open")
        ...
        self.required_sufffact_nigh.setObjectTitle("required_sufffact_nigh")
        ...
        self.required_sufffact_divisor.setObjectTitle("required_sufffact_divisor")
        ...
        self.button_required_delete.setObjectTitle("button_required_delete")
        ...
        self.yo_task_status.setObjectTitle("yo_task_status")
        ...
        self.yo_range_source_road.setObjectTitle("yo_range_source_road")
        self.label_21 = QtWidgets.QLabel(Form)
        self.label_21.setGeometry(QtCore.QRect(580, 340, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_21.setFont(font)
        self.label_21.setObjectTitle("label_21")
        ...
        self.required_sufffact_open_combo.setObjectTitle("required_sufffact_open_combo")
        ...
        self.required_sufffact_nigh_combo.setObjectTitle("required_sufffact_nigh_combo")
        ...
        self.required_sufffact_divisor_combo.setObjectTitle(
        ...
        self.button_hreg_base.setObjectTitle("button_hreg_base")
        ...
        self.hreg_days_repeat.setObjectTitle("hreg_days_repeat")
        self.label_25 = QtWidgets.QLabel(Form)
        self.label_25.setGeometry(QtCore.QRect(1530, 350, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_25.setFont(font)
        self.label_25.setObjectTitle("label_25")
        ...
        self.hreg_months_repeat.setObjectTitle("hreg_months_repeat")
        ...
        self.hreg_year_month.setObjectTitle("hreg_year_month")
        ...
        self.hreg_year_monthday.setObjectTitle("hreg_year_monthday")
        self.label_35 = QtWidgets.QLabel(Form)
        self.label_35.setGeometry(QtCore.QRect(1720, 440, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_35.setFont(font)
        self.label_35.setObjectTitle("label_35")
        ...
        self.button_sufffactunit_hreg_update_weeks.setObjectTitle(
        ...
        self.hreg_weeks_remainder.setObjectTitle("hreg_weeks_remainder")
        ...
        self.hreg_days_remainder.setObjectTitle("hreg_days_remainder")
        self.label_30 = QtWidgets.QLabel(Form)
        self.label_30.setGeometry(QtCore.QRect(1660, 350, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_30.setFont(font)
        self.label_30.setObjectTitle("label_30")
        ...
        self.button_sufffactunit_hreg_update_days.setObjectTitle(
        ...
        self.yo_problem_bool_cb.setObjectTitle("yo_problem_bool_cb")
        self.cb_acptfactheir_view = QtWidgets.QCheckBox(Form)
        self.cb_acptfactheir_view.setGeometry(QtCore.QRect(10, 90, 71, 20))
        self.cb_acptfactheir_view.setObjectTitle("cb_acptfactheir_view")
        self.cb_yo_acptfactheir_count = QtWidgets.QCheckBox(Form)
        self.cb_yo_acptfactheir_count.setGeometry(QtCore.QRect(430, 60, 101, 20))
        self.cb_yo_acptfactheir_count.setObjectTitle("cb_yo_acptfactheir_count")
        self.yo_active_status = QtWidgets.QTextEdit(Form)
        self.yo_active_status.setGeometry(QtCore.QRect(930, 220, 91, 26))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.yo_active_status.setFont(font)
        self.yo_active_status.setObjectTitle("yo_active_status")
        self.label_36 = QtWidgets.QLabel(Form)
        self.label_36.setGeometry(QtCore.QRect(860, 220, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.label_36.setFont(font)
        self.label_36.setObjectTitle("label_36")
        self.button_view_requiredheirs = QtWidgets.QPushButton(Form)
        self.button_view_requiredheirs.setGeometry(QtCore.QRect(1430, 520, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.button_view_requiredheirs.setFont(font)
        self.button_view_requiredheirs.setObjectTitle("button_view_requiredheirs")
        self.requiredheir_table = QtWidgets.QTableWidget(Form)
        self.requiredheir_table.setGeometry(QtCore.QRect(580, 600, 1171, 171))
        self.requiredheir_table.setObjectTitle("requiredheir_table")
        self.requiredheir_table.setColumnCount(11)
        self.requiredheir_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.requiredheir_table.setHorizontalHeaderItem(10, item)
        self.submit_duty_insert = QtWidgets.QPushButton(Form)
        self.submit_duty_insert.setGeometry(QtCore.QRect(1190, 800, 171, 26))
        self.submit_duty_insert.setObjectTitle("submit_duty_insert")
    ...
    def retranslateUi(self, Form):
        ...
        self.cb_yo_agenda.setText(_translate("Form", "lf agenda"))
        ...
        self.cb_yo_agenda_current.setText(_translate("Form", "Agenda"))
        ...
        self.cb_yo_acptfactunit_count.setText(_translate("Form", "acptfactunits"))
        self.cb_yo_acptfactunit_time.setText(_translate("Form", "time acptfactunit"))
        ...
        item = self.required_table.horizontalHeaderItem(10)
        item.setText(_translate("Form", "11"))
        self.cb_requiredheir_count.setText(_translate("Form", "RequiredHeir count"))
        self.cb_required_count.setText(_translate("Form", "RequiredUnit count"))
        self.cb_required_view.setText(_translate("Form", "Required:"))
        self.prom_l_03.setText(_translate("Form", "SuffFact"))
        ...
        self.cb_acptfactheir_view.setText(_translate("Form", "AcptFactheir:"))
        self.cb_yo_acptfactheir_count.setText(_translate("Form", "acptfactheirs"))
        self.label_36.setText(_translate("Form", "Active Status:"))
        self.button_view_requiredheirs.setText(_translate("Form", "view RequiredHeirs"))
        item = self.requiredheir_table.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Required Base"))
        item = self.requiredheir_table.horizontalHeaderItem(1)
        item.setText(_translate("Form", "SuffFact"))
        item = self.requiredheir_table.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Base"))
        item = self.requiredheir_table.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Need"))
        item = self.requiredheir_table.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Open"))
        item = self.requiredheir_table.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Nigh"))
        item = self.requiredheir_table.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Divisor"))
        item = self.requiredheir_table.horizontalHeaderItem(7)
        item.setText(_translate("Form", "empty"))
        item = self.requiredheir_table.horizontalHeaderItem(8)
        item.setText(_translate("Form", "Limt_status"))
        item = self.requiredheir_table.horizontalHeaderItem(9)
        item.setText(_translate("Form", "SuffFact_status"))
        item = self.requiredheir_table.horizontalHeaderItem(10)
        item.setText(_translate("Form", "11"))
