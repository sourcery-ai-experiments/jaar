...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.idea2tribe_table = QtWidgets.QTableWidget(Form)
        self.idea2tribe_table.setGeometry(QtCore.QRect(1050, 80, 381, 191))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.idea2tribe_table.setFont(font)
        self.idea2tribe_table.setObjectName("idea2tribe_table")
        self.idea2tribe_table.setColumnCount(3)
        self.idea2tribe_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.idea2tribe_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.idea2tribe_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.idea2tribe_table.setHorizontalHeaderItem(2, item)
        self.idea2tribe_delete_button = QtWidgets.QPushButton(Form)
        self.idea2tribe_delete_button.setGeometry(QtCore.QRect(1440, 80, 131, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.idea2tribe_delete_button.setFont(font)
        self.idea2tribe_delete_button.setObjectName("idea2tribe_delete_button")
        self.idea2tribe_insert_button = QtWidgets.QPushButton(Form)
        self.idea2tribe_insert_button.setGeometry(QtCore.QRect(1050, 50, 141, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.idea2tribe_insert_button.setFont(font)
        self.idea2tribe_insert_button.setObjectName("idea2tribe_insert_button")
        self.idea2tribe_insert_combo = QtWidgets.QComboBox(Form)
        self.idea2tribe_insert_combo.setGeometry(QtCore.QRect(1200, 50, 231, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.idea2tribe_insert_combo.setFont(font)
        self.idea2tribe_insert_combo.setObjectName("idea2tribe_insert_combo")
    ...
    def retranslateUi(self, Form):
        ...
        item = self.idea2tribe_table.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Tribe_ID"))
        item = self.idea2tribe_table.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Tribe"))
        item = self.idea2tribe_table.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Member Count"))
        self.idea2tribe_delete_button.setText(_translate("Form", "De-link Tribe"))
        self.idea2tribe_insert_button.setText(_translate("Form", "Add Tribe to Idea"))
        self.cb_rootrank.setText(_translate("Form", "root rank"))
        self.cb_yo_id.setText(_translate("Form", "uid"))
        self.cb_yo2bd_count.setText(_translate("Form", "Tribe count"))
