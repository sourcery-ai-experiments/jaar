...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.oath2idea_table = QtWidgets.QTableWidget(Form)
        self.oath2idea_table.setGeometry(QtCore.QRect(1050, 80, 381, 191))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath2idea_table.setFont(font)
        self.oath2idea_table.setObjectName("oath2idea_table")
        self.oath2idea_table.setColumnCount(3)
        self.oath2idea_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.oath2idea_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.oath2idea_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.oath2idea_table.setHorizontalHeaderItem(2, item)
        self.oath2idea_delete_button = QtWidgets.QPushButton(Form)
        self.oath2idea_delete_button.setGeometry(QtCore.QRect(1440, 80, 131, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath2idea_delete_button.setFont(font)
        self.oath2idea_delete_button.setObjectName("oath2idea_delete_button")
        self.oath2idea_insert_button = QtWidgets.QPushButton(Form)
        self.oath2idea_insert_button.setGeometry(QtCore.QRect(1050, 50, 141, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath2idea_insert_button.setFont(font)
        self.oath2idea_insert_button.setObjectName("oath2idea_insert_button")
        self.oath2idea_insert_combo = QtWidgets.QComboBox(Form)
        self.oath2idea_insert_combo.setGeometry(QtCore.QRect(1200, 50, 231, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.oath2idea_insert_combo.setFont(font)
        self.oath2idea_insert_combo.setObjectName("oath2idea_insert_combo")
        ...
        self.cb_yo_beliefunit_count = QtWidgets.QCheckBox(Form)
        self.cb_yo_beliefunit_count.setGeometry(QtCore.QRect(210, 60, 101, 20))
        self.cb_yo_beliefunit_count.setObjectName("cb_yo_beliefunit_count")
        self.cb_yo_beliefunit_time = QtWidgets.QCheckBox(Form)
        self.cb_yo_beliefunit_time.setGeometry(QtCore.QRect(320, 60, 111, 20))
        self.cb_yo_beliefunit_time.setObjectName("cb_yo_beliefunit_time")
        ...
        self.cb_yo_beliefheir_count = QtWidgets.QCheckBox(Form)
        self.cb_yo_beliefheir_count.setGeometry(QtCore.QRect(430, 60, 101, 20))
        self.cb_yo_beliefheir_count.setObjectName("cb_yo_beliefheir_count")
    ...
    def retranslateUi(self, Form):
        ...
        item = self.oath2idea_table.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Idea_ID"))
        item = self.oath2idea_table.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Idea"))
        item = self.oath2idea_table.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Party Count"))
        self.oath2idea_delete_button.setText(_translate("Form", "De-link Idea"))
        self.oath2idea_insert_button.setText(_translate("Form", "Add Idea to Oath"))
        self.cb_rootadmiration.setText(_translate("Form", "root admiration"))
        self.cb_yo_id.setText(_translate("Form", "uid"))
        self.cb_yo2bd_count.setText(_translate("Form", "Idea count"))
        ...
        self.cb_yo_beliefunit_count.setText(_translate("Form", "beliefunits"))
        self.cb_yo_beliefunit_time.setText(_translate("Form", "time beliefunit"))
