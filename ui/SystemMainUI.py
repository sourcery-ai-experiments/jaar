...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_tools_table = QtWidgets.QTableWidget(self.centralwidget)
        self.w_tools_table.setGeometry(QtCore.QRect(600, 10, 391, 681))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.w_tools_table.setFont(font)
        self.w_tools_table.setObjectName("w_tools_table")
        self.w_tools_table.setColumnCount(3)
        self.w_tools_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.w_tools_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.w_tools_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.w_tools_table.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "New Column"))
        item = self.w_tools_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Person Tools"))
        item = self.w_tools_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Tool walk"))
