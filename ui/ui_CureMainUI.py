...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.oaths_table = QtWidgets.QTableWidget(self.centralwidget)
        self.oaths_table.setGeometry(QtCore.QRect(170, 190, 171, 501))
        self.oaths_table.setObjectName("oaths_table")
        self.oaths_table.setColumnCount(2)
        self.oaths_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.oaths_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.oaths_table.setHorizontalHeaderItem(1, item)
        ...
        self.oath_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_update_button.setGeometry(QtCore.QRect(180, 80, 141, 31))
        self.oath_update_button.setObjectName("oath_update_button")
        self.oath_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_insert_button.setGeometry(QtCore.QRect(180, 50, 141, 31))
        self.oath_insert_button.setObjectName("oath_insert_button")
        self.oath_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_delete_button.setGeometry(QtCore.QRect(240, 110, 81, 28))
        self.oath_delete_button.setObjectName("oath_delete_button")
        self.oath_healer = QtWidgets.QLineEdit(self.centralwidget)
        self.oath_healer.setGeometry(QtCore.QRect(180, 20, 141, 22))
        ...
        self.oath_edit_button = QtWidgets.QPushButton(self.centralwidget)
        self.oath_edit_button.setGeometry(QtCore.QRect(170, 160, 91, 31))
        self.oath_edit_button.setObjectName("oath_edit_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.oath_update_button.setText(_translate("MainWindow", "Change Oath Title"))
        self.oath_insert_button.setText(_translate("MainWindow", "Add new Oath"))
        self.oath_delete_button.setText(_translate("MainWindow", "delete Oath"))
        ...
        self.depotlink_delete_button.setText(
            _translate("MainWindow", "delete OathLink")
        )
        self.depotlink_insert_button.setText(
            _translate("MainWindow", "Add new OathLink")
        )
        self.depotlink_update_button.setText(
            _translate("MainWindow", "Change OathLink Title")
        )
        self.refresh_all_button.setText(_translate("MainWindow", "Refresh Tables"))
        self.oath_edit_button.setText(_translate("MainWindow", "Edit Oath"))
        self.healer_edit_button.setText(_translate("MainWindow", "Edit Healer"))
        self.depotlink_edit_button.setText(_translate("MainWindow", "Edit OathLink"))
        self.eluc_update_button.setText(
            _translate("MainWindow", "Change OathLink Title")
        )
        self.eluc_delete_button.setText(_translate("MainWindow", "delete OathLink"))
        self.eluc_edit_button.setText(_translate("MainWindow", "Edit OathLink"))
        item = self.elucs_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Elucs"))
        self.eluc_insert_button.setText(_translate("MainWindow", "Add new OathLink"))
