...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pacts_table.setGeometry(QtCore.QRect(170, 190, 171, 501))
        ...
        self.pact_edit_button.setGeometry(QtCore.QRect(170, 160, 91, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Pactlinks"))
        ...
        self.pact_update_button.setText(_translate("MainWindow", "Change Pact Title"))
        self.pact_insert_button.setText(_translate("MainWindow", "Add new Pact"))
        self.pact_delete_button.setText(_translate("MainWindow", "delete Pact"))
        ...
        self.depotlink_delete_button.setText(
            _translate("MainWindow", "delete PactLink")
        )
        self.depotlink_insert_button.setText(
            _translate("MainWindow", "Add new PactLink")
        )
        self.depotlink_update_button.setText(
            _translate("MainWindow", "Change PactLink Title")
        )
        self.refresh_all_button.setText(_translate("MainWindow", "Refresh Tables"))
        self.pact_edit_button.setText(_translate("MainWindow", "Edit Pact"))
        self.healer_edit_button.setText(_translate("MainWindow", "Edit Healer"))
        self.depotlink_edit_button.setText(_translate("MainWindow", "Edit PactLink"))
        self.eluc_update_button.setText(
            _translate("MainWindow", "Change PactLink Title")
        )
        self.eluc_delete_button.setText(_translate("MainWindow", "delete PactLink"))
        self.eluc_edit_button.setText(_translate("MainWindow", "Edit PactLink"))
        item = self.elucs_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Elucs"))
        self.eluc_insert_button.setText(_translate("MainWindow", "Add new PactLink"))
