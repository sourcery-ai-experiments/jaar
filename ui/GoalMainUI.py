...
# Form implementation generated from reading ui file 'ui\GoalMainUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.goal_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.goal_delete_button.setGeometry(QtCore.QRect(170, 20, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_delete_button.setFont(font)
        self.goal_delete_button.setObjectName("goal_delete_button")
        self.goal_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.goal_insert_button.setGeometry(QtCore.QRect(20, 50, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_insert_button.setFont(font)
        self.goal_insert_button.setObjectName("goal_insert_button")
        self.goal_kind = QtWidgets.QLineEdit(self.centralwidget)
        self.goal_kind.setGeometry(QtCore.QRect(20, 20, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_kind.setFont(font)
        self.goal_kind.setObjectName("goal_kind")
        self.goal_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.goal_update_button.setGeometry(QtCore.QRect(20, 80, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_update_button.setFont(font)
        self.goal_update_button.setObjectName("goal_update_button")
        ...
        self.goal_kind_combo = QtWidgets.QComboBox(self.centralwidget)
        self.goal_kind_combo.setGeometry(QtCore.QRect(20, 110, 141, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_kind_combo.setFont(font)
        self.goal_kind_combo.setObjectName("goal_kind_combo")
        self.goal_copy_button = QtWidgets.QPushButton(self.centralwidget)
        self.goal_copy_button.setGeometry(QtCore.QRect(100, 80, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_copy_button.setFont(font)
        self.goal_copy_button.setObjectName("goal_copy_button")
        ...
        self.goal_load_button = QtWidgets.QPushButton(self.centralwidget)
        self.goal_load_button.setGeometry(QtCore.QRect(100, 140, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.goal_load_button.setFont(font)
        self.goal_load_button.setObjectName("goal_load_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "GOAL Stories"))
        ...
        self.goal_delete_button.setText(_translate("MainWindow", "delete "))
        self.goal_insert_button.setText(_translate("MainWindow", "Add new Goal"))
        self.goal_update_button.setText(_translate("MainWindow", "Change Title"))
        ...
        self.goal_copy_button.setText(_translate("MainWindow", "Copy"))
        self.goal_load_button.setText(_translate("MainWindow", "load"))
