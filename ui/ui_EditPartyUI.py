...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.party_handle_edit = QtWidgets.QLineEdit(Form)
        self.party_handle_edit.setGeometry(QtCore.QRect(500, 140, 181, 22))
        self.party_handle_edit.setObjectName("party_handle_edit")
        ...
        self.party_handle_new = QtWidgets.QLineEdit(Form)
        self.party_handle_new.setGeometry(QtCore.QRect(500, 40, 171, 22))
        self.party_handle_new.setObjectName("party_handle_new")
    ...
    def retranslateUi(self, Form):
        ...
        self.party_update_button.setText(
            _translate("Form", "update old party handle to new")
        )
        self.label_3.setText(_translate("Form", "Change Handle to:"))
        ...
        item.setText(_translate("Form", "huh_handle_for_target"))
