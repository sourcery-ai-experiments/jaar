...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.party_pid_edit = QtWidgets.QLineEdit(Form)
        self.party_pid_edit.setGeometry(QtCore.QRect(500, 140, 181, 22))
        self.party_pid_edit.setObjectName("party_pid_edit")
        ...
        self.party_pid_new = QtWidgets.QLineEdit(Form)
        self.party_pid_new.setGeometry(QtCore.QRect(500, 40, 171, 22))
        self.party_pid_new.setObjectName("party_pid_new")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "Change PID to:"))
