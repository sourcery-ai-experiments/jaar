...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.remedy_title = QtWidgets.QLineEdit(self.centralwidget)
        self.remedy_title.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.remedy_title.setFont(font)
        self.remedy_title.setObjectName("remedy_title")
