...
# Form implementation generated from reading ui file 'ui\FixMainUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fix_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.fix_delete_button.setGeometry(QtCore.QRect(170, 20, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_delete_button.setFont(font)
        self.fix_delete_button.setObjectName("fix_delete_button")
        self.fix_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.fix_insert_button.setGeometry(QtCore.QRect(20, 50, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_insert_button.setFont(font)
        self.fix_insert_button.setObjectName("fix_insert_button")
        self.fix_handle = QtWidgets.QLineEdit(self.centralwidget)
        self.fix_handle.setGeometry(QtCore.QRect(20, 20, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_handle.setFont(font)
        self.fix_handle.setObjectName("fix_handle")
        self.fix_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.fix_update_button.setGeometry(QtCore.QRect(20, 80, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_update_button.setFont(font)
        self.fix_update_button.setObjectName("fix_update_button")
        ...
        self.collect_title = QtWidgets.QLineEdit(self.centralwidget)
        self.collect_title.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.collect_title.setFont(font)
        self.collect_title.setObjectName("collect_title")
        ...
        self.fix_handle_combo = QtWidgets.QComboBox(self.centralwidget)
        self.fix_handle_combo.setGeometry(QtCore.QRect(20, 110, 141, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_handle_combo.setFont(font)
        self.fix_handle_combo.setObjectName("fix_handle_combo")
        self.fix_copy_button = QtWidgets.QPushButton(self.centralwidget)
        self.fix_copy_button.setGeometry(QtCore.QRect(100, 80, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_copy_button.setFont(font)
        self.fix_copy_button.setObjectName("fix_copy_button")
        ...
        self.fix_load_button = QtWidgets.QPushButton(self.centralwidget)
        self.fix_load_button.setGeometry(QtCore.QRect(100, 140, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.fix_load_button.setFont(font)
        self.fix_load_button.setObjectName("fix_load_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "FIX Stories"))
        ...
        self.fix_delete_button.setText(_translate("MainWindow", "delete "))
        self.fix_insert_button.setText(_translate("MainWindow", "Add new Fix"))
        self.fix_update_button.setText(_translate("MainWindow", "Change Title"))
        ...
        self.fix_copy_button.setText(_translate("MainWindow", "Copy"))
        self.fix_load_button.setText(_translate("MainWindow", "load"))
