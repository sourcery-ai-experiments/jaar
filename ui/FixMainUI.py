...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.healing_title = QtWidgets.QLineEdit(self.centralwidget)
        self.healing_title.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.healing_title.setFont(font)
        self.healing_title.setObjectName("healing_title")
