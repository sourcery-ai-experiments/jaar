...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_guys_table = QtWidgets.QTableWidget(self.centralwidget)
        self.w_guys_table.setGeometry(QtCore.QRect(1140, 10, 171, 241))
        self.w_guys_table.setObjectName("w_guys_table")
        self.w_guys_table.setColumnCount(2)
        self.w_guys_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.w_guys_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.w_guys_table.setHorizontalHeaderItem(1, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.w_guys_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "owner_ids Guys"))
