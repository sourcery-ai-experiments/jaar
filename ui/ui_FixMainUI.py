...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.w_ideas_table.setGeometry(QtCore.QRect(1140, 260, 171, 431))
        self.w_ideas_table.setObjectName("w_ideas_table")
        self.w_ideas_table.setColumnCount(2)
        ...
        self.w_oaths_table = QtWidgets.QTableWidget(self.centralwidget)
        self.w_oaths_table.setGeometry(QtCore.QRect(900, 10, 231, 681))
        self.w_oaths_table.setObjectName("w_oaths_table")
        self.w_oaths_table.setColumnCount(3)
        self.w_oaths_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.w_oaths_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.w_oaths_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.w_oaths_table.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.w_oaths_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "owner_id Oaths"))
        item = self.w_oaths_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Oath parent_road"))
