...
import sys
from src.agenda.idea import idea_kid_shop, ideaattrfilter_shop
...
class EditIdeaUnit(qtw0, Ui_Form):
    ...
    def idea2group_table_load(self):
        ...
        self.idea2group_table.setHorizontalHeaderLabels(
            ["Group display", "group_pid", "LW Force"]
        )
    ...
    def idea2group_insert_combo_load(self):
        ...
        self.idea2group_insert_combo.clear()
        self.idea2group_insert_combo.addItems(groupunits_pids_list)
    ...
    def idea_duty_insert(self):
        ...
        self.agenda_x.add_idea(
            idea_kid=idea_kid_shop(not_done_text),
            parent_road=new_road,
        )
        done_text = "done"
        self.agenda_x.add_idea(
            idea_kid=idea_kid_shop(done_text),
            parent_road=new_road,
        )
    ...
    def idea_insert(self):
        new_idea = idea_kid_shop(self.yo_deescription.toPlainText())
