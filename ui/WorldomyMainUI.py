...
# Form implementation generated from reading ui file 'ui\marketMainUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.agent_ids_table.setGeometry(QtCore.QRect(190, 190, 141, 430))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agent_ids_table.setFont(font)
        ...
        self.market_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.market_delete_button.setGeometry(QtCore.QRect(170, 20, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_delete_button.setFont(font)
        self.market_delete_button.setObjectName("market_delete_button")
        self.market_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.market_insert_button.setGeometry(QtCore.QRect(20, 50, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_insert_button.setFont(font)
        self.market_insert_button.setObjectName("market_insert_button")
        self.market_id = QtWidgets.QLineEdit(self.centralwidget)
        self.market_id.setGeometry(QtCore.QRect(20, 20, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_id.setFont(font)
        self.market_id.setObjectName("market_id")
        self.market_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.market_update_button.setGeometry(QtCore.QRect(20, 80, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_update_button.setFont(font)
        self.market_update_button.setObjectName("market_update_button")
        ...
        self.agenda_agent_id.setGeometry(QtCore.QRect(10, 180, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agenda_agent_id.setFont(font)
        self.agenda_agent_id.setObjectName("agenda_agent_id")
        self.agent_id_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.agent_id_update_button.setGeometry(QtCore.QRect(190, 130, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agent_id_update_button.setFont(font)
        ...
        self.agent_id_insert_button.setGeometry(QtCore.QRect(190, 100, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agent_id_insert_button.setFont(font)
        ...
        self.agent_id_delete_button.setGeometry(QtCore.QRect(240, 40, 91, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agent_id_delete_button.setFont(font)
        self.agent_id_delete_button.setObjectName("agent_id_delete_button")
        self.clerk_id = QtWidgets.QLineEdit(self.centralwidget)
        self.clerk_id.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.agent_id_edit_button.setGeometry(QtCore.QRect(190, 160, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agent_id_edit_button.setFont(font)
        ...
        self.market_id_combo = QtWidgets.QComboBox(self.centralwidget)
        self.market_id_combo.setGeometry(QtCore.QRect(20, 110, 141, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_id_combo.setFont(font)
        self.market_id_combo.setObjectName("market_id_combo")
        self.market_copy_button = QtWidgets.QPushButton(self.centralwidget)
        self.market_copy_button.setGeometry(QtCore.QRect(100, 80, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_copy_button.setFont(font)
        self.market_copy_button.setObjectName("market_copy_button")
        ...
        self.market_load_button = QtWidgets.QPushButton(self.centralwidget)
        self.market_load_button.setGeometry(QtCore.QRect(100, 140, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.market_load_button.setFont(font)
        self.market_load_button.setObjectName("market_load_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "market Stories"))
        ...
        self.market_delete_button.setText(_translate("MainWindow", "delete "))
        self.market_insert_button.setText(_translate("MainWindow", "Add new market"))
        self.market_update_button.setText(_translate("MainWindow", "Change PID"))
        ...
        self.market_copy_button.setText(_translate("MainWindow", "Copy"))
        self.market_load_button.setText(_translate("MainWindow", "load"))
