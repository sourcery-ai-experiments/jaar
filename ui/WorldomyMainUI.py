...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.worker_ids_table = QtWidgets.QTableWidget(self.centralwidget)
        self.worker_ids_table.setGeometry(QtCore.QRect(190, 190, 141, 430))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.worker_ids_table.setFont(font)
        self.worker_ids_table.setObjectName("worker_ids_table")
        self.worker_ids_table.setColumnCount(2)
        self.worker_ids_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.worker_ids_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.worker_ids_table.setHorizontalHeaderItem(1, item)
        ...
        self.agenda_worker_id.setGeometry(QtCore.QRect(10, 180, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.agenda_worker_id.setFont(font)
        self.agenda_worker_id.setObjectName("agenda_worker_id")
        self.worker_id_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.worker_id_update_button.setGeometry(QtCore.QRect(190, 130, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.worker_id_update_button.setFont(font)
        self.worker_id_update_button.setObjectName("worker_id_update_button")
        self.worker_id_insert_button = QtWidgets.QPushButton(self.centralwidget)
        self.worker_id_insert_button.setGeometry(QtCore.QRect(190, 100, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.worker_id_insert_button.setFont(font)
        self.worker_id_insert_button.setObjectName("worker_id_insert_button")
        self.worker_id_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.worker_id_delete_button.setGeometry(QtCore.QRect(240, 40, 91, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.worker_id_delete_button.setFont(font)
        self.worker_id_delete_button.setObjectName("worker_id_delete_button")
        ...
        self.worker_id_edit_button = QtWidgets.QPushButton(self.centralwidget)
        self.worker_id_edit_button.setGeometry(QtCore.QRect(190, 160, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.worker_id_edit_button.setFont(font)
        self.worker_id_edit_button.setObjectName("worker_id_edit_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.worker_ids_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "worker_ids"))
        ...
        self.worker_id_update_button.setText(
            _translate("MainWindow", "Change worker_id PID")
        )
        self.worker_id_insert_button.setText(
            _translate("MainWindow", "Add new worker_id")
        )
        self.worker_id_delete_button.setText(
            _translate("MainWindow", "delete worker_id")
        )
