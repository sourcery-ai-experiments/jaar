...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.kitchen_dub = QtWidgets.QLineEdit(self.centralwidget)
        self.kitchen_dub.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.kitchen_dub.setFont(font)
        self.kitchen_dub.setObjectName("kitchen_dub")
