...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.enact_cid = QtWidgets.QLineEdit(self.centralwidget)
        self.enact_cid.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.enact_cid.setFont(font)
        self.enact_cid.setObjectName("enact_cid")
