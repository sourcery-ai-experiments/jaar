...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.council_cid = QtWidgets.QLineEdit(self.centralwidget)
        self.council_cid.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.council_cid.setFont(font)
        self.council_cid.setObjectName("council_cid")
