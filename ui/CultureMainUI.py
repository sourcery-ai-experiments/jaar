...
# Form implementation generated from reading ui file 'ui\cultureMainUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.culture_delete_button.setGeometry(QtCore.QRect(170, 20, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_delete_button.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_insert_button.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_title.setFont(font)
        self.culture_title.setObjectName("culture_title")
        self.culture_update_button = QtWidgets.QPushButton(self.centralwidget)
        self.culture_update_button.setGeometry(QtCore.QRect(20, 80, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_update_button.setFont(font)
        ...
        self.council_dub = QtWidgets.QLineEdit(self.centralwidget)
        self.council_dub.setGeometry(QtCore.QRect(190, 70, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.council_dub.setFont(font)
        self.council_dub.setObjectName("council_dub")
        ...
        self.depotlink_handle = QtWidgets.QLineEdit(self.centralwidget)
        self.depotlink_handle.setGeometry(QtCore.QRect(340, 20, 141, 22))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.depotlink_handle.setFont(font)
        self.depotlink_handle.setObjectName("depotlink_handle")
        ...
        self.w_goal_table.setGeometry(QtCore.QRect(1180, 260, 371, 431))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.w_goal_table.setFont(font)
        self.w_goal_table.setObjectName("w_goal_table")
        self.w_goal_table.setColumnCount(3)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.w_goal_table.setHorizontalHeaderItem(2, item)
        ...
        self.culture_title_combo = QtWidgets.QComboBox(self.centralwidget)
        self.culture_title_combo.setGeometry(QtCore.QRect(20, 110, 141, 26))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_title_combo.setFont(font)
        self.culture_title_combo.setObjectName("culture_title_combo")
        self.culture_copy_button = QtWidgets.QPushButton(self.centralwidget)
        self.culture_copy_button.setGeometry(QtCore.QRect(100, 80, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_copy_button.setFont(font)
        self.culture_copy_button.setObjectName("culture_copy_button")
        ...
        self.culture_load_button = QtWidgets.QPushButton(self.centralwidget)
        self.culture_load_button.setGeometry(QtCore.QRect(100, 140, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.culture_load_button.setFont(font)
        self.culture_load_button.setObjectName("culture_load_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.culture_delete_button.setText(_translate("MainWindow", "delete "))
        self.culture_insert_button.setText(_translate("MainWindow", "Add new culture"))
        self.culture_update_button.setText(_translate("MainWindow", "Change Handle"))
        self.agenda_update_button.setText(
            _translate("MainWindow", "Change Agenda Handle")
        )
        ...
        self.healer_update_button.setText(
            _translate("MainWindow", "Change Healer Handle")
        )
        ...
        item = self.w_goal_table.horizontalHeaderItem(1)
        ...
        self.culture_copy_button.setText(_translate("MainWindow", "Copy"))
        self.culture_load_button.setText(_translate("MainWindow", "load"))
