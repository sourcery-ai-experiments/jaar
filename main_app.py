...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def set_acptfact_time_open_5daysago(self):
        ...
        road_minute = f"{self.contract_x._healing_handle},time,jajatime"
    ...
    def _commit_file_save(self):
        ...
        #     file_title=f"{self.contract_x._healing_handle}.json",
    ...
    def populate_agenda_table_row(self, row, agenda_item):
        ...
        if (
            ax._requiredunits.get(f"{self.contract_x._healing_handle},time,jajatime")
            != None
        ):
            jajatime_required = ax._requiredunits.get(
                f"{self.contract_x._healing_handle},time,jajatime"
            )
    ...
    def agenda_task_display(self, agenda_item):
        ...
        if (
            ...
            sufffact_x = jajatime_required.sufffacts.get(
                f"{self.contract_x._healing_handle},time,jajatime,day"
            )
            if sufffact_x != None:
