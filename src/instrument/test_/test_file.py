...
def test_is_path_valid_ReturnsCorrectObj():
    ...
    assert is_path_valid("run/,trail")
    assert (platform_system() == "Windows") and is_path_valid("trail?") == False
    assert (platform_system() == "Windows") and is_path_valid("run/trail?") == False
    assert is_path_valid("run//trail////")
...
def test_is_path_existent_or_creatable_ReturnsCorrectObj():
    ...
    assert (platform_system() == "Windows") and is_path_existent_or_creatable(
        "run/trail?"
    ) == False
