from src.pact.required_idea import Road, SuffFactUnit
from src.pact.idea import IdeaBare as YB
...
class SuffFactUnitHregTime:
    ...
    _every_x_months: int = None  # builds mypact,time,months
    _on_x_monthday: int = None  # " build mypact,time,month,monthday
    _every_x_years: int = None  # builds mypact,time,years
