...
def test_pact_yoke_dict_isDictionaryAndIsFullyPopulated():
    # GIVEN
    cx = get_pact_with_4_levels_and_2requireds()
...
def test_pact_get_idea_list_SetsSatiateStatusCorrectlyWhenAcptFactChanges():
    ...
    states_road = f"{cx._cure_handle},{states_text}"
    usa_text = "USA"
...
def test_pact_get_idea_list_returns_correct_list():
    ...
    state_road = f"{cx._cure_handle},{state_text}"
    france_text = "France"
...
def test_pact_set_pact_metrics_CorrectlyClears_pact_coin():
    # GIVEN
    cx = get_pact_with7amCleanTableRequired()
    work_text = "work"
    catt_text = "feed cat"
    week_text = "weekdays"
    cx._idearoot._pact_coin_onset = 13
    cx._idearoot._pact_coin_cease = 13
    cx._idearoot._kids.get(work_text)._pact_coin_onset = 13
    cx._idearoot._kids.get(work_text)._pact_coin_cease = 13
    cx._idearoot._kids.get(catt_text)._pact_coin_onset = 13
    cx._idearoot._kids.get(catt_text)._pact_coin_cease = 13
    cx._idearoot._kids.get(week_text)._pact_coin_onset = 13
    cx._idearoot._kids.get(week_text)._pact_coin_cease = 13

    assert cx._idearoot._pact_coin_onset == 13
    assert cx._idearoot._pact_coin_cease == 13
    assert cx._idearoot._kids.get(work_text)._pact_coin_onset == 13
    assert cx._idearoot._kids.get(work_text)._pact_coin_cease == 13
    assert cx._idearoot._kids.get(catt_text)._pact_coin_onset == 13
    assert cx._idearoot._kids.get(catt_text)._pact_coin_cease == 13
    assert cx._idearoot._kids.get(week_text)._pact_coin_onset == 13
    assert cx._idearoot._kids.get(week_text)._pact_coin_cease == 13
...
def test_pact_get_idea_list_CorrectlyCalculatesIdeaAttr_pact_coin():
    ...
    assert cx._idearoot._pact_coin_onset is None
    assert cx._idearoot._pact_coin_cease is None
    assert cx._idearoot._kids.get(auto_text)._pact_coin_onset is None
    assert cx._idearoot._kids.get(auto_text)._pact_coin_cease is None
    assert cx._idearoot._kids.get(barn_text)._pact_coin_onset is None
    assert cx._idearoot._kids.get(barn_text)._pact_coin_cease is None
    assert cx._idearoot._kids.get(coal_text)._pact_coin_onset is None
    assert cx._idearoot._kids.get(coal_text)._pact_coin_cease is None
    ...
    # THEN
    assert cx._idearoot._pact_coin_onset == 0.0
    assert cx._idearoot._pact_coin_cease == 1.0
    assert cx._idearoot._kids.get(auto_text)._pact_coin_onset == 0.0
    assert cx._idearoot._kids.get(auto_text)._pact_coin_cease == 0.1
    assert cx._idearoot._kids.get(barn_text)._pact_coin_onset == 0.1
    assert cx._idearoot._kids.get(barn_text)._pact_coin_cease == 0.7
    assert cx._idearoot._kids.get(coal_text)._pact_coin_onset == 0.7
    assert cx._idearoot._kids.get(coal_text)._pact_coin_cease == 1.0
...
def test_pact_get_idea_list_CorrectlyCalculatesRangeAttributes():
    ...
    house_road = f"{cx._cure_handle},{house_text}"
...
def test_exammple_idea_list_HasCorrectData():
    ...
    laundry_road = f"{cx._cure_handle},casa,cleaning,{laundry_text}"
...
def test_exammple_idea_list_OptionWeekdaysCorrectlyWork():
    ...
    day_hr_road = f"{cx._cure_handle},{day_hr_text}"
    ...
    # cx.set_acptfact(base=f"{cx._cure_handle},weekdays", pick=f"{cx._cure_handle},weekdays,Tuesday")
    # idea_list = cx.get_idea_list()
    # assert YR.get_active_status(road=bird_idea, idea_list=idea_list) == True

    # cx.set_acptfact(base=f"{cx._cure_handle},weekdays", pick=f"{cx._cure_handle},weekdays,Wednesday")
    # idea_list = cx.get_idea_list()
...
def test_exammple_idea_list_Every6WeeksRequired():
    ...
    min_text = "day_minute"
    min_road = f"{cx._cure_handle},{day_text}"
    ...
    # THEN
    ced_week_base = f"{cx._cure_handle},ced_week"
    ...
    clean_sheet_road = f"{cx._cure_handle},casa,cleaning,clean sheets couch blankets"
    ...
    clean_couch_road = f"{cx._cure_handle},casa,cleaning,{clean_couch_text}"
...
def test_exammple_idea_list_EveryOtherMonthWorks():
    ...
    internet_road = f"{cx._cure_handle},{internet_text}"
