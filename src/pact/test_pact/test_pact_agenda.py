...
from src.pact.required_idea import RequiredUnit, SuffFactStatusFinder
...
from src.pact.examples.example_pacts import (
    ...
    pact_v001_with_large_agenda as example_pacts_pact_v001_with_large_agenda,
    pact_v002 as example_pacts_pact_v002,
)
from src.pact.x_func import yr_explanation, open_file as x_func_open_file
...
def test_get_agenda_returns_agenda_with_pact_importance():
    ...
    assert agenda_list[0]._pact_importance

    print(f"{agenda_list[1]._label=}")
    assert agenda_list[1]._pact_importance
