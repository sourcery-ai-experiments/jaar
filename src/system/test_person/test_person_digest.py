...
def test_person_get_remelded_output_calendar_withEmptyDigestDict(
    person_dir_setup_cleanup,
):
    # GIVEN
    ...
    px.create_core_dir_and_files()
    sx_output_before = px._admin.get_remelded_output_calendar()
    ...
    # WHEN
    sx_output_after = px._admin.get_remelded_output_calendar()
...
def test_person_get_remelded_output_calendar_with1DigestedCalendar(
    person_dir_setup_cleanup,
):
    # GIVEN
    yao_text = "Yao"
    ...
    px.create_core_dir_and_files()
    sx_output_old = px._admin.get_remelded_output_calendar()
    ...
    # WHEN
    sx_output_new = px._admin.get_remelded_output_calendar()
...
def test_person_isol_calendar_CorrectlysHasOriginLinksWithOwnerAsSource(
    ...
    # WHEN
    output_calendar_x = px._admin.get_remelded_output_calendar()
