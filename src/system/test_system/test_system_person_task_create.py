...
def test_system_person1_set_laundry_fact_create_person2_laundry_task(
    ...
    america_person.set_dest_calendar_to_public_calendar()
    ...
    old_joa_person.set_dest_calendar_to_public_calendar()
    ...
    new_joa_person.set_dest_calendar_to_public_calendar()
