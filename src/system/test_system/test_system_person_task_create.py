...
#     america_person.set_output_calendar_to_public_calendar()
...
#     old_joa_person.set_output_calendar_to_public_calendar()
...
#     new_joa_person.set_output_calendar_to_public_calendar()
