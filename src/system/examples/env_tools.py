...
def create_agent_file_for_systems(system_dir: str, agent_desc: str):
    agent_x = AgentUnit(_desc=agent_desc)
    agent_dir = f"{system_dir}/agents"
...
def create_person_file_for_systems(system_dir: str, person_name: str):
    ...
    person_dir = f"{system_dir}/persons/{person_x.name}"
...
def _delete_and_set_ex3():
    ...
    bob_text = "bob wurld"
    create_agent_file_for_systems(
        system_dir=ex.get_object_root_dir(), agent_desc=bob_text
    )
    ...
    land_text = "tim wurld"
    create_agent_file_for_systems(
        system_dir=ex.get_object_root_dir(), agent_desc=land_text
    )
