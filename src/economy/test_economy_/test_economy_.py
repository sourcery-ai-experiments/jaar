...
def test_economy_create_dirs_if_null_CreatesDirAndFiles(env_dir_setup_cleanup):
    ...
    councilunits_dir = f"{economy_dir}/councilunits"
    ...
    assert x_economy.get_councilunits_dir() == councilunits_dir
...
def test_change_economy_id_example_economy_CorrectlyChangesDirAndFiles(
    ...
    old_councilunits_dir = f"{old_economy_dir}/councilunits"
    ...
    new_councilunits_dir = f"{new_economy_dir}/councilunits"
    ...
    assert x_economy.get_councilunits_dir() == old_councilunits_dir
    ...
    assert x_economy.get_councilunits_dir() != new_councilunits_dir
