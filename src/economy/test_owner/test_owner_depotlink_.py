...
from src.economy.examples.economy_env_kit import get_temp_env_tag
...
def test_ownerunit_set_depotlink_CorrectlySetsIsolPartys(owner_dir_setup_cleanup):
    ...
    yao_text = "yao"
    env_dir = get_temp_owner_dir()
    yao_ux = ownerunit_shop(yao_text, env_dir, get_temp_economy_tag())
...
def test_ownerunit_set_depotlink_CorrectlySetsAssignment(owner_dir_setup_cleanup):
    ...
    joachim_ux = ownerunit_shop(
        joachim_text, get_temp_owner_dir(), get_temp_economy_tag()
    )
...
def test_ownerunit_del_depot_contract_CorrectlyDeletesObj(owner_dir_setup_cleanup):
    ...
    bob_text = "Bob"
    env_dir = get_temp_owner_dir()
    bob_cx = ownerunit_shop(bob_text, env_dir, get_temp_economy_tag())
    yao_text = "Yao"
...
def test_ownerunit_set_ignore_contract_file_CorrectlyUpdatesIgnoreFile(
    ...
    bob_text = "Bob"
    env_dir = get_temp_owner_dir()
    bob_ux = ownerunit_shop(bob_text, env_dir, get_temp_economy_tag())
    zia_text = "Zia"
