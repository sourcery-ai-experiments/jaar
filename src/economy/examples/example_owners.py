...
from src.economy.examples.owner_env_kit import get_temp_economy_tag
...
def get_1node_contract() -> ContractUnit:
    ...
    contract_x.set_economy_tag(get_temp_economy_tag())
...
def get_Jnode2node_contract() -> ContractUnit:
    ...
    contract_x.add_idea(idea_kid=idea_a, walk=get_temp_economy_tag())
    contract_x.set_contract_metrics()
    return contract_x
...
def get_2node_contract() -> ContractUnit:
    ...
    contract_x.add_idea(idea_kid=idea_b, walk=get_temp_economy_tag())
    contract_x.set_contract_metrics()
    return contract_x
...
def get_owner_2contract(env_dir, economy_tag) -> OwnerUnit:
    yao_text = "Xio"
    yao_owner = ownerunit_shop(yao_text, env_dir, economy_tag)
...
def get_contract_2CleanNodesRandomWeights(_owner: str = None) -> ContractUnit:
    ...
    casa_road = f"{contract_x._economy_tag},{casa_text}"
...
def get_contract_assignment_laundry_example1() -> ContractUnit:
    ...
    root_road = america_cx._economy_tag
    casa_text = "casa"
