from src.agenda.agenda import AgendaUnit, agendaunit_shop, idea_kid_shop, EconomyID
...
def get_Jnode2node_agenda() -> AgendaUnit:
    ...
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("A"), parent_road=x_agenda._economy_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_3node_agenda() -> AgendaUnit:
    ...
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("B"), parent_road=x_agenda._economy_id)
    x_agenda.add_idea(idea_kid_shop("C"), parent_road=x_agenda._economy_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_3node_D_E_F_agenda() -> AgendaUnit:
    ...
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("E"), parent_road=x_agenda._economy_id)
    x_agenda.add_idea(idea_kid_shop("F"), parent_road=x_agenda._economy_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_6node_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("A")
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("B"), x_agenda._economy_id)
    x_agenda.add_idea(idea_kid_shop("C"), x_agenda._economy_id)
    c_road = x_agenda.make_l1_road("C")
    x_agenda.add_idea(idea_kid_shop("D"), c_road)
    x_agenda.add_idea(idea_kid_shop("E"), c_road)
    x_agenda.add_idea(idea_kid_shop("F"), c_road)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_7nodeInsertH_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("A")
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("B"), x_agenda.make_road(x_agenda._economy_id))
    x_agenda.add_idea(idea_kid_shop("C"), x_agenda.make_road(x_agenda._economy_id))
    c_road = x_agenda.make_l1_road("C")
    x_agenda.add_idea(idea_kid_shop("H"), c_road)
    x_agenda.add_idea(idea_kid_shop("D"), c_road)
    x_agenda.add_idea(idea_kid_shop("E"), c_road)
    x_agenda.add_idea(idea_kid_shop("F"), x_agenda.make_road(c_road, "H"))
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_5nodeHG_agenda() -> AgendaUnit:
    ...
    c_road = x_agenda.make_l1_road("C")
    x_agenda.add_idea(idea_kid_shop("H"), c_road)
    x_agenda.add_idea(idea_kid_shop("G"), c_road)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_7nodeJRoot_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("J")
    x_agenda.set_economy_id(get_temp_economy_id())
    x_agenda.add_idea(idea_kid_shop("A"), x_agenda._economy_id)

    a_road = x_agenda.make_l1_road("A")
    x_agenda.add_idea(idea_kid_shop("B"), a_road)
    x_agenda.add_idea(idea_kid_shop("C"), a_road)
    c_road = x_agenda.make_l1_road("C")
    x_agenda.add_idea(idea_kid_shop("D"), c_road)
    x_agenda.add_idea(idea_kid_shop("E"), c_road)
    x_agenda.add_idea(idea_kid_shop("F"), c_road)
...
def get_agenda_2CleanNodesRandomWeights(_healer: str = None) -> AgendaUnit:
    ...
    casa_text = "casa"
    x_agenda.add_idea(idea_kid_shop(casa_text), parent_road=x_agenda._economy_id)
    casa_road = f"{x_agenda._economy_id},{casa_text}"
    cookery_text = "clean cookery"
    bedroom_text = "clean bedroom"
    cookery_idea = idea_kid_shop(cookery_text, _weight=randrange(1, 50), promise=True)
    bedroom_idea = idea_kid_shop(bedroom_text, _weight=randrange(1, 50), promise=True)
...
def get_agenda_3CleanNodesRandomWeights(_healer: str = None) -> AgendaUnit:
    ...
    cookery_idea = idea_kid_shop(cookery_text, _weight=randrange(1, 50), promise=True)
    bedroom_idea = idea_kid_shop(bedroom_text, _weight=randrange(1, 50), promise=True)
    hallway_idea = idea_kid_shop(hallway_text, _weight=randrange(1, 50), promise=True)
    x_agenda.add_idea(cookery_idea, parent_road=casa_road)
    x_agenda.add_idea(bedroom_idea, parent_road=casa_road)
