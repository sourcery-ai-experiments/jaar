...
from src.economy.examples.council_env_kit import get_temp_economy_id
...
def get_healer_2agenda(env_dir, economy_id) -> CouncilUnit:
    yao_text = "Xio"
    yao_healer = councilunit_shop(yao_text, env_dir, economy_id)
