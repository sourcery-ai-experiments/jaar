...
def owneradmin_shop(_owner_title: str, _env_dir: str, _economy_tag: str) -> OwnerAdmin:
    uax = OwnerAdmin(
        _owner_title=_owner_title, _env_dir=_env_dir, _economy_tag=_economy_tag
    )
    uax.set_dirs()
    return uax
...
class OwnerUnit:
    ...
    # housekeeping
    def set_env_dir(self, env_dir: str, owner_title: str, economy_tag: str):
        self._admin = owneradmin_shop(
            _owner_title=owner_title, _env_dir=env_dir, _economy_tag=economy_tag
        )
...
def ownerunit_shop(
    title: str, env_dir: str, economy_tag: str, _auto_output_to_public: bool = None
) -> OwnerUnit:
    owner_x = OwnerUnit()
    owner_x.set_env_dir(env_dir, title, economy_tag=economy_tag)
    owner_x.get_isol()
