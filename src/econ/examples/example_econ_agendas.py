...
def _delete_and_set_ex4():
    ...
    x_econ.agendahub.save_file_job(get_7nodeJRootWithH_agenda())
    x_econ.agendahub.save_file_job(get_agenda_with7amCleanTableReason())
    x_econ.agendahub.save_file_job(get_agenda_base_time_example())
    x_econ.agendahub.save_file_job(get_agenda_x1_3levels_1reason_1beliefs())
