...
#     x_econ.save_file_to_jobs(input_agenda)
#     # x_econ.save_file_to_jobs(ex_cxs_get_agenda_1Task_1CE0MinutesReason_1Belief())
#     # x_econ.save_file_to_jobs(ex_cxs_agenda_v001())
#     xia_text = "Xia"
#     x_econ.create_clerkunit(clerk_id=xia_text)
#     x_econ.set_clerk_depot_item(xia_text, input_agenda._owner_id)
...
#     x_econ.save_file_to_jobs(x1_agenda)
#     x_econ.save_file_to_jobs(x2_agenda)
#     # x_econ.save_file_to_jobs(ex_cxs_get_agenda_1Task_1CE0MinutesReason_1Belief())
#     # x_econ.save_file_to_jobs(ex_cxs_agenda_v001())
#     xia_text = "Xia"
#     x_econ.create_clerkunit(clerk_id=xia_text)
#     x_econ.set_clerk_depot_item(xia_text, x1_agenda._owner_id, "blind_trust")
#     x_econ.set_clerk_depot_item(xia_text, x2_agenda._owner_id, "blind_trust")
#     x_econ.save_clerkunit_file(clerk_id=xia_text)
#     xia_healer = x_econ.get_clerkunit(clerk_id=xia_text)
#     print(f"{xia_healer._role._partys.keys()=}")
...
#     x_econ.save_file_to_jobs(ernie_agenda)
#     x_econ.save_file_to_jobs(jessi_agenda)
#     x_econ.save_file_to_jobs(old_steve_agenda)
#     x_econ.create_clerkunit(clerk_id=ernie_text)
#     x_econ.create_clerkunit(clerk_id=jessi_text)
#     # x_econ.create_clerkunit(clerk_id=steve_text)
...
#     ux_ernie.set_depot_agenda(x_agenda=jessi_agenda)
#     ux_ernie.set_depot_agenda(x_agenda=old_steve_agenda)
#     ux_jessi.set_depot_agenda(x_agenda=ernie_agenda)
#     ux_jessi.set_depot_agenda(x_agenda=old_steve_agenda)
#     # ux_steve.set_depot_agenda(x_agenda=ernie_agenda)
#     # ux_steve.set_depot_agenda(x_agenda=jessi_agenda)
...
#     x_econ.save_file_to_jobs(new_steve_agenda)
#     # print(f"{env_dir=} {ux._jobs_dir=}")
#     # for file_name in dir_files(dir_path=env_dir):
#     #     print(f"{ux._jobs_dir=} {file_name=}")

#     # for file_name in dir_files(dir_path=ux._jobs_dir):
#     #     print(f"{ux._jobs_dir=} {file_name=}")
