...
def test_EconUnit_refresh_treasury_job_agendas_data_CorrectlyDeletesOldTreasuryInMemory(
    ...
    x_econ.agendanox.save_file_job(bob_agentunit)
...
def test_EconUnit_refresh_treasury_job_agendas_data_CorrectlyPopulatesPartyunitTable01(
    ...
    x_econ.agendanox.save_file_job(sal_agentunit)
    ...
    x_econ.agendanox.save_file_job(tom_agentunit)
    ...
    x_econ.agendanox.save_file_job(elu_agentunit)
...
def test_EconUnit_set_agenda_treasury_attrs_CorrectlyPopulatesAgenda_partylinks(
    ...
    x_real_id = x_econ.agendanox.real_id
    ...
    e1_sal_agenda = x_econ.agendanox.get_job_agenda(owner_id=sal_text)
...
def test_EconUnit_refresh_treasury_job_agendas_data_Populates_agenda_ideaunit_table(
    ...
    x_econ.agendanox.save_file_job(bob_agenda)
    x_econ.agendanox.save_file_job(tim_agenda)
    x_econ.agendanox.save_file_job(sal_agenda)
