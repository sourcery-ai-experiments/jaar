...
def test_EconUnit_refresh_treasury_job_agendas_data_CorrectlyDeletesOldTreasuryInMemory(
    ...
    x_econ.agendahub.save_job_agenda(bob_agentunit)
...
def test_EconUnit_refresh_treasury_job_agendas_data_CorrectlyPopulatesPartyunitTable01(
    ...
    x_econ.agendahub.save_job_agenda(sal_agentunit)
    ...
    x_econ.agendahub.save_job_agenda(tom_agentunit)
    ...
    x_econ.agendahub.save_job_agenda(elu_agentunit)
...
def test_EconUnit_refresh_treasury_job_agendas_data_CorrectlyPopulatesAgendaTable01(
    ...
    x_econ.agendahub.save_job_agenda(agendaunit_shop(_owner_id=bob_text))
    x_econ.agendahub.save_job_agenda(agendaunit_shop(_owner_id=tom_text))
    x_econ.agendahub.save_job_agenda(agendaunit_shop(_owner_id=sal_text))
    x_econ.agendahub.save_job_agenda(agendaunit_shop(_owner_id=elu_text))
...
def test_EconUnit_set_agenda_treasury_attrs_CorrectlyPopulatesAgenda_partylinks(
    ...
    x_real_id = x_econ.agendahub.real_id
    ...
    e1_sal_agenda = x_econ.agendahub.get_job_agenda(owner_id=sal_text)
...
def test_EconUnit_refresh_treasury_job_agendas_data_Populates_agenda_ideaunit_table(
    ...
    x_econ.agendahub.save_job_agenda(bob_agenda)
    x_econ.agendahub.save_job_agenda(tim_agenda)
    x_econ.agendahub.save_job_agenda(sal_agenda)
