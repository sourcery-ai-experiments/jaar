...
#     amos_agenda.set_world_id(get_temp_econ_id())
#     cali_text = "Cali"
...
#     assert amos_agenda._idearoot._label == get_temp_econ_id()
#     assert amos_agenda._owner_id == "Amos"
#     print(f"{amos_agenda._owner_id} {amos_agenda._idearoot._label=}")

#     # WHEN
#     cali_ux.set_depot_agenda(x_agenda=amos_agenda)
