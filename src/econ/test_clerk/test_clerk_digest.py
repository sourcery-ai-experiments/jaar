...
# def test_presonunit__create_digested_item_from_depot_item_CorrectlySets_blind_trust_DigestAgenda(
#     clerk_dir_setup_cleanup,
# ):
#     # GIVEN
#     sue_text = "Sue"
...
#     # WHEN
#     sue_agenda.set_depot_agenda(x_agenda=x_agenda)
...
#     yao_clerk.set_depot_agenda(x_agenda=input_agenda)
