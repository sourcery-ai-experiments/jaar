...
class ClerkUnit:
    ...
    _roll: dict[PartyID:PartyUnit] = None
    ...
    def set_road_delimiter(self, x_road_delimiter: str):
        self._road_delimiter = x_road_delimiter
...
def clerkunit_shop(clerk_id: PersonID, env_dir: str) -> ClerkUnit:
    x_clerk = ClerkUnit()
