...
class SuffFactUnitHregTime:
    ...
    _every_x_months: int = None  # builds myagent,time,months
    _on_x_monthday: int = None  # " build myagent,time,month,monthday
    _every_x_years: int = None  # builds myagent,time,years
