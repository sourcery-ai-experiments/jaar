...
from src.fix.healing import healingunit_shop, HealingUnit
from src.fix.examples.healer_env_kit import get_temp_fix_handle
...
def get_healer_2deal(env_dir, fix_handle) -> HealingUnit:
    yao_text = "Xio"
    yao_healer = healingunit_shop(yao_text, env_dir, fix_handle)
