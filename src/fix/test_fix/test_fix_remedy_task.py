...
def test_fix_ChangingOneHealersFactChangesAnotherAgenda(env_dir_setup_cleanup):
    ...
    sx.create_new_remedyunit(remedy_title=america_text)
    america_ux = sx.get_remedyunit(title=america_text)
    ...
    sx.create_new_remedyunit(remedy_title=joachim_text)
    joachim_ux = sx.get_remedyunit(title=joachim_text)
...
#     # new_joa_healer = sx.get_remedyunit(title=joachim_text)
...
#     # sx.create_new_remedyunit(remedy_title=america_text)
#     # america_healer = sx.get_remedyunit(title=america_text)
#     # america_healer.save_output_deal_to_public()
...
#     # sx.create_new_remedyunit(remedy_title=joachim_text)
#     # old_joa_healer = sx.get_remedyunit(title=joachim_text)
