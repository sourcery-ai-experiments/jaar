...
def test_cure_set_deal_CreatesDealFile(env_dir_setup_cleanup):
    # GIVEN
...
def test_cure_get_deal_currentlyGetsDeal(env_dir_setup_cleanup):
    # GIVEN
    cure_handle = get_temp_env_handle()
...
def test_cure_rename_public_deal_ChangesDealTitle(
    env_dir_setup_cleanup,
):
    # GIVEN
    cure_handle = get_temp_env_handle()
...
def test_cure_SetsIdeaRootLabel(
    ...
    assert deal_after._idearoot._label == cure_handle
