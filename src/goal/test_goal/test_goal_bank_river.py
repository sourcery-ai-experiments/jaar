...
from src.goal.y_func import check_connection, get_single_result_back
from src.goal.bank_sqlstr import (
...
def test_goal_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable01(
    env_dir_setup_cleanup,
):
...
def test_goal_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable02(
    env_dir_setup_cleanup,
):
...
def test_goal_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable03(
    env_dir_setup_cleanup,
):
...
def test_goal_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable04(
    env_dir_setup_cleanup,
):
...
def test_goal_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable05(
    env_dir_setup_cleanup,
):
...
def test_goal_set_river_sphere_for_contract_CorrectlyDeletesPreviousRiver(
    env_dir_setup_cleanup,
):
    # GIVEN 4 contracts, 100% of river flows to sal
    goal_tag = get_temp_env_tag()
...
def test_goal_set_river_sphere_for_contract_CorrectlyUsesMaxFlowsCount(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    goal_tag = get_temp_env_tag()
...
def test_goal_set_river_sphere_for_contract_CorrectlyBuildsASingleContinuousRange(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    goal_tag = get_temp_env_tag()
...
def test_goal_set_river_sphere_for_contract_CorrectlyUpatesContractPartyUnits(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    goal_tag = get_temp_env_tag()
