...
def test_goal_get_ledger_table_insert_sqlstr_CorrectlyPopulatesTable01(
    env_dir_setup_cleanup,
):
...
def test_goal_get_idea_catalog_table_insert_sqlstr_CorrectlyPopulatesTable01(
    env_dir_setup_cleanup,
):
    # GIVEN
    sx = goalunit_shop(tag=get_temp_env_tag(), goals_dir=get_test_goals_dir())
...
def test_goal_get_acptfact_catalog_table_insert_sqlstr_CorrectlyPopulatesTable01(
    env_dir_setup_cleanup,
):
    # GIVEN Create example goal with 4 Owners, each with 3 Partyunits = 12 ledger rows
...
def test_goal_get_groupunit_catalog_table_insert_sqlstr_CorrectlyPopulatesTable01(
    env_dir_setup_cleanup,
):
    # GIVEN Create example goal with 4 Owners, each with 3 Partyunits = 12 ledger rows
