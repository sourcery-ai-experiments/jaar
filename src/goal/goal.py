...
from src.goal.owner import OwnerUnit, ownerunit_shop
...
class GoalUnit:
    ...
    def set_contract_bank_attrs(self, contract_owner: str):
        ...
        for groupunit_x in contract_obj._groups.values():
            if groupunit_x._partylinks_set_by_goal_road != None:
                groupunit_x.clear_partylinks()
                ic = get_idea_catalog_dict(
                    self.get_bank_conn(), groupunit_x._partylinks_set_by_goal_road
                )
        ...
        with self.get_bank_conn() as bank_conn:
            ...
            for groupunit_x in contractunit_x._groups.values():
                groupunit_catalog_x = GroupUnitCatalog(
                    ...
                    partylinks_set_by_goal_road=groupunit_x._partylinks_set_by_goal_road,
                )
    ...
    def create_ownerunit_from_public(self, title: str):
        ...
        self.set_ownerunits_empty_if_null()
        self.set_ownerunit_to_goal(owner_x)

    def set_ownerunit_to_goal(self, owner: OwnerUnit):
    ...
    def rename_ownerunit(self, old_title: str, new_title: str):
        ...
        self.set_ownerunit_to_goal(owner=owner_x)
        x_func_delete_dir(old_owner_dir)
        self.del_owner_from_goal(owner_title=old_title)

    def del_owner_from_goal(self, owner_title):
