...
from src.heal.owner import ownerunit_shop, OwnerUnit
from src.heal.examples.owner_env_kit import get_temp_heal_kind
...
def get_1node_contract() -> ContractUnit:
    ...
    contract_x.set_heal_kind(get_temp_heal_kind())
...
def get_Jnode2node_contract() -> ContractUnit:
    ...
    contract_x.add_idea(idea_kid=idea_a, walk=get_temp_heal_kind())
    contract_x.set_contract_metrics()
    return contract_x
...
def get_2node_contract() -> ContractUnit:
    ...
    contract_x.add_idea(idea_kid=idea_b, walk=get_temp_heal_kind())
    contract_x.set_contract_metrics()
    return contract_x
...
def get_owner_2contract(env_dir, heal_kind) -> OwnerUnit:
    yao_text = "Xio"
    yao_owner = ownerunit_shop(yao_text, env_dir, heal_kind)
...
def get_contract_2CleanNodesRandomWeights(_owner: str = None) -> ContractUnit:
    ...
    casa_road = f"{contract_x._heal_kind},{casa_text}"
...
def get_contract_assignment_laundry_example1() -> ContractUnit:
    ...
    root_road = america_cx._heal_kind
    casa_text = "casa"
