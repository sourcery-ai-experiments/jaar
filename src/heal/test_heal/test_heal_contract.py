...
def test_heal_set_contract_CreatesContractFile(env_dir_setup_cleanup):
    # GIVEN
...
def test_heal_get_contract_currentlyGetsContract(env_dir_setup_cleanup):
    # GIVEN
    heal_kind = get_temp_env_kind()
...
def test_heal_rename_public_contract_ChangesContractTitle(
    env_dir_setup_cleanup,
):
    # GIVEN
    heal_kind = get_temp_env_kind()
...
def test_heal_SetsIdeaRootLabel(
    env_dir_setup_cleanup,
):
    # GIVEN
    heal_kind = get_temp_env_kind()
    ...
    assert contract_after._idearoot._label == heal_kind
