...
def test_heal_ChangingOneOwnersFactChangesAnotherAgenda(env_dir_setup_cleanup):
    sx = healunit_shop(get_temp_env_kind(), get_test_heals_dir())
    ...
    laundry_contract.set_heal_kind(sx.kind)
...
# def test_heal_create_task_CorrectlyCreatesTask(env_dir_setup_cleanup):
#     sx = healunit_shop(
#         kind=get_temp_env_kind(), heals_dir=get_test_heals_dir()
#     )
#     sx.create_dirs_if_null(in_memory_bank=True)
