...
def test_heal_get_output_contract_ReturnsCorrectContractObjScenario1(
    env_dir_setup_cleanup,
):
    # GIVEN
    ...
    a_text = "A"
    c_text = "C"
    c_road = f"{input_cx._heal_kind},{c_text}"
    d_text = "D"
...
def test_heal_get_output_contract_ReturnsCorrectContractObjScenario2(
    env_dir_setup_cleanup,
):
    # GIVEN
    sx = healunit_shop(kind=get_temp_env_kind(), heals_dir=get_test_heals_dir())
    ...
    # THEN
    output_cx_d_road = f"{output_cx._heal_kind},C,D"
