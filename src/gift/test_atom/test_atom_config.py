...
def test_world_idea_heldbelief_text_ReturnsObj():
    assert world_idea_heldbelief_text() == "world_idea_heldbelief"
...
def test_get_atom_config_dict_EveryCrudOperationHasChangeOrderBelief():
    ...
    # set_mog(atom_insert(), "world_idea_heldbelief", 4)
    ...
    # set_mog(atom_delete(), "world_idea_heldbelief", 19)
    ...
    assert 4 == q_order(atom_insert(), "world_idea_heldbelief")
    ...
    assert 19 == q_order(atom_delete(), "world_idea_heldbelief")
...
def test_get_normalized_world_table_build_ReturnsCorrectObj():
    ...
    cat_heldbelief = nx.get(world_idea_heldbelief_text())
    ...
    normal_specs_heldbelief = cat_heldbelief.get(normal_specs_text())
    ...
    assert normal_specs_heldbelief != None
    ...
    table_name_heldbelief = normal_specs_heldbelief.get(normal_table_name_text())
    ...
    assert table_name_heldbelief == "heldbelief"
