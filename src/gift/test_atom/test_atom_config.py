...
def test_get_atom_config_dict_EveryCrudOperationHasChangeOrderBelief():
    ...
    # set_mog("world_idea_fiscallink", atom_insert(), mog, 4)
    ...
    # set_mog("world_idea_fiscallink", atom_update(), mog, 14)
    ...
    # set_mog("world_idea_fiscallink", atom_delete(), mog, 23)
    ...
    assert 3 == q_order("world_idea_fiscallink", atom_insert(), mog, 3)
    ...
    assert 12 == q_order("world_idea_fiscallink", atom_update(), mog, 12)
    ...
    assert 21 == q_order("world_idea_fiscallink", atom_delete(), mog, 21)
