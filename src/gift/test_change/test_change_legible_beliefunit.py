...
def test_create_legible_list_ReturnsObj_belief_charlink_INSERT():
    # GIVEN
    sue_world = worldunit_shop("Sue")
    category = "world_belief_charlink"
    belief_id_text = "belief_id"
...
def test_create_legible_list_ReturnsObj_belief_charlink_UPDATE_credor_weight_debtor_weight():
    # GIVEN
    sue_world = worldunit_shop("Sue")
    category = "world_belief_charlink"
    belief_id_text = "belief_id"
...
def test_create_legible_list_ReturnsObj_belief_charlink_UPDATE_credor_weight():
    # GIVEN
    sue_world = worldunit_shop("Sue")
    category = "world_belief_charlink"
    belief_id_text = "belief_id"
...
def test_create_legible_list_ReturnsObj_belief_charlink_UPDATE_debtor_weight():
    # GIVEN
    sue_world = worldunit_shop("Sue")
    category = "world_belief_charlink"
    belief_id_text = "belief_id"
...
def test_create_legible_list_ReturnsObj_belief_charlink_DELETE():
    # GIVEN
    sue_world = worldunit_shop("Sue")
    category = "world_belief_charlink"
    belief_id_text = "belief_id"
