...
from src.healing.y_func import check_connection, get_single_result_back
...
def test_healing_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable01(
    env_dir_setup_cleanup,
):
...
def test_healing_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable02(
    env_dir_setup_cleanup,
):
...
def test_healing_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable03(
    env_dir_setup_cleanup,
):
...
def test_healing_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable04(
    env_dir_setup_cleanup,
):
...
def test_healing_set_river_sphere_for_contract_CorrectlyPopulatesriver_tpartyTable05(
    env_dir_setup_cleanup,
):
...
def test_healing_set_river_sphere_for_contract_CorrectlyDeletesPreviousRiver(
    env_dir_setup_cleanup,
):
    # GIVEN 4 contracts, 100% of river flows to sal
    healing_handle = get_temp_env_handle()
...
def test_healing_set_river_sphere_for_contract_CorrectlyUsesMaxFlowsCount(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    healing_handle = get_temp_env_handle()
...
def test_healing_set_river_sphere_for_contract_CorrectlyBuildsASingleContinuousRange(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    healing_handle = get_temp_env_handle()
...
def test_healing_set_river_sphere_for_contract_CorrectlyUpatesContractPartyUnits(
    env_dir_setup_cleanup,
):
    # GIVEN 5 contracts, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    healing_handle = get_temp_env_handle()
