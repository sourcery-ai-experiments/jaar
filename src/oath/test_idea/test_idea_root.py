from src.oath.idea import IdeaRoot
...
def test_IdeaRoot_set_idea_label_CorrectlyDoesNotRaisesError():
    ...
    new_obj.set_idea_label(_label=cure_handle, oath_cure_handle=cure_handle)
...
def test_IdeaRoot_set_idea_label_InCorrectlyDoesRaisesError():
    ...
    with pytest_raises(Exception) as excinfo:
        casa_text = "casa"
        new_obj.set_idea_label(_label=casa_text, oath_cure_handle=cure_handle)
    assert (
        str(excinfo.value)
...
def test_IdeaRoot_set_idea_label_RaisesErrorWhen_oath_cure_handle_IsNone():
    # GIVEN
    new_obj = IdeaRoot()
    ...
    with pytest_raises(Exception) as excinfo:
        casa_text = "casa"
        new_obj.set_idea_label(_label=casa_text, oath_cure_handle=None)
    assert (
        str(excinfo.value)
...
def test_IdeaRoot_set_idea_label_oath_cure_handle_EqualRootLabelDoesNotRaisesError():
    # GIVEN
    new_obj = IdeaRoot()

    # WHEN

    new_obj.set_idea_label(_label=root_label(), oath_cure_handle=root_label())
