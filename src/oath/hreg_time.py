from src.oath.required_idea import Road, SuffFactUnit
from src.oath.idea import IdeaBare as YB
...
class SuffFactUnitHregTime:
    ...
    _every_x_months: int = None  # builds myoath,time,months
    _on_x_monthday: int = None  # " build myoath,time,month,monthday
    _every_x_years: int = None  # builds myoath,time,years
