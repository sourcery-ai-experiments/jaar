...
def test_create_legible_list_ReturnsObj_oath_reasonunit_INSERT_With_suff_oath_active():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_oath_reasonunit"
    road_text = "road"
    ...
    suff_oath_active_text = "suff_oath_active"
    suff_oath_active_value = True
    ...
    swim_quarkunit.set_arg(suff_oath_active_text, suff_oath_active_value)
    ...
    # THEN
    x_str = f"ReasonUnit created for oath '{road_value}' with base '{base_value}'. suff_oath_active={suff_oath_active_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_oath_reasonunit_INSERT_Without_suff_oath_active():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_oath_reasonunit"
    road_text = "road"
    ...
    # THEN
    x_str = f"ReasonUnit created for oath '{road_value}' with base '{base_value}'."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_oath_reasonunit_UPDATE_suff_oath_active_IsTrue():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_oath_reasonunit"
    base_text = "base"
...
def test_create_legible_list_ReturnsObj_oath_reasonunit_UPDATE_suff_oath_active_IsNone():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_oath_reasonunit"
    base_text = "base"
...
def test_create_legible_list_ReturnsObj_oath_reasonunit_DELETE():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_oath_reasonunit"
    road_text = "road"
