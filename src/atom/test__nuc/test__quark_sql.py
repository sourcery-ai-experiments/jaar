...
def test_QuarkUnit_get_insert_sqlstr_ReturnsCorrectObj_AgendaUnitSimpleAttrs():
    # WHEN
    new2_value = 66
    category = "agendaunit"
...
def test_QuarkUnit_get_insert_sqlstr_ReturnsCorrectObj_fact_beliefunit():
    # GIVEN
    sports_text = "sports"
    sports_road = create_road("a", sports_text)
    ball_text = "basketball"
...
def test_get_quarkunit_from_rowdata_ReturnsCorrectObj_fact_beliefunit():
    # GIVEN
    sports_text = "sports"
    sports_road = create_road("a", sports_text)
    ball_text = "basketball"
