...
def test_create_legible_list_ReturnsObj_ideaunit_INSERT():
    ...
    swim_quarkunit.set_arg(idea_id_text, swim_text)
    ...
    # THEN
    x_str = f"The idea '{swim_text}' was created."
    print(f"{x_str=}")
...
def test_create_legible_list_ReturnsObj_ideaunit_DELETE():
    ...
    # THEN
    x_str = f"The idea '{swim_text}' was deleted."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_idea_partylink_INSERT():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_idea_partylink"
    idea_id_text = "idea_id"
    ...
    rico_quarkunit.set_arg(idea_id_text, swim_text)
    ...
    # THEN
    x_str = f"Idea '{swim_text}' has new member {rico_text} with idea_cred={credor_weight_value} and idea_debt={debtor_weight_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_idea_partylink_UPDATE_credor_weight_debtor_weight():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_idea_partylink"
    idea_id_text = "idea_id"
    ...
    # THEN
    x_str = f"Idea '{swim_text}' member {rico_text} has new idea_cred={credor_weight_value} and idea_debt={debtor_weight_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_idea_partylink_UPDATE_credor_weight():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_idea_partylink"
    idea_id_text = "idea_id"
    ...
    # THEN
    x_str = f"Idea '{swim_text}' member {rico_text} has new idea_cred={credor_weight_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_idea_partylink_UPDATE_debtor_weight():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_idea_partylink"
    idea_id_text = "idea_id"
    ...
    # THEN
    x_str = f"Idea '{swim_text}' member {rico_text} has new idea_debt={debtor_weight_value}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str


def test_create_legible_list_ReturnsObj_idea_partylink_DELETE():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    category = "agenda_idea_partylink"
    idea_id_text = "idea_id"
    ...
    # THEN
    x_str = f"Idea '{swim_text}' no longer has member {rico_text}."
    print(f"{x_str=}")
    assert legible_list[0] == x_str
