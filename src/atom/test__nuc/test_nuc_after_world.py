...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_SimplestScenario():
    # GIVEN
    ...
    after_sue_worldunit = ex1_nucunit.get_edited_world(before_sue_worldunit)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnitSimpleAttrs():
    # GIVEN
    ...
    # WHEN
    after_sue_worldunit = sue_nucunit.get_edited_world(before_sue_worldunit)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_other():
    # GIVEN
    sue_nucunit = nucunit_shop()
    sue_text = "Sue"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_other():
    # GIVEN
    sue_nucunit = nucunit_shop()
    sue_text = "Sue"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_other():
    # GIVEN
    sue_nucunit = nucunit_shop()
    sue_text = "Sue"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_otherlink():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    # WHEN
    rico_quarkunit = quarkunit_shop("world_belief_otherlink", quark_delete())
    ...
    carm_quarkunit = quarkunit_shop("world_belief_otherlink", quark_delete())
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_otherlink():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    # WHEN
    rico_quarkunit = quarkunit_shop("world_belief_otherlink", quark_insert())
    rico_quarkunit.set_required_arg("belief_id", run_text)
    rico_quarkunit.set_required_arg("other_id", rico_text)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_otherlink():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    # WHEN
    rico_quarkunit = quarkunit_shop("world_belief_otherlink", quark_update())
    rico_quarkunit.set_required_arg("belief_id", run_text)
    rico_quarkunit.set_required_arg("other_id", rico_text)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_beliefunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    run_text = ",runners"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_beliefunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    run_text = ",runners"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_beliefunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    run_text = ",runners"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_ideaunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    # WHEN
    delete_disc_quarkunit = quarkunit_shop("world_ideaunit", quark_delete())
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_ideaunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    # x_numor = 10
    x_pledge = True
    insert_disc_quarkunit = quarkunit_shop("world_ideaunit", quark_insert())
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_ideaunit_SimpleAttributes():
    # GIVEN
    sue_text = "Sue"
    before_sue_worldunit = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    # x_numor = 10
    x_pledge = True
    insert_disc_quarkunit = quarkunit_shop("world_ideaunit", quark_update())
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_idea_balancelink():
    # GIVEN
    sue_text = "Sue"
    ...
    # WHEN
    delete_disc_quarkunit = quarkunit_shop("world_idea_balancelink", quark_delete())
    delete_disc_quarkunit.set_required_arg("road", disc_road)
    delete_disc_quarkunit.set_required_arg("belief_id", fly_text)
    print(f"{delete_disc_quarkunit=}")
    sue_nucunit = nucunit_shop()
    sue_nucunit.set_quarkunit(delete_disc_quarkunit)
    after_sue_worldunit = sue_nucunit.get_edited_world(before_sue_au)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_idea_balancelink():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    x_credor_weight = 55
    x_debtor_weight = 66
    update_disc_quarkunit = quarkunit_shop("world_idea_balancelink", quark_update())
    ...
    after_sue_au = sue_nucunit.get_edited_world(before_sue_au)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_idea_balancelink():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    x_credor_weight = 55
    x_debtor_weight = 66
    update_disc_quarkunit = quarkunit_shop("world_idea_balancelink", quark_insert())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("belief_id", run_text)
    update_disc_quarkunit.set_optional_arg("credor_weight", x_credor_weight)
    update_disc_quarkunit.set_optional_arg("debtor_weight", x_debtor_weight)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_idea_factunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    broken_open = 55
    broken_nigh = 66
    update_disc_quarkunit = quarkunit_shop("world_idea_factunit", quark_insert())
    update_disc_quarkunit.set_required_arg("road", ball_road)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_idea_factunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    # WHEN
    update_disc_quarkunit = quarkunit_shop("world_idea_factunit", quark_delete())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("base", knee_road)
    # print(f"{update_disc_quarkunit=}")
    sue_nucunit = nucunit_shop()
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_idea_factunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    medical_open = 45
    medical_nigh = 77
    update_disc_quarkunit = quarkunit_shop("world_idea_factunit", quark_update())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("base", knee_road)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_idea_reason_premiseunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_idea_reason_premiseunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_idea_reason_premiseunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_idea_reasonunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    update_disc_quarkunit = quarkunit_shop("world_idea_reasonunit", quark_insert())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("base", knee_road)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_update_idea_reasonunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    update_disc_quarkunit = quarkunit_shop("world_idea_reasonunit", quark_update())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("base", knee_road)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_idea_reasonunit():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    sports_text = "sports"
    ...
    # WHEN
    update_disc_quarkunit = quarkunit_shop("world_idea_reasonunit", quark_delete())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("base", knee_road)
    sue_nucunit = nucunit_shop()
    sue_nucunit.set_quarkunit(update_disc_quarkunit)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_insert_idea_suffbelief():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    # WHEN
    update_disc_quarkunit = quarkunit_shop("world_idea_suffbelief", quark_insert())
    update_disc_quarkunit.set_required_arg("road", ball_road)
...
def test_NucUnit_get_edited_world_ReturnsCorrectObj_WorldUnit_delete_idea_suffbelief():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = worldunit_shop(sue_text)
    rico_text = "Rico"
    ...
    # WHEN
    update_disc_quarkunit = quarkunit_shop("world_idea_suffbelief", quark_delete())
    update_disc_quarkunit.set_required_arg("road", ball_road)
    update_disc_quarkunit.set_required_arg("belief_id", rico_text)
    sue_nucunit = nucunit_shop()
    sue_nucunit.set_quarkunit(update_disc_quarkunit)
