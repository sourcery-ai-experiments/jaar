...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_belief_partylink_insert():
    # GIVEN
    sue_text = "Sue"
    ...
    run_beliefunit.set_partylink(rico_partylink)
    ...
    # THEN
    x_keylist = [quark_insert(), "agenda_beliefunit", run_text]
    rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert rico_quarkunit.get_value("belief_id") == run_text
    # print(f"\n{sue_nucunit.quarkunits=}")
    print(f"\n{rico_quarkunit=}")

    x_keylist = [quark_insert(), "agenda_belief_partylink", run_text, rico_text]
    rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert rico_quarkunit.get_value("belief_id") == run_text
    assert rico_quarkunit.get_value("party_id") == rico_text
    assert rico_quarkunit.get_value("credor_weight") == rico_credor_weight
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_belief_partylink_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    after_run_beliefunit.edit_partylink(
    ...
    # THEN
    # x_keylist = [quark_update(), "agenda_beliefunit", run_text]
    # rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    # assert rico_quarkunit.get_value("belief_id") == run_text
    # print(f"\n{sue_nucunit.quarkunits=}")
    # print(f"\n{rico_quarkunit=}")

    x_keylist = [quark_update(), "agenda_belief_partylink", run_text, rico_text]
    rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert rico_quarkunit.get_value("belief_id") == run_text
    assert rico_quarkunit.get_value("party_id") == rico_text
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_belief_partylink_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    after_fly_beliefunit.del_partylink(dizz_text)
    ...
    # THEN
    x_keylist = [quark_delete(), "agenda_beliefunit", run_text]
    rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert rico_quarkunit.get_value("belief_id") == run_text

    x_keylist = [quark_delete(), "agenda_belief_partylink", fly_text, dizz_text]
    rico_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_idea_factunit_update():
    ...
    x_keylist = [quark_update(), "agenda_idea_factunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_idea_factunit_insert():
    ...
    # THEN
    print(f"{print_quarkunit_keys(sue_nucunit)=}")
    x_keylist = [quark_insert(), "agenda_idea_factunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
    assert ball_quarkunit.get_value("base") == knee_road
    assert ball_quarkunit.get_value("pick") == broken_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_idea_factunit_delete():
    ...
    # THEN
    print(f"{print_quarkunit_keys(sue_nucunit)=}")
    x_keylist = [quark_delete(), "agenda_idea_factunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
    assert ball_quarkunit.get_value("base") == knee_road
    assert ball_quarkunit.get_value("road") == ball_road
