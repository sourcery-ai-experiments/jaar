...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    before_sue_agendaunit.add_fact(factunit_shop(street_text), ball_road)
    disc_text = "Ultimate Disc"
    disc_road = before_sue_agendaunit.make_road(sports_road, disc_text)
    music_text = "music"
    before_sue_agendaunit.add_l1_fact(factunit_shop(music_text))
    before_sue_agendaunit.add_fact(factunit_shop(disc_text), sports_road)
    # create after without ball_fact and street_fact
    after_sue_agendaunit = copy_deepcopy(before_sue_agendaunit)
    after_sue_agendaunit.del_fact_obj(ball_road)
    ...
    x_keylist = [quark_delete(), "agenda_factunit", ball_road, street_text]
    ...
    x_keylist = [quark_delete(), "agenda_factunit", sports_road, ball_text]
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    after_sue_agendaunit.add_fact(factunit_shop(disc_text), sports_road)
    music_text = "music"
    music_begin = 34
    music_close = 78
    ...
    after_sue_agendaunit.add_l1_fact(
        factunit_shop(
            music_text,
            _begin=music_begin,
            _close=music_close,
    ...
    x_keylist = [quark_insert(), "agenda_factunit", sports_road, disc_text]
    street_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    before_sue_agendaunit.add_l1_fact(
        factunit_shop(
            music_text,
    ...
    after_sue_agendaunit.edit_fact_attr(
        music_road,
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_balancelink_delete():
    # GIVEN
    sue_text = "Sue"
    ...
    after_sue_agendaunit.edit_fact_attr(disc_road, balancelink_del=run_text)
    ...
    x_keylist = [quark_delete(), "agenda_fact_balancelink", disc_road, run_text]
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_balancelink_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    after_sue_au.edit_fact_attr(ball_road, balancelink=balancelink_shop(fly_text))
    after_run_credor_weight = 44
    after_run_debtor_weight = 66
    after_sue_au.edit_fact_attr(
        disc_road,
    ...
    x_keylist = [quark_insert(), "agenda_fact_balancelink", disc_road, run_text]
    run_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert run_quarkunit.get_value("road") == disc_road
    assert run_quarkunit.get_value("idea_id") == run_text
    assert run_quarkunit.get_value("road") == disc_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_balancelink_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_au = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    x_keylist = [quark_update(), "agenda_fact_balancelink", ball_road, run_text]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_beliefunit_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    before_sue_agendaunit.add_fact(factunit_shop(bend_text), knee_road)
    broken_text = "broke cartilage"
    broken_road = before_sue_agendaunit.make_road(knee_road, broken_text)
    before_sue_agendaunit.add_l1_fact(factunit_shop(knee_text))
    before_sue_agendaunit.add_fact(factunit_shop(broken_text), knee_road)
    before_broken_open = 11
    before_broken_nigh = 22
    before_sue_agendaunit.edit_fact_attr(
        ball_road,
    ...
    x_keylist = [quark_update(), "agenda_fact_beliefunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_beliefunit_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    # THEN
    print(f"{print_quarkunit_keys(sue_nucunit)=}")
    x_keylist = [quark_insert(), "agenda_fact_beliefunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
    assert ball_quarkunit.get_value("base") == knee_road
    assert ball_quarkunit.get_value("pick") == broken_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_beliefunit_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    # THEN
    print(f"{print_quarkunit_keys(sue_nucunit)=}")
    x_keylist = [quark_delete(), "agenda_fact_beliefunit", ball_road, knee_road]
    ball_quarkunit = get_nested_value(sue_nucunit.quarkunits, x_keylist)
    assert ball_quarkunit.get_value("road") == ball_road
    assert ball_quarkunit.get_value("base") == knee_road
    assert ball_quarkunit.get_value("road") == ball_road
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reason_premiseunit_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reason_premiseunit_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reason_premiseunit_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reasonunit_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    before_sue_agendaunit.add_l1_fact(factunit_shop(knee_text))
    before_sue_agendaunit.add_fact(factunit_shop(medical_text), knee_road)

    after_sue_agendaunit = copy_deepcopy(before_sue_agendaunit)
    after_medical_suff_fact_active = False
    after_sue_agendaunit.edit_fact_attr(
        road=ball_road,
        reason_base=medical_road,
        reason_suff_fact_active=after_medical_suff_fact_active,
    )
    ...
    assert (
        ball_quarkunit.get_value("suff_fact_active") == after_medical_suff_fact_active
    )
    assert get_quarkunit_total_count(sue_nucunit) == 1


def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reasonunit_update():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    before_sue_agendaunit.add_l1_fact(factunit_shop(knee_text))
    before_sue_agendaunit.add_fact(factunit_shop(medical_text), knee_road)
    before_medical_suff_fact_active = True
    before_sue_agendaunit.edit_fact_attr(
        road=ball_road,
        reason_base=medical_road,
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_reasonunit_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    sports_text = "sports"
    ...
    after_sue_agendaunit = copy_deepcopy(before_sue_agendaunit)
    after_ball_fact = after_sue_agendaunit.get_fact_obj(ball_road)
    after_ball_fact.del_reasonunit_base(medical_road)
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_suffidea_insert():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    after_sue_agendaunit = copy_deepcopy(before_sue_agendaunit)
    after_ball_factunit = after_sue_agendaunit.get_fact_obj(ball_road)
    after_ball_factunit._assignedunit.set_suffidea(rico_text)
...
def test_NucUnit_add_all_different_quarkunits_Creates_QuarkUnit_fact_suffidea_delete():
    # GIVEN
    sue_text = "Sue"
    before_sue_agendaunit = agendaunit_shop(sue_text)
    rico_text = "Rico"
    ...
    ball_road = before_sue_agendaunit.make_road(sports_road, ball_text)
    before_sue_agendaunit.add_fact(factunit_shop(ball_text), sports_road)
    before_ball_factunit = before_sue_agendaunit.get_fact_obj(ball_road)
    before_ball_factunit._assignedunit.set_suffidea(rico_text)

    after_sue_agendaunit = copy_deepcopy(before_sue_agendaunit)
    after_ball_factunit = after_sue_agendaunit.get_fact_obj(ball_road)
    after_ball_factunit._assignedunit.del_suffidea(rico_text)
