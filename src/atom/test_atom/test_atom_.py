...
from src.atom.examples.example_quarks import get_quark_example_oathunit_sports
...
def test_AtomUnit_set_nucunit_SetsAttribute():
    ...
    farm_nucunit.set_quarkunit(get_quark_example_oathunit_sports())
...
def test_AtomUnit_quarkunit_exists_ReturnsCorrectObj():
    ...
    # WHEN
    sports_quarkunit = get_quark_example_oathunit_sports()
