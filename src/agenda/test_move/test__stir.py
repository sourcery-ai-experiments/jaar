...
def test_category_ref_ReturnsCorrectObj():
    assert get_stir_config_dict() != None
...
def test_get_stir_config_dict_EveryCrudOperationHasMoveOrderGroup():
    ...
    mog = stir_order_text
    # # Simple script for editing move_categorys.json
    # set_mog("partyunit", stir_insert(), mog, 0)
    # set_mog("groupunit_partylink", stir_insert(), mog, 1)
    # set_mog("groupunit", stir_insert(), mog, 2)
    # set_mog("idea", stir_insert(), mog, 3)
    # set_mog("idea_balancelink", stir_insert(), mog, 4)
    # set_mog("idea_suffgroup", stir_insert(), mog, 5)
    # set_mog("idea_beliefunit", stir_insert(), mog, 6)
    # set_mog("idea_reasonunit", stir_insert(), mog, 7)
    # set_mog("idea_reasonunit_premiseunit", stir_insert(), mog, 8)
    # set_mog("partyunit", stir_update(), mog, 9)
    # set_mog("groupunit", stir_update(), mog, 10)
    # set_mog("groupunit_partylink", stir_update(), mog, 11)
    # set_mog("idea", stir_update(), mog, 12)
    # set_mog("idea_balancelink", stir_update(), mog, 13)
    # set_mog("idea_beliefunit", stir_update(), mog, 14)
    # set_mog("idea_reasonunit_premiseunit", stir_update(), mog, 15)
    # set_mog("idea_reasonunit", stir_update(), mog, 16)
    # set_mog("idea_reasonunit_premiseunit", stir_delete(), mog, 17)
    # set_mog("idea_reasonunit", stir_delete(), mog, 18)
    # set_mog("idea_beliefunit", stir_delete(), mog, 19)
    # set_mog("idea_suffgroup", stir_delete(), mog, 20)
    # set_mog("idea_balancelink", stir_delete(), mog, 21)
    # set_mog("idea", stir_delete(), mog, 22)
    # set_mog("groupunit_partylink", stir_delete(), mog, 23)
    # set_mog("partyunit", stir_delete(), mog, 24)
    # set_mog("groupunit", stir_delete(), mog, 25)
    # set_mog("AgendaUnit_weight", stir_update(), mog, 26)
    # set_mog("_max_tree_traverse", stir_update(), mog, 26)
    # set_mog("_party_creditor_pool", stir_update(), mog, 26)
    # set_mog("_party_debtor_pool", stir_update(), mog, 26)
    # set_mog("_auto_output_to_forum", stir_update(), mog, 26)
    # set_mog("_meld_strategy", stir_update(), mog, 26)

    assert 0 == get_mog("partyunit", stir_insert(), mog, 0)
    assert 1 == get_mog("groupunit_partylink", stir_insert(), mog, 1)
    assert 2 == get_mog("groupunit", stir_insert(), mog, 2)
    assert 3 == get_mog("idea", stir_insert(), mog, 3)
    assert 4 == get_mog("idea_balancelink", stir_insert(), mog, 4)
    assert 5 == get_mog("idea_suffgroup", stir_insert(), mog, 5)
    assert 6 == get_mog("idea_beliefunit", stir_insert(), mog, 6)
    assert 7 == get_mog("idea_reasonunit", stir_insert(), mog, 7)
    assert 8 == get_mog("idea_reasonunit_premiseunit", stir_insert(), mog, 8)
    assert 9 == get_mog("partyunit", stir_update(), mog, 9)
    assert 10 == get_mog("groupunit", stir_update(), mog, 10)
    assert 11 == get_mog("groupunit_partylink", stir_update(), mog, 11)
    assert 12 == get_mog("idea", stir_update(), mog, 12)
    assert 13 == get_mog("idea_balancelink", stir_update(), mog, 13)
    assert 14 == get_mog("idea_beliefunit", stir_update(), mog, 14)
    assert 15 == get_mog("idea_reasonunit_premiseunit", stir_update(), mog, 15)
    assert 16 == get_mog("idea_reasonunit", stir_update(), mog, 16)
    assert 17 == get_mog("idea_reasonunit_premiseunit", stir_delete(), mog, 17)
    assert 18 == get_mog("idea_reasonunit", stir_delete(), mog, 18)
    assert 19 == get_mog("idea_beliefunit", stir_delete(), mog, 19)
    assert 20 == get_mog("idea_suffgroup", stir_delete(), mog, 20)
    assert 21 == get_mog("idea_balancelink", stir_delete(), mog, 21)
    assert 22 == get_mog("idea", stir_delete(), mog, 22)
    assert 23 == get_mog("groupunit_partylink", stir_delete(), mog, 23)
    assert 24 == get_mog("partyunit", stir_delete(), mog, 24)
    assert 25 == get_mog("groupunit", stir_delete(), mog, 25)
    assert 26 == get_mog("AgendaUnit_weight", stir_update(), mog, 26)
    assert 26 == get_mog("_max_tree_traverse", stir_update(), mog, 26)
    assert 26 == get_mog("_party_creditor_pool", stir_update(), mog, 26)
    assert 26 == get_mog("_party_debtor_pool", stir_update(), mog, 26)
    assert 26 == get_mog("_auto_output_to_forum", stir_update(), mog, 26)
    assert 26 == get_mog("_meld_strategy", stir_update(), mog, 26)
