...
def create_legible_list(x_book: BookUnit, x_agenda: AgendaUnit) -> list[str]:
    ...
    x_list = [atom_insert(), "agenda_idea_healerunit"]
    agenda_idea_healerunit_insert_dict = get_leg_obj(atoms_dict, x_list)
    x_list = [atom_delete(), "agenda_idea_healerunit"]
    agenda_idea_healerunit_delete_dict = get_leg_obj(atoms_dict, x_list)
    ...
    if agenda_idea_healerunit_insert_dict != None:
        add_agenda_idea_healerunit_insert_to_legible_list(
            leg_list, agenda_idea_healerunit_insert_dict, x_agenda
        )
    if agenda_idea_healerunit_delete_dict != None:
        add_agenda_idea_healerunit_delete_to_legible_list(
            leg_list, agenda_idea_healerunit_delete_dict, x_agenda
        )
...
def add_agenda_idea_healerunit_insert_to_legible_list(
    legible_list: list[str], idea_healerunit_insert_dict: dict, x_agenda: AgendaUnit
):
    for road_dict in idea_healerunit_insert_dict.values():
        for idea_healerunit_atom in road_dict.values():
            group_id_value = idea_healerunit_atom.get_value("group_id")
            road_value = idea_healerunit_atom.get_value("road")
            x_str = f"healerunit '{group_id_value}' created for idea '{road_value}'."
            legible_list.append(x_str)


def add_agenda_idea_healerunit_delete_to_legible_list(
    legible_list: list[str], idea_healerunit_delete_dict: dict, x_agenda: AgendaUnit
):
    for road_dict in idea_healerunit_delete_dict.values():
        for idea_healerunit_atom in road_dict.values():
            group_id_value = idea_healerunit_atom.get_value("group_id")
            road_value = idea_healerunit_atom.get_value("road")
