...
from src.agenda.examples.example_books import get_sue_bookunit_example1
...
def test_BookUnit_exists():
    ...
    # THEN
    assert x_bookunit.learnunits is None
...
def test_BookUnit_set_learnunit_CorrectlySets_AgendaUnitSimpleAttrs():
    # GIVEN
    sue_bookunit = bookunit_shop()
    attribute_value = 55
    category = "agendaunit"
    ...
    # WHEN
    sue_bookunit.set_learnunit(agenda_weight_learnunit)

    # THEN
    assert len(sue_bookunit.learnunits) == 1
    x_update_dict = sue_bookunit.learnunits.get(learn_update())
...
def test_BookUnit_set_learnunit_RaisesErrorWhen_is_valid_IsFalse():
    # GIVEN
    sue_bookunit = bookunit_shop()
...
def test_BookUnit_get_learn_ReturnsCorrectObj():
    # GIVEN
    sue_bookunit = bookunit_shop()
    ...
    sue_bookunit.set_learnunit(agendaunit_learnunit)

    # WHEN
    gen_learnunit = sue_bookunit.get_learnunit(
...
def test_BookUnit_add_learnunit_CorrectlySets_AgendaUnitSimpleAttrs():
    # GIVEN
    sue_bookunit = bookunit_shop()
    assert sue_bookunit.learnunits == {}
...
def test_BookUnit_add_learnunit_CorrectlySets_AgendaUnit_partyunits():
    # GIVEN
    sue_bookunit = bookunit_shop()
    assert sue_bookunit.learnunits == {}
    ...
    assert (
        sue_bookunit.learnunits.get(learn_insert()).get(partyunit_text).get(bob_text)
        != None
    )


# def test_BookUnit_add_learnunit_CorrectlySets_AgendaUnit_max_tree_traverse():
#     # GIVEN
#     sue_bookunit = bookunit_shop(get_sue_road())
#     assert sue_bookunit.learnunits == {}
...
#     sue_bookunit.set_learnunit(weight_learnunit)
#     # THEN
#     assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 1
#     sue_agendaunit_dict = sue_bookunit.learnunits.get(learn_update())
...
#     # THEN
#     print(f"{sue_bookunit.learnunits.keys()=}")
#     print(f"{sue_bookunit.learnunits.get(learn_update()).keys()=}")
#     # print(f"{get_all_nondictionary_objs(sue_bookunit.learnunits).get(learn_update())=}")
#     assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 2
#     assert x_learnunit == sue_bookunit.learnunits.get(learn_update()).get(x_attribute)
...
#     sue_bookunit.set_learnunit(x_learnunit)
#     # THEN
#     assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 3
#     assert x_learnunit == sue_bookunit.learnunits.get(learn_update()).get(x_attribute)
...
#     sue_bookunit.set_learnunit(x_learnunit)
#     # THEN
#     assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 4
#     assert x_learnunit == sue_bookunit.learnunits.get(learn_update()).get(x_attribute)
...
#     sue_bookunit.set_learnunit(x_learnunit)
#     # THEN
#     assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 5
#     assert x_learnunit == sue_bookunit.learnunits.get(learn_update()).get(x_attribute)


def test_BookUnit_get_learn_order_learnunit_dict_ReturnsCorrectObj():
    # GIVEN
    sue_bookunit = get_sue_bookunit_example1()
    assert len(sue_bookunit.learnunits.get(learn_update()).keys()) == 1
    assert sue_bookunit.learnunits.get(learn_insert()) is None
    assert len(sue_bookunit.learnunits.get(learn_delete()).keys()) == 1

    # WHEN
    sue_learn_order_dict = sue_bookunit.get_learn_order_learnunit_dict()
