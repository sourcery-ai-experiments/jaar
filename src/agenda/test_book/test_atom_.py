...
def test_get_atom_config_dict_EveryCrudOperationHasBookOrderGroup():
    ...
    # set_mog("agenda_idea_leaderunit", atom_insert(), mog, 6)
    ...
    # set_mog("agenda_idea_leaderunit", atom_delete(), mog, 22)
    ...
    assert 6 == get_atom_order("agenda_idea_leaderunit", atom_insert(), mog, 6)
    ...
    assert 22 == get_atom_order("agenda_idea_leaderunit", atom_delete(), mog, 22)
