...
def test_get_grain_config_dict_EveryCrudOperationHasLearnOrderGroup():
    ...
    # set_mog("idea_healerhold", grain_insert(), mog, 6)
    # set_mog("idea_beliefunit", grain_insert(), mog, 7)
    # set_mog("idea_reasonunit", grain_insert(), mog, 8)
    # set_mog("idea_reason_premiseunit", grain_insert(), mog, 9)
    # set_mog("partyunit", grain_update(), mog, 10)
    # set_mog("groupunit", grain_update(), mog, 11)
    # set_mog("partylink", grain_update(), mog, 12)
    # set_mog("ideaunit", grain_update(), mog, 13)
    # set_mog("idea_balancelink", grain_update(), mog, 14)
    # set_mog("idea_beliefunit", grain_update(), mog, 15)
    # set_mog("idea_reason_premiseunit", grain_update(), mog, 16)
    # set_mog("idea_reasonunit", grain_update(), mog, 17)
    # set_mog("idea_reason_premiseunit", grain_delete(), mog, 18)
    # set_mog("idea_reasonunit", grain_delete(), mog, 19)
    # set_mog("idea_beliefunit", grain_delete(), mog, 20)
    # set_mog("idea_suffgroup", grain_delete(), mog, 21)
    # set_mog("idea_healerhold", grain_delete(), mog, 22)
    # set_mog("idea_balancelink", grain_delete(), mog, 23)
    # set_mog("ideaunit", grain_delete(), mog, 24)
    # set_mog("partylink", grain_delete(), mog, 25)
    # set_mog("partyunit", grain_delete(), mog, 26)
    # set_mog("groupunit", grain_delete(), mog, 27)
    # set_mog("agendaunit", grain_update(), mog, 28)
    ...
    assert 6 == get_mog("idea_healerhold", grain_insert(), mog, 6)
    assert 7 == get_mog("idea_beliefunit", grain_insert(), mog, 7)
    assert 8 == get_mog("idea_reasonunit", grain_insert(), mog, 8)
    assert 9 == get_mog("idea_reason_premiseunit", grain_insert(), mog, 9)
    assert 10 == get_mog("partyunit", grain_update(), mog, 10)
    assert 11 == get_mog("groupunit", grain_update(), mog, 11)
    assert 12 == get_mog("partylink", grain_update(), mog, 12)
    assert 13 == get_mog("ideaunit", grain_update(), mog, 13)
    assert 14 == get_mog("idea_balancelink", grain_update(), mog, 14)
    assert 15 == get_mog("idea_beliefunit", grain_update(), mog, 15)
    assert 16 == get_mog("idea_reason_premiseunit", grain_update(), mog, 16)
    assert 17 == get_mog("idea_reasonunit", grain_update(), mog, 17)
    assert 18 == get_mog("idea_reason_premiseunit", grain_delete(), mog, 18)
    assert 19 == get_mog("idea_reasonunit", grain_delete(), mog, 19)
    assert 20 == get_mog("idea_beliefunit", grain_delete(), mog, 20)
    assert 21 == get_mog("idea_suffgroup", grain_delete(), mog, 21)
    assert 22 == get_mog("idea_healerhold", grain_delete(), mog, 22)
    assert 23 == get_mog("idea_balancelink", grain_delete(), mog, 23)
    assert 24 == get_mog("ideaunit", grain_delete(), mog, 24)
    assert 25 == get_mog("partylink", grain_delete(), mog, 25)
    assert 26 == get_mog("partyunit", grain_delete(), mog, 26)
    assert 27 == get_mog("groupunit", grain_delete(), mog, 27)
    assert 28 == get_mog("agendaunit", grain_update(), mog, 28)
