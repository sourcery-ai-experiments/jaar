from src.agenda.idea import idea_kid_shop, IdeaAttrFilter, IdeaUnit, EconomyID
...
def test_idea_balancelink_meld_BaseScenarioWorks_on_meld_weight_actionEquals_default():
    # GIVEN
    casa_text = "casa"
    yx1 = idea_kid_shop("spirit", _parent_road=casa_text)
    br1 = "Running"
...
def test_idea_acptfactunits_meld_BaseScenarioWorks():
    ...
    yx2 = idea_kid_shop("fun", _parent_road=casa_text)
...
def test_idea_attributes_meld_CorrectlyMeldsIdeas():
    ...
    label1_text = "spirit"
    texas_text = "texas"
    yx1 = idea_kid_shop(label1_text, _agenda_economy_id=texas_text)
    custom_set_idea_attr(
        idea=yx1,
        uid=uid_x,
        weight=7,
    ...
    label2_text = "fun"
    yx2 = idea_kid_shop(label2_text, _agenda_economy_id=texas_text)
    custom_set_idea_attr(
        idea=yx2,
        uid=uid_x,
        weight=7,
...
def test_idea_meld_CorrectlyCreatesOriginUnitWithOriginLink():
    # GIVEN
    label1_text = "spirit"
    yx1 = idea_kid_shop(label1_text)

    label2_text = "fun"
    yx2 = idea_kid_shop(label2_text)
...
def test_idea_meld_IdeaMeldingItselfCreatesOriginUnitWithCorrectOriginLink():
    ...
    tim_text = "Tim"
    tim_weight = 7
    tim_idea = idea_kid_shop(tim_text)
