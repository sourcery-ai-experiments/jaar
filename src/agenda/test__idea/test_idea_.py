...
from src.agenda.belief import BeliefID, balancelink_shop, balanceheir_shop
...
def test_IdeaUnit_set_assignedheir_CorrectlySetsAttr():
    ...
    # WHEN
    sport_idea.set_assignedheir(parent_assignheir=None, agenda_beliefs=None)
    ...
    swim_assigned_heir.set_suffbeliefs(
        assignunit=swim_assignedunit, parent_assignheir=None, agenda_beliefs=None
    )
