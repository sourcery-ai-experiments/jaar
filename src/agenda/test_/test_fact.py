...
def test_FactUnit_clear_range_works_1():
    # GIVEN
    weekday_text = "weekdays"
    weekday_road = create_road(root_label(), weekday_text)
...
def test_FactUnit_clear_range_works_2():
    # GIVEN
    weekday_text = "weekdays"
    weekday_road = create_road(root_label(), weekday_text)
    weekday_fact = factunit_shop(weekday_road, weekday_road, open=1.0, nigh=5.0)
...
def test_FactUnit_get_dict_CorrectlyReturnsDict():
    # GIVEN
    weekday_text = "weekdays"
    weekday_road = create_road(root_label(), weekday_text)
    sunday_text = "Sunday"
...
def test_FactUnit_get_dict_CorrectlyReturnsPartialDict():
    # GIVEN
    weekday_text = "weekdays"
    weekday_road = create_road(root_label(), weekday_text)
    sunday_text = "Sunday"
...
def test_FactUnit_find_replace_road_works():
    # GIVEN
...
def test_FactHeir_IsChangedByFactUnit():
    # GIVEN
...
def test_FactHeir_is_range_ReturnsRangeStatus():
    ...
    assert x_factheir.is_range() == False
...
def test_FactCore_get_obj_key_works():
    # GIVEN
    ced_min_text = "ced_minute"
    min_road = create_road(root_label(), ced_min_text)
    secs_text = "seconds"
...
def test_factcores_meld_CorrectlyMeldLikeObjs_v1():
    # GIVEN
    tech_text = "tech"
...
def test_factcores_meld_CorrectlyMeldLikeObjs_v2():
    # GIVEN
    tech_text = "tech"
    tech_road = create_road(root_label(), tech_text)
    bowl_text = "bowl"
