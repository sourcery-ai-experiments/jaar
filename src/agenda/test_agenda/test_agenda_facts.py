...
def test_AgendaUnit_set_fact_CorrectlyModifiesAttr_1():
    # GIVEN
    ...
    x_idearoot._factunits = {sunday_agenda_fact.base: sunday_agenda_fact}
    ...
    # THEN
    assert x_idearoot._factunits == {sunday_agenda_fact.base: sunday_agenda_fact}
...
def test_AgendaUnit_set_fact_CorrectlyModifiesAttr_2():
    # GIVEN
    x_agenda = examples_get_agenda_with_4_levels()
    weekday_road = x_agenda.make_l1_road("weekdays")
    sunday_road = x_agenda.make_road(weekday_road, "Sunday")
...
def test_AgendaUnit_set_fact_CorrectlyModifiesAttrWhen_pick_IsNone():
    # GIVEN
    x_agenda = examples_get_agenda_with_4_levels()
    weekday_road = x_agenda.make_l1_road("weekdays")

    # WHEN
    x_agenda.set_fact(base=weekday_road, open=5, nigh=7)

    # THEN
    sunday_agenda_fact = factunit_shop(weekday_road, weekday_road, 5, 7)
    x_idearoot = x_agenda._idearoot
    assert x_idearoot._factunits == {sunday_agenda_fact.base: sunday_agenda_fact}


def test_AgendaUnit_set_fact_CorrectlyModifiesAttrWhen_open_IsNone():
    # GIVEN
    x_agenda = examples_get_agenda_with_4_levels()
    weekday_road = x_agenda.make_l1_road("weekdays")
    x_agenda.set_fact(base=weekday_road, open=5, nigh=7)
    ...
    # WHEN
    x_agenda.set_fact(base=weekday_road, nigh=10)
...
def test_AgendaUnit_set_fact_FailsToCreateWhenBaseAndFactAreDifferenctAndFactIdeaIsNotRangeRoot():
    # GIVEN
...
def test_AgendaUnit_del_fact_CorrectlyModifiesAttr():
    # GIVEN
    x_agenda = examples_get_agenda_with_4_levels()
    weekday_road = x_agenda.make_l1_road("weekdays")
    sunday_road = x_agenda.make_road(weekday_road, "Sunday")
...
def test_AgendaUnit_get_idea_list_FactHeirsCorrectlyInherited():
    # GIVEN
    bob_agenda = agendaunit_shop("Bob")
    swim_text = "swim"
...
def test_AgendaUnit_get_idea_list_FactUnitCorrectlyTransformsfactheir_shop():
    # GIVEN
    bob_agenda = agendaunit_shop("Bob")
    swim_text = "swim"
    swim_road = bob_agenda.make_l1_road(swim_text)
...
def test_AgendaUnit_get_idea_list_FactHeirCorrectlyDeletesFactUnit():
    # GIVEN
...
def test_AgendaUnit_set_fact_create_missing_ideas_CreatesBaseAndFact():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    ...
    # WHEN
    sue_agenda.set_fact(situations_road, climate_road, create_missing_ideas=True)
...
def test_AgendaUnit_get_fact_ReturnsFactUnit():
    # GIVEN
    sue_agenda = agendaunit_shop("Sue")
    situations_text = "situations"
    situations_road = sue_agenda.make_l1_road(situations_text)
    ...
    # WHEN
    generated_situations_base = sue_agenda.get_fact(situations_road)

    # THEN
    static_situations_base = sue_agenda._idearoot._factunits.get(situations_road)
