...
def test_agenda_get_dict_ReturnsDictObject():
    ...
    day_hour_road = f"{x_agenda._culture_qid},{day_hour_text}"
    ...
    time_minute = f"{x_agenda._culture_qid},day_minute"
...
def test_agenda_get_dict_ReturnsDictWith_ideakid_AssignedUnit():
    ...
    morn_text = "morning"
    morn_road = f"{x_agenda._culture_qid},{morn_text}"
    x_agenda.add_idea(
...
def test_export_to_JSON_BigExampleCorrectlyReturnsValues():
    ...
    cont_road = f"{x_agenda._culture_qid},{cont_text}"
...
def test_agenda_get_json_CorrectlyWorksForSimpleExample():
    ...
    shave_text = "shave"
    shave_road = f"{y_agenda._culture_qid},{shave_text}"
    ...
    weekday_road = f"{y_agenda._culture_qid},{weekday_text}"
