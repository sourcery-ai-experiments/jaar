...
def test_agenda_requiredheirs_AreCorrectlyInherited_v1():
    ...
    work_road = f"{x_agenda._culture_handle},{work_text}"
    week_label = "weekdays"
    week_road = f"{x_agenda._culture_handle},{week_label}"
    wed_text = "Wednesday"
...
def test_agenda_requiredheirs_AreCorrectlyInheritedTo4LevelsFromRoot():
    ...
    work_text = "work"
    work_road = f"{a4_agenda._culture_handle},{work_text}"
    week_text = "weekdays"
    week_road = f"{a4_agenda._culture_handle},{week_text}"
    wed_text = "Wednesday"
    wed_road = f"{week_road},{wed_text}"
...
def test_agenda_requiredheirs_AreCorrectlyInheritedTo4LevelsFromLevel2():
    ...
    work_road = f"{a4_agenda._culture_handle},{work_text}"
    week_label = "weekdays"
    week_road = f"{a4_agenda._culture_handle},{week_label}"
    wed_text = "Wednesday"
    wed_road = f"{week_road},{wed_text}"
...
def test_agenda_requiredunits_set_sufffactIdeaWithBeginCloseSetsSuffFactOpenNigh():
    ...
    time = "time"
    time_road = f"{x_agenda._culture_handle},{time}"
    rus_war = "rus_war"
...
def test_agenda_requiredunits_del_required_sufffact_UncoupledMethod1():
    ...
    x_agenda = example_agendas_get_agenda_with_4_levels()
    work_road = f"{x_agenda._culture_handle},work"
    weekday_road = f"{x_agenda._culture_handle},weekdays"
    wed_road = f"{x_agenda._culture_handle},weekdays,Wednesday"

    x_agenda.edit_idea_attr(
        road=work_road, required_base=weekday_road, required_sufffact=wed_road
    )
    thu_road = f"{x_agenda._culture_handle},weekdays,Thursday"
    x_agenda.edit_idea_attr(
        road=work_road,
...
def test_agenda_requiredunits_del_required_sufffact_UncoupledMethod2():
    ...
    x_agenda = example_agendas_get_agenda_with_4_levels()
    work_road = f"{x_agenda._culture_handle},work"
    weekdays_road = f"{x_agenda._culture_handle},weekdays"
    work_idea1 = x_agenda.get_idea_kid(road=work_road)
