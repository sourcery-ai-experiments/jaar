...
def test_agenda_edit_idea_attr_CorrectlySetsAssignedUnit():
    ...
    x_agenda.add_idea(ideaunit_shop(run_text), parent_road=x_agenda._economy_id)
...
def test_agenda_ideakid_assignedunit_CorrectlySets_grandchild_idea_assignedheir():
    ...
    x_agenda.add_idea(ideaunit_shop(morn_text), parent_road=swim_road)
    x_agenda.add_idea(ideaunit_shop(four_text), parent_road=morn_road)
...
def test_AgendaUnit__get_filtered_balancelinks_idea_CorrectlyFiltersIdea_AssignUnit():
    ...
    x_agenda1.add_idea(ideaunit_shop(work_text), parent_road=x_agenda1._economy_id)
    x_agenda1.add_idea(ideaunit_shop(swim_text), parent_road=x_agenda1._economy_id)
