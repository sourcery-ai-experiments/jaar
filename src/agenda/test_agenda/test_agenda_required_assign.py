...
def test_AgendaUnit__get_filtered_balancelinks_idea_CorrectlyFiltersIdea_AssignUnit():
    ...
    work_text = "work"
    work_road = x_agenda1.make_road(x_agenda1._culture_qid, work_text)
    swim_text = "swim"
    swim_road = x_agenda1.make_road(x_agenda1._culture_qid, swim_text)
    x_agenda1.add_idea(ideacore_shop(work_text), pad=x_agenda1._culture_qid)
    x_agenda1.add_idea(ideacore_shop(swim_text), pad=x_agenda1._culture_qid)
