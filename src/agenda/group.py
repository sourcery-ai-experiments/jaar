...
class GroupUnit(GroupCore):
    ...
    _agenda_credit: float = None  # calculated by AgendaUnit.calc_intent()
    _agenda_debt: float = None  # calculated by AgendaUnit.calc_intent()
    _agenda_intent_credit: float = None  # calculated by AgendaUnit.calc_intent()
    _agenda_intent_debt: float = None  # calculated by AgendaUnit.calc_intent()
