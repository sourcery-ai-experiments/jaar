...
# created to help make code readable. Holds some FactUnit attributes
@dataclass
class YB:
    n: str = None
    weight: int = 1
...
@dataclass
class HregTimeFactSource:
    delimiter: str

    def _get_time_hreg_src_fact(self, c400_count: int):
        time_text = "time"
        min_text = "minutes"
    ...
    def _get_time_hreg_ced(self, local_root: str, tech: str, c400_count: int):
        ...
        list_x += self._get_time_hreg_segment400(local_root=rt, multipler=m)
        ...
        list_x += self._get_time_hreg_weekday_fact(
    ...
    def _get_time_hreg_weekday_fact(
    ...
    def _get_time_hreg_segment400(self, local_root: str, multipler: int):
        m = multipler
        tech = get_c400()
