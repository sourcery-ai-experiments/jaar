from src.agenda.road import get_road, Road, RaodNode
...
class HregTimeIdeaSource:
    ...
    def get_tech_road(self, local_root) -> Road:
        return self.roxd(local_root, "tech")

    def get_tech_type_road(self, local_root, tech_type) -> Road:
        return self.roxd(self.get_tech_road(local_root), tech_type)

    def get_jajatime_road(self, local_root) -> Road:
