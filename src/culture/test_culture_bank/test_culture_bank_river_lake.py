...
def test_culture_set_credit_lake_for_agenda_CorrectlyPopulatesriver_tallyTable01(
    env_dir_setup_cleanup,
):
...
def test_culture_set_credit_lake_for_agenda_CorrectlyPopulatesriver_tallyTable02(
    env_dir_setup_cleanup,
):
...
def test_culture_set_credit_lake_for_agenda_CorrectlyPopulatesriver_tallyTable03(
    env_dir_setup_cleanup,
):
...
def test_culture_set_credit_lake_for_agenda_CorrectlyPopulatesriver_tallyTable04(
    env_dir_setup_cleanup,
):
...
def test_culture_set_credit_lake_for_agenda_CorrectlyPopulatesriver_tallyTable05(
    env_dir_setup_cleanup,
):
...
def test_culture_set_credit_lake_for_agenda_CorrectlyDeletesPreviousRiver(
    env_dir_setup_cleanup,
):
    # GIVEN 4 agendas, 100% of river flows to sal
    culture_handle = get_temp_env_handle()
    ...
    x_culture.set_credit_lake_for_agenda(agenda_healer=sal_text)
    x_culture.set_credit_lake_for_agenda(agenda_healer=elu_text)
...
def test_culture_set_credit_lake_for_agenda_CorrectlyUsesMaxFlowsCount(
    env_dir_setup_cleanup,
):
    # GIVEN 5 agendas, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    culture_handle = get_temp_env_handle()
    ...
    # WHEN
    mtc = 13
    x_culture.set_credit_lake_for_agenda(agenda_healer=sal_text, max_flows_count=mtc)
...
def test_culture_set_credit_lake_for_agenda_CorrectlyBuildsASingleContinuousRange(
    env_dir_setup_cleanup,
):
    # GIVEN 5 agendas, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    culture_handle = get_temp_env_handle()
...
def test_culture_set_credit_lake_for_agenda_CorrectlyUpatesAgendaPartyUnits(
    env_dir_setup_cleanup,
):
    """GIVEN 5 agendas, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal"""
    # GIVEN
