...
from src.culture.examples.council_env_kit import get_temp_culture_id
...
def get_Jnode2node_agenda() -> AgendaUnit:
    ...
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("A"), pad=x_agenda._culture_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_2node_agenda() -> AgendaUnit:
    ...
    x_agenda.add_idea(idea_b, pad=get_temp_culture_id())
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_3node_agenda() -> AgendaUnit:
    ...
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("B"), pad=x_agenda._culture_id)
    x_agenda.add_idea(ideacore_shop("C"), pad=x_agenda._culture_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_3node_D_E_F_agenda() -> AgendaUnit:
    ...
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("E"), pad=x_agenda._culture_id)
    x_agenda.add_idea(ideacore_shop("F"), pad=x_agenda._culture_id)
    x_agenda.set_agenda_metrics()
    return x_agenda
...
def get_6node_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("A")
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("B"), x_agenda._culture_id)
    x_agenda.add_idea(ideacore_shop("C"), x_agenda._culture_id)
...
def get_7nodeInsertH_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("A")
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("B"), x_agenda.make_road(x_agenda._culture_id))
    x_agenda.add_idea(ideacore_shop("C"), x_agenda.make_road(x_agenda._culture_id))
    c_road = x_agenda.make_l1_road("C")
...
def get_7nodeJRoot_agenda() -> AgendaUnit:
    x_agenda = agendaunit_shop("J")
    x_agenda.set_culture_id(get_temp_culture_id())
    x_agenda.add_idea(ideacore_shop("A"), x_agenda._culture_id)
...
def get_healer_2agenda(env_dir, culture_id) -> CouncilUnit:
    yao_text = "Xio"
    yao_healer = councilunit_shop(yao_text, env_dir, culture_id)
...
def get_agenda_2CleanNodesRandomWeights(_healer: str = None) -> AgendaUnit:
    ...
    casa_road = f"{x_agenda._culture_id},{casa_text}"
...
def get_agenda_3CleanNodesRandomWeights(_healer: str = None) -> AgendaUnit:
    ...
    x_agenda = agendaunit_shop(healer_text)
    casa_text = "casa"
    x_agenda.add_idea(ideacore_shop(casa_text), pad=x_agenda._culture_id)
    casa_road = f"{x_agenda._culture_id},{casa_text}"
    cookery_text = "clean cookery"
    bedroom_text = "clean bedroom"
