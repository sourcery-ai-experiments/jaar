...
def test_MoneyUnit_treasury_get_worldunits_ReturnsCorrectNoneObj(
    ...
    ava_text = "Ava"
    elu_text = "Elu"
    x_money.userhub.save_job_world(worldunit_shop(_owner_id=sal_text))
    x_money.userhub.save_job_world(worldunit_shop(_owner_id=bob_text))
    x_money.userhub.save_job_world(worldunit_shop(_owner_id=tom_text))
    x_money.userhub.save_job_world(worldunit_shop(_owner_id=ava_text))
    x_money.userhub.save_job_world(worldunit_shop(_owner_id=elu_text))
    x_money.refresh_treasury_job_worlds_data()
    x_worldtreasuryunits = get_worldtreasuryunits_dict(x_money.get_treasury_conn())
