...
def test_get_credorledger_ReturnsCorrectObj():
    ...
    yao_world.add_otherunit(bob_text, yao_credor_weight)
    yao_world.add_otherunit(sue_text, bob_credor_weight)
    yao_world.add_otherunit(yao_text, sue_credor_weight)
...
def test_get_credorledger_ReturnsCorrectObjWithNoEmpty_credor_weight():
    ...
    yao_world.add_otherunit(sue_text, sue_credor_weight)
...
def test_get_debtorledger_ReturnsCorrectObj():
    ...
    yao_world = worldunit_shop(yao_text)
    yao_world.add_otherunit(bob_text, 2, bob_debtor_weight)
    yao_world.add_otherunit(sue_text, 2, sue_debtor_weight)
    yao_world.add_otherunit(yao_text, 2, yao_debtor_weight)
...
def test_RiverRun_set_tax_dues_CorrectlySetsAttr():
    ...
    bob_world.add_otherunit(bob_text, 2, bob_debtor_weight)
    bob_world.add_otherunit(sue_text, 2, sue_debtor_weight)
    bob_world.add_otherunit(yao_text, 2, yao_debtor_weight)
