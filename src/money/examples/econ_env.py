...
#     econ_obj: MoneyUnit, src_userhub: UserHub, dst_userhub: UserHub, new_real_id
# ):
#     src_dir = src_userhub.econ_dir()
#     dst_dir = dst_userhub.econ_dir()
...
def copy_evaluation_econ(src_real_id: str, dest_real_id: str):
    ...
    # base_dir = econ_obj.userhub.econ_dir()
