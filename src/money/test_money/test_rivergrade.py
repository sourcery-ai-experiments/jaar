...
def test_RiverGrade_Exists():
    ...
    # THEN
    #: Healer soul get_char._debtor_weight (SELECT tax_due_amount FROM char WHERE char_id = bob_text)
    ...
    #: Healer soul get_char._credor_weight (SELECT grant_amount FROM char WHERE char_id = bob_text)
