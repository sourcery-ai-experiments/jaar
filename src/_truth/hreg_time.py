...
class PremiseUnitHregTime:
    ...
    _every_x_months: int = None  # builds mytruth,time,months
    _on_x_monthday: int = None  # " build mytruth,time,month,monthday
    _every_x_years: int = None  # builds mytruth,time,years
