...
def test_otherlink_shop_reset_truth_cred_debt():
    ...
    biker_other = otherlink_shop(
        other_id=biker_other_id, _truth_cred=0.04, _truth_debt=0.7
    )
    print(f"{biker_other}")

    assert biker_other._truth_cred != None
    assert biker_other._truth_debt != None

    # WHEN
    biker_other.reset_truth_cred_debt()

    # THEN
    assert biker_other._truth_cred == 0
    assert biker_other._truth_debt == 0
