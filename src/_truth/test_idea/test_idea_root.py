...
def test_IdeaUnit_set_idea_label_CorrectlyDoesNotRaisesError():
    ...
    x_idearoot = ideaunit_shop(_root=True, _truth_real_id=el_paso_text)
...
def test_IdeaUnit_set_idea_label_RaisesErrorWhen_truth_real_id_IsNone():
    # GIVEN
    x_idearoot = ideaunit_shop(_root=True)
...
def test_IdeaUnit_set_idea_label_truth_real_id_EqualRootLabelDoesNotRaisesError():
    # GIVEN
    x_idearoot = ideaunit_shop(_root=True, _truth_real_id=root_label())
