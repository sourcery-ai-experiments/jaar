...
def test_AssignedHeir_get_all_suff_others_ReturnsSingleDictWithAllOthers_v1():
    ...
    x_world.add_otherunit(other_id=jim_text)
    ...
    # WHEN
    all_others = assigned_heir_x._get_all_suff_others(world_beliefs=x_world._beliefs)
...
def test_AssignedHeir_set_suffbelief_AssignedUnit_NotEqual_ParentAssignedHeir_NonEmpty():
    ...
    x_world.add_otherunit(other_id=sue_text)
    x_world.add_otherunit(other_id=bob_text)
    x_world.add_otherunit(other_id=tom_text)
