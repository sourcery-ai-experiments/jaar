...
def test_WorldUnit_get_all_pledges_ReturnsCorrectObj():
    ...
    bob_text = "Bob"
    zia_world.add_otherunit(bob_text)
...
def test_WorldUnit_create_agenda_item_CorrectlyCreatesAllWorldAttributes():
    ...
    assert len(zia_world._others) == 0
    ...
    assert zia_world._beliefs.get(family_text)._others in (None, {})
...
def test_agenda_IsSetByAssignedUnit_1OtherBelief():
    ...
    sue_text = "Sue"
    bob_world.add_otherunit(other_id=sue_text)
