...
def test_WorldUnit_3AdvocatesNoideaunit_shop():
    ...
    # print(f"{rico=}")
    zia_world.set_otherunit(otherunit=au_rico)
    zia_world.set_otherunit(otherunit=au_carm)
    zia_world.set_otherunit(otherunit=au_patr)
    ...
    # WHEN
    assert zia_world.get_others_metrics() != None
    others_metrics = zia_world.get_others_metrics()
