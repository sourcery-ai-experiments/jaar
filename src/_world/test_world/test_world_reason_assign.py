...
def test_WorldUnit__get_filtered_cashlinks_idea_CorrectlyFiltersIdea_AssignUnit():
    # GIVEN
    noa_text = "Noa"
    ...
    filtered_idea = noa2_world._get_filtered_cashlinks_idea(noa1_world_swim_idea)
