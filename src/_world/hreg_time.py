...
class PremiseUnitHregTime:
    ...
    _every_x_months: int = None  # builds myworld,time,months
    _on_x_monthday: int = None  # " build myworld,time,month,monthday
    _every_x_years: int = None  # builds myworld,time,years
