...
from src._world.belief import BalanceLink, BeliefID, balancelink_shop
...
def test_IdeaUnit_meld_CorrectlyMeldsRangeAttributesWhen_meld_strategyEquals_default():
    ...
    x_uid = "uid1xx"
    x_all_person_cred = "am_cx"
    x_all_person_debt = "am_dx"
    ...
    arbitrarily_set_idea_attr(
        ...
        pledge=True,
        all_person_cred=x_all_person_cred,
        all_person_debt=x_all_person_debt,
        is_expanded=True,
    )
    ...
    assert x1_idea._all_person_cred == x_all_person_cred
    assert x1_idea._all_person_debt == x_all_person_debt
...
# def test_IdeaUnit_meld_FailRaisesError_all_person_cred():
# def test_IdeaUnit_meld_FailRaisesError_all_person_debt():
#     x_attr = "_all_person_cred"
#     x_attr = "_all_person_debt"
#     x_val = "test_all_person_cred1"
#     x_val = "test_all_person_debt1"
#     x1_idea = ideaunit_shop("clean", _parent_road=casa_text)
#     arbitrarily_set_idea_attr(idea=x1_idea, all_person_cred=x_val)
#     arbitrarily_set_idea_attr(idea=x1_idea, all_person_debt=x_val)
#     x2_idea = ideaunit_shop("cook", _parent_road=casa_text)
...
def test_IdeaUnit_meld_CorrectlyCreatesOriginUnitWithOriginLink():
    ...
    sue_text = "Sue"
    sue_weight = 5
    x1_idea.meld(exterior_idea=x2_idea, person_id=sue_text, person_weight=sue_weight)
...
def test_IdeaUnit_meld_IdeaMeldingItselfCreatesOriginUnitWithCorrectOriginLink():
    ...
    ex_x1_idea_originunit.set_originlink(person_id=tim_text, weight=tim_weight)
    x1_idea.meld(exterior_idea=tim_idea, person_id=tim_text, person_weight=tim_weight)
    assert x1_idea._originunit == ex_x1_idea_originunit

    sue_text = "Sue"
    sue_weight = 5
    ex_x1_idea_originunit.set_originlink(person_id=sue_text, weight=sue_weight)
    assert x1_idea._originunit != ex_x1_idea_originunit

    x1_idea_copy = deepcopy(x1_idea)

    # WHEN
    x1_idea.meld(exterior_idea=x1_idea, person_id=sue_text, person_weight=sue_weight)
    assert x1_idea._originunit == ex_x1_idea_originunit
