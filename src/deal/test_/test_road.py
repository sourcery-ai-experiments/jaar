...
def test_road_find_replace_road_key_dict_ReturnsCorrectDict_ChangeprojectHandleScenario():
    ...
    healer_text = "healer"
    old_healer_road = f"{old_project_handle},{healer_text}"
    ...
    # WHEN
    new_project_handle = "Austin"
    new_healer_road = f"{new_project_handle},{healer_text}"
...
def test_road_get_default_project_root_label_ReturnsCorrectObj():
    assert root_label() == "A"
