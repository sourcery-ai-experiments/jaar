...
def test_sufffact_set_status_CorrectlySetsStatusWhenAcptFactIsNull():
    ...
    deal_acptfact_2 = None
    assert sufffact_2._status is None
    sufffact_2.set_status(acptfactheir=deal_acptfact_2)
...
def test_sufffact_set_status_CorrectlySetsStatus_3():
    ...
    deal_acptfact_3 = acptfactheir_shop(
        base="casa,weekday", pick="casa,weekday,wednesday,noon"
    )
    assert sufffact_3._status is None
    sufffact_3.set_status(acptfactheir=deal_acptfact_3)
...
def test_sufffact_set_status_CorrectlySetsStatus_4():
    ...
    deal_acptfact_4 = acptfactheir_shop(
        base="casa,weekday", pick="casa,weekday,thursday"
    )
    assert sufffact_4._status is None
    assert sufffact_4.is_in_lineage(acptfact_pick=deal_acptfact_4.pick) == False
    assert deal_acptfact_4.open is None
    assert deal_acptfact_4.nigh is None
    sufffact_4.set_status(acptfactheir=deal_acptfact_4)
...
def test_sufffact_set_status_CorrectlySetsStatus_5():
    ...
    deal_acptfact_5 = acptfactheir_shop(base="casa,weekday", pick="casa,weekday,rainy")
    assert sufffact_5._status is None
    sufffact_5.set_status(acptfactheir=deal_acptfact_5)
