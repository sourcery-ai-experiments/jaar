...
def test_x_func_dir_files_correctlyGrabsFileData(kitchen_dir_setup_cleanup):
    # GIVEN
...
def test_x_func_dir_files_removesFileExtension(kitchen_dir_setup_cleanup):
    # GIVEN
    env_dir = get_temp_kitchenunit_dir()
    x1_title = "x1"
    x2_title = "x2"
...
def test_x_func_dir_files_returnsSubDirs(kitchen_dir_setup_cleanup):
    # GIVEN
    env_dir = get_temp_kitchenunit_dir()
    x1_title = "x1"
    x2_title = "x2"
...
def test_x_func_dir_files_doesNotReturnsFiles(kitchen_dir_setup_cleanup):
    # GIVEN
    env_dir = get_temp_kitchenunit_dir()
    x1_title = "x1"
    x1_file_ext = "txt"
...
def test_x_func_save_file_ReplacesFileAsDefault(kitchen_dir_setup_cleanup):
    # GIVEN
    env_dir = get_temp_kitchenunit_dir()
    x_old_title = "x_old"
    # x_new_title = "x_new"
...
def test_x_func_save_file_DoesNotreplaceFile(kitchen_dir_setup_cleanup):
    # GIVEN
    env_dir = get_temp_kitchenunit_dir()
    x_old_title = "x_old"
    # x_new_title = "x_new"
