from src.deal.required_idea import Road, SuffFactUnit
from src.deal.idea import IdeaBare as YB
...
class SuffFactUnitHregTime:
    ...
    _every_x_months: int = None  # builds mydeal,time,months
    _on_x_monthday: int = None  # " build mydeal,time,month,monthday
    _every_x_years: int = None  # builds mydeal,time,years
