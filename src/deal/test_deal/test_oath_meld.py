...
def test_deal_idearoot_meld_IdeaRootAttrCorrectlyMelded():
    ...
    assert (
        str(excinfo.value)
        == f"Meld fail idea=None,{x_deal1._cure_handle} _uid:1 with None,{x_deal2._cure_handle} _uid:4"
    )
...
def test_deal_idearoot_meld_Add4IdeasScenario():
    ...
    tech_text = "tech"
    tech_road = f"{x_deal1._cure_handle},{tech_text}"
    bowl_text = "bowl"
    bowl_road = f"{x_deal1._cure_handle},{tech_text},{bowl_text}"
    swim_text = "swim"
    swim_road = f"{x_deal1._cure_handle},{swim_text}"
    free_text = "freestyle"
    free_road = f"{x_deal1._cure_handle},{swim_text},{free_text}"

    x_deal2 = DealUnit(_healer=spirit_text)
    x_deal2.add_idea(pad=x_deal2._cure_handle, idea_kid=IdeaKid(_label=tech_text))
...
def test_deal_idearoot_meld_2SameIdeasScenario():
    ...
    x_deal1.add_idea(pad=x_deal1._cure_handle, idea_kid=IdeaKid(_label=tech_text))
...
def test_deal_acptfactunits_meld_AcptFactsAttributeCorrectlySet():
    ...
    swim_road = f"{x_deal1._cure_handle},{swim_text}"
    free_text = "freestyle"
    free_road = f"{x_deal1._cure_handle},{free_text}"
    x_deal1.add_idea(pad=swim_road, idea_kid=IdeaKid(_label=free_text))
...
def test_deal_meld_OriginUnitsCorrectlySet():
    ...
    swim_text = "swim"
    swim_road = f"{bob_x_deal._cure_handle},{swim_text}"
    free_text = "freestyle"
