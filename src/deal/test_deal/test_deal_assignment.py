...
def test_deal_get_assignment_CorrectlyCreatesAssignmentFile_v1():
    ...
    print(f"{america_deal._project_handle=} {america_deal._idea_dict.keys()=}")
    america_deal.set_project_handle(project_handle_text)
    print(f"{america_deal._project_handle=} {america_deal._idea_dict.keys()=}")
    ...
    casa_text = "casa"
    casa_road = f"{america_deal._project_handle},{casa_text}"
    basket_text = "laundry basket status"
    basket_road = f"{casa_road},{basket_text}"
    b_full_text = "full"
