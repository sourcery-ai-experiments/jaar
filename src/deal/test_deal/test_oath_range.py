...
def test_dealAddingIdeaWithAddinCorrectlyTransformsRangeScenario1():
    ...
    x_deal.add_idea(pad=x_deal._cure_handle, idea_kid=idea_kid_l1)
    l1_road = f"{x_deal._cure_handle},{l1}"
...
def test_get_idea_ranged_kids_CorrectlyReturnsAllChildren():
    ...
    # WHEN
    weekunit_road = f"{x_deal._cure_handle},time,tech,week"
...
def test_get_idea_ranged_kids_CorrectlyReturnsSomeChildrenScen2():
    ...
    # WHEN THEN
    week_road = f"{x_deal._cure_handle},time,tech,week"
    assert (
