...
def test_culturelink_get_dict_ReturnsCorrectDict():
    ...
    # THEN
    assert diet_dict == {"culture_id": diet_text, "weight": diet_weight}
...
def test_healerlink_get_dict_ReturnsCorrectDict():
    ...
    assert yao_dict == {
        "person_id": yao_text,
        "weight": yao_weight,
        "_culturelinks": {diet_text: {"culture_id": diet_text, "weight": diet_weight}},
    }
...
def test_painunit_get_dict_ReturnsCorrectDict():
    ...
    assert diet_culturelink_dict == {"culture_id": diet_text, "weight": diet_weight}
    assert yao_culturelinks_dict == {
        diet_text: {"culture_id": diet_text, "weight": diet_weight}
    }
