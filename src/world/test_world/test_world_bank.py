...
from src.world.y_func import check_connection, get_single_result_back
...
def test_world_create_bank_db_CreatesBankDBIfItDoesNotExist(
    env_dir_setup_cleanup,
):
    # GIVEN create world
...
def test_world_create_bank_db_CanCreateBankInMemory(
    env_dir_setup_cleanup,
):
    # GIVEN create world
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
...
def test_world_refresh_bank_metrics_CanConnectToBankInMemory(
    env_dir_setup_cleanup,
):
    # GIVEN create world
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
...
def test_world_get_bank_db_conn_CreatesBankDBIfItDoesNotExist(env_dir_setup_cleanup):
    # GIVEN create world
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
    # WHEN/THEN
...
def test_world_create_dirs_if_null_CorrectlyCreatesDBTables(env_dir_setup_cleanup):
    # GIVEN create world
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
...
def test_world_refresh_bank_metrics_CorrectlyDeletesOldBankInMemory(
    env_dir_setup_cleanup,
):
    # GIVEN
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
...
def test_world_refresh_bank_metrics_CorrectlyDeletesOldBankFile(
    env_dir_setup_cleanup,
):
    # GIVEN
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
...
def test_world_refresh_bank_metrics_CorrectlyPopulates_groupunit_catalog(
    env_dir_setup_cleanup,
):
    # GIVEN
    e1 = WorldUnit(name=get_temp_env_name(), worlds_dir=get_test_worlds_dir())
