...
def test_WorldUnit_set_all_econunits_contract_CorrectlySetsroles(
    ...
    luca_dallas_econ.create_clerkunit(luca_text)
    luca_dallas_econ.create_clerkunit(todd_text)
    todd_dallas_econ.create_clerkunit(luca_text)
    todd_dallas_econ.create_clerkunit(todd_text)
