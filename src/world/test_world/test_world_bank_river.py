...
def test_world_set_river_sphere_for_agent_CorrectlyPopulatesriver_tmemberTable01(
    env_dir_setup_cleanup,
):
...
def test_world_set_river_sphere_for_agent_CorrectlyPopulatesriver_tmemberTable02(
    env_dir_setup_cleanup,
):
...
def test_world_set_river_sphere_for_agent_CorrectlyPopulatesriver_tmemberTable03(
    env_dir_setup_cleanup,
):
...
def test_world_set_river_sphere_for_agent_CorrectlyPopulatesriver_tmemberTable04(
    env_dir_setup_cleanup,
):
...
def test_world_set_river_sphere_for_agent_CorrectlyPopulatesriver_tmemberTable05(
    env_dir_setup_cleanup,
):
...
def test_world_set_river_sphere_for_agent_CorrectlyUpatesAgentMemberUnits(
    env_dir_setup_cleanup,
):
    # GIVEN 5 agents, 85% of river flows to sal, left over %15 goes on endless loop that slowly bleeds to sal
    world_name = get_temp_env_name()
