...
def test_WantUnit_exists():
    ...
    # WHEN
    farm_wantunit = WantUnit(texas_economyaddress)

    # THEN
    assert farm_wantunit.issue is None
    assert farm_wantunit.fix is None
    assert farm_wantunit.economyaddress == texas_economyaddress


def test_wantunit_shop_ReturnsCorrectObj():
    # GIVEN
    ...
    assert farm_wantunit.economyaddress == texas_economyaddress
    assert (
        farm_wantunit.get_economyaddress_road_delimiter()
...
def test_WantUnit_set_issue_EmptySubjectRaisesErrorCorrectly():
    ...
    texas_economyaddress = farm_wantunit.economyaddress
