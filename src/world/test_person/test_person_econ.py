...
def test_PersonUnit_create_person_econunits_RaisesErrorWhen__econs_justified_IsFalse(
    ...
    sue_gut_agenda.edit_idea_attr(texas_road, healerunit=healerunit_shop({sue_text}))
...
def test_PersonUnit_create_person_econunits_CreatesEconUnits(worlds_dir_setup_cleanup):
    ...
    dallas_idea = ideaunit_shop(dallas_text, _healerunit=healerunit_shop({sue_text}))
    elpaso_idea = ideaunit_shop(elpaso_text, _healerunit=healerunit_shop({sue_text}))
