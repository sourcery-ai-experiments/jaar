...
from src.world.examples.person_env_tools import (
    person_dir_setup_cleanup,
    get_temp_person_dir,
    create_agent_file_for_person,
)
from src.world.examples.env_tools import get_temp_env_name
...
def test_personunit_refresh_agentlinks_CorrectlyPullsAllPublicAgents(
    ...
    px = e1.get_person_obj_from_world(name=person1_text)
