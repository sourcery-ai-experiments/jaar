...
# @dataclass
# class WantUnit:
#     economyaddress: RoadUnit  # Healer_pid,EconomyID
#     fix: BeliefUnit = None
...
#     #         )
#     #     if is_sub_road(road, self.economydeletemeaddress.economy_id) == False:
#     #         raise WantSubRoadUnitException(
...
#         fix_road = get_diff_road(_fix_subject, self.economydeletemeaddress.economy_id)
#         negative_road = get_diff_road(_fix_negative, _fix_subject)
#         positive_road = get_diff_road(_fix_positive, _fix_subject)

#         return f"""Within {self.economydeletemeaddress.treasurer_pid}'s {self.economydeletemeaddress.economy_id} economy subject: {want_road}
#  {bad_road} is bad.
#  {good_road} is good.
...
#         return self.economydeletemeaddress.treasurer_pid


# def wantunit_shop(
#     economydeletemeaddress: EconomyDELETEMEaddress, issue: BeliefUnit, fix: BeliefUnit
# ) -> WantUnit:
#     x_wantunit = WantUnit(economydeletemeaddress=economydeletemeaddress)
...
# def create_wantunit(
#     economydeletemeaddress: EconomyDELETEMEaddress,
...
#         create_beliefunit(
#             base=create_road(economydeletemeaddress.economy_id, issue),
#             good=good,
#             bad=bad,
#         )
#     )
#     x_wantunit.set_fix(
#         create_beliefunit(
#             base=create_road(economydeletemeaddress.economy_id, fix),
#             good=positive,
#             bad=negative,
#         )
#     )
