...
#     texas_forum_dir = texas_economy.get_forum_dir()

#     highway_wantunit = create_wantunit(
#         economydeletemeaddress=economydeletemeaddress_shop("war", yao_text, texas_text),
...
#     # check tim forum
#     tim_forum = texas_economy.get_forum_agenda(tim_text)
