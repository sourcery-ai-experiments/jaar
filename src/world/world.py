...
class WorldUnit:
    ...
    def _create_person_from_pid(self, person_id: PersonID):
        x_person_dir = f"{self._persons_dir}/{person_id}"
        x_person_obj = personunit_shop(pid=person_id, person_dir=x_person_dir)
