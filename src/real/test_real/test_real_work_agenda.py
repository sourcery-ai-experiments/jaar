...
def test_RealUnit_generate_work_agenda_Sets_work_AgendaFile(
    reals_dir_setup_cleanup,
):
    # GIVEN
    music_text = "Music"
    ...
    luca_text = "Luca"
    x_luca_work_path = f"{music_real._persons_dir}/{luca_text}/work.json"
    ...
    # WHEN
    luca_work = music_real.generate_work_agenda(luca_text)
    ...
    assert luca_work._real_id == example_agenda._real_id
    assert luca_work._last_gift_id == example_agenda._last_gift_id
    assert luca_work == example_agenda


def test_RealUnit_generate_work_agenda_ReturnsRegeneratedObj(
    reals_dir_setup_cleanup,
):
    # GIVEN
    ...
    # WHEN
    after_luca_agenda = music_real.generate_work_agenda(luca_text)
