from src.real.real_report import (
    get_real_minds_chars_dataframe,
    get_real_minds_chars_plotly_fig,
    get_real_beings_chars_dataframe,
    get_real_beings_chars_plotly_fig,
    get_real_minds_agenda_dataframe,
    get_real_minds_agenda_plotly_fig,
...
def test_get_real_minds_chars_dataframe_ReturnsCorrectObj(env_dir_setup_cleanup):
    # GIVEN
    music_real = create_example_real2()

    # WHEN
    x_df = get_real_minds_chars_dataframe(music_real)
...
def test_get_real_minds_chars_plotly_fig_DisplaysCorrectInfo(env_dir_setup_cleanup):
    # GIVEN
    music_real = create_example_real2()

    # WHEN
    x_fig = get_real_minds_chars_plotly_fig(music_real)
...
def test_get_real_minds_agenda_dataframe_ReturnsCorrectObj(env_dir_setup_cleanup):
    # GIVEN
    music_real = create_example_real3()

    # WHEN
    x_df = get_real_minds_agenda_dataframe(music_real)
...
def test_get_real_minds_agenda_plotly_fig_DisplaysCorrectInfo(env_dir_setup_cleanup):
    # GIVEN
    music_real = create_example_real3()

    # WHEN
    x_fig = get_real_minds_agenda_plotly_fig(music_real)
