...
def test_RealUnit_get_person_duty_from_file_ReturnsCorrectObj(env_dir_setup_cleanup):
    ...
    luca_duty.add_guyunit(bob_text)
    ...
    assert gen_luca_duty.guy_exists(bob_text)
...
def test_RealUnit__set_all_healer_roles_CorrectlySetsroles(
    ...
    luca_duty_agenda.add_guyunit(luca_text)
    luca_duty_agenda.add_guyunit(todd_text)
    todd_duty_agenda.add_guyunit(luca_text)
    todd_duty_agenda.add_guyunit(todd_text)
    texas_text = "Texas"
