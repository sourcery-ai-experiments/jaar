...
def test_RealUnit_set_person_moneyunits_dirs_CorrectlySetsroles(
    ...
    create_duty_treasury_db_files(luca_filehub)
    create_duty_treasury_db_files(todd_filehub)
    luca_dallas_money = init_treasury_db_file(luca_filehub, dallas_road)
    todd_dallas_money = init_treasury_db_file(todd_filehub, dallas_road)
