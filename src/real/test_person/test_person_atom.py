...
def test_PersonUnit_save_valid_atom_file_CorrectlySavesFile(reals_dir_setup_cleanup):
    ...
    atom_num = _save_valid_atom_file(
        yao_chapunit, get_atom_example_beliefunit_knee(), one_int
    )
...
def test_PersonUnit_chap_atom_file_exists_ReturnsCorrectObj(reals_dir_setup_cleanup):
    # GIVEN
    yao_text = "Yao"
    yao_person = personunit_shop(yao_text)
    yao_chapunit = chapunit_shop(None, None, yao_text)
...
def test_PersonUnit_chap_save_atom_file_CorrectlySavesFile(reals_dir_setup_cleanup):
    # GIVEN
    yao_text = "Yao"
    yao_person = personunit_shop(yao_text)
    yao_chapunit = chapunit_shop(None, None, yao_text)
