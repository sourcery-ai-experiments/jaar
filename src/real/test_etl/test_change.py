...
def test_save_changeunit_file_SaveCorrectObj(reals_dir_setup_cleanup):
    ...
    sue_change2_path = f"{sue_userdir.changes_dir()}/{two_filename}"
    sue_change0_path = f"{sue_userdir.changes_dir()}/{six_filename}"
    ...
    sue_changeunit = changeunit_shop(
        ...
        _atoms_dir=sue_userdir.atoms_dir(),
        _changes_dir=sue_userdir.changes_dir(),
    )
    ...
    assert os_path_exists(sue_change0_path) == False
    two_file_json = open_file(sue_userdir.changes_dir(), two_filename)
...
def test_save_changeunit_file_RaisesErrorIfChangeUnit_atoms_dir_IsWrong(
    ...
    assert (
        str(excinfo.value)
        == f"ChangeUnit file cannot be saved because changeunit._atoms_dir is incorrect: {sue_changeunit._atoms_dir}. It must be {sue_userdir.atoms_dir()}."
    )
...
def test_save_changeunit_file_RaisesErrorIfChangeUnit_changes_dir_IsWrong(
    ...
    assert (
        str(excinfo.value)
        == f"ChangeUnit file cannot be saved because changeunit._changes_dir is incorrect: {sue_changeunit._changes_dir}. It must be {sue_userdir.changes_dir()}."
    )
...
def test_validate_changeunit_ReturnsObjWithAttributesFixed(
    ...
    invalid_sue_changeunit = changeunit_shop(
        ...
        _atoms_dir=f"{sue_userdir.econs_dir()}/swimming",
        _changes_dir=f"{sue_userdir.econs_dir()}/swimming",
    )
    valid_changeunit = validate_changeunit(sue_userdir, invalid_sue_changeunit)

    # THEN
    assert valid_changeunit._atoms_dir == sue_userdir.atoms_dir()
    assert valid_changeunit._changes_dir == sue_userdir.changes_dir()
...
def test_save_changeunit_file_SaveCorrectObj_correct_invalid_attrs_IsTrue(
    ...
    sue_change2_path = f"{sue_userdir.changes_dir()}/{next_filename}"
    print(f"{sue_change2_path=}")
    assert os_path_exists(sue_change2_path) == False
    ...
    # THEN
    assert os_path_exists(sue_change2_path)
    two_file_json = open_file(sue_userdir.changes_dir(), next_filename)
...
def test__create_new_changeunit_ReturnsObjWithCorrect_change_id_WhenNochangeFilesExist(
    ...
    assert sue_changeunit._atoms_dir == sue_userdir.atoms_dir()
    assert sue_changeunit._changes_dir == sue_userdir.changes_dir()
...
def test__create_new_changeunit_ReturnsObjWithCorrect_change_id_WhenchangeFilesExist(
    ...
    zero_changeunit._atoms_dir = sue_userdir.atoms_dir()
    zero_changeunit._changes_dir = sue_userdir.changes_dir()
...
def test_del_changeunit_DeleteschangejsonAndNotAgendaAtomjsons(
    ...
    sue_change0_path = f"{sue_userdir.changes_dir()}/{six_filename}"
    sue_atom0_path = f"{sue_userdir.atoms_dir()}/{atom0_filename}"
    assert os_path_exists(sue_change0_path) == False
    ...
    print(f"{dir_files(sue_userdir.atoms_dir())}")
    assert os_path_exists(sue_change0_path)
...
def test_save_changeunit_file_CanCreateAndModify3changeunits(
    ...
    sue_userdir = userdir_shop(None, None, sue_text)
    delete_dir(sue_userdir.changes_dir())
    delete_dir(sue_userdir.atoms_dir())
    set_dir(sue_userdir.changes_dir())
    set_dir(sue_userdir.atoms_dir())
    assert len(dir_files(sue_userdir.changes_dir())) == 0
    assert len(dir_files(sue_userdir.atoms_dir())) == 0
    ...
    # THEN
    assert len(dir_files(sue_userdir.changes_dir())) == 3
    assert len(dir_files(sue_userdir.atoms_dir())) == 9
...
def test_save_changeunit_file_ReturnsValidObj(reals_dir_setup_cleanup):
    ...
    sue2_changeunit._atoms_dir = f"{sue_userdir.econs_dir()}/swimming"
    sue2_changeunit._changes_dir = f"{sue_userdir.econs_dir()}/swimming"
...
def test_create_save_changeunit_SaveCorrectObj(reals_dir_setup_cleanup):
    ...
    sue_change2_path = f"{sue_userdir.changes_dir()}/{two_filename}"
    sue_change3_path = f"{sue_userdir.changes_dir()}/{three_filename}"
    print(f"{sue_change2_path=}")
...
def test_add_pledge_change_Addspledgechange(reals_dir_setup_cleanup):
    ...
    sue_change_path = f"{sue_userdir.changes_dir()}/{change_filename}"
