...
def test_create_econ_dir_CreatesDir(reals_dir_setup_cleanup):
    ...
    dallas_dir = get_econ_path(sue_usernox, dallas_road)
    print(f"{dallas_dir=}")
    assert os_path_exists(dallas_dir) == False

    # WHEN
    create_econ_dir(sue_usernox, dallas_road)
...
def test_init_econunit_CreatesAndReturnsObj(reals_dir_setup_cleanup):
    ...
    pound_text = "#"
    sue_text = "Sue"
    sue_usernox = usernox_shop(None, None, sue_text, pound_text)
    ...
    dallas_dir = create_econ_dir(sue_usernox, dallas_road)
    ...
    # WHEN
    sue_dallas_econunit = init_econunit(sue_usernox, dallas_road)
...
def test_create_person_econunits_CreatesEconUnits(reals_dir_setup_cleanup):
    ...
    dallas_dir = create_econ_dir(sue_usernox, dallas_road)
    elpaso_dir = create_econ_dir(sue_usernox, elpaso_road)
    dallas_db_path = f"{dallas_dir}/{treasury_db_filename()}"
...
def test_set_econunit_role_CorrectlySets_role(reals_dir_setup_cleanup):
    ...
    # WHEN
    set_econunit_role(sue_usernox, dallas_road, sue_duty_agenda)
...
def test_set_econunits_role_CorrectlySets_roles(reals_dir_setup_cleanup):
    ...
    # WHEN
    set_econunits_role(sue_usernox, sue_duty_agenda)
...
def test_set_person_econunits_role_CorrectlySetsroles(
    ...
    # WHEN
    set_person_econunits_role(sue_usernox)
