...
def create_example_real1() -> RealUnit:
    ...
    yao_usernox = agendahub_shop(None, music_text, yao_text, None)
...
def create_example_real2() -> RealUnit:
    ...
    music_real.init_person_econs(yao_text)
    yao_usernox = agendahub_shop(None, music_text, yao_text, None)
    wei_usernox = agendahub_shop(None, music_text, wei_text, None)
    zia_usernox = agendahub_shop(None, music_text, zia_text, None)
