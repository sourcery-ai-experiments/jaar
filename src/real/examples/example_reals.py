...
def create_example_real4() -> RealUnit:
    ...
    # yao_dallas_econ.save_role_file_agenda(yao_duty_agenda)
    # yao_dallas_econ.save_role_file_agenda(wei_duty_agenda)
    # yao_dallas_econ.save_role_file_agenda(zia_duty_agenda)
    # zia_dallas_econ.save_role_file_agenda(yao_duty_agenda)
    # zia_dallas_econ.save_role_file_agenda(wei_duty_agenda)
    # zia_dallas_econ.save_role_file_agenda(zia_duty_agenda)
    # yao_elpaso_econ.save_role_file_agenda(yao_duty_agenda)
    # yao_elpaso_econ.save_role_file_agenda(wei_duty_agenda)
    # yao_elpaso_econ.save_role_file_agenda(zia_duty_agenda)
