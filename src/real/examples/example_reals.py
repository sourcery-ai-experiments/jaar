...
def create_example_real1() -> RealUnit:
    ...
    yao_same_world.set_char_credor_pool(101)
    yao_same_world.set_char_debtor_pool(1000)

    yao_same_world.add_charunit(yao_text, 34, 600)
...
def create_example_real2() -> RealUnit:
    ...
    yao_same_world.set_char_credor_pool(101)
    wei_same_world.set_char_credor_pool(75)
    zia_same_world.set_char_credor_pool(52)
    yao_same_world.set_char_debtor_pool(1000)
    wei_same_world.set_char_debtor_pool(750)
    zia_same_world.set_char_debtor_pool(500)

    yao_same_world.add_charunit(yao_text, 34, 600)
    yao_same_world.add_charunit(zia_text, 57, 300)
    yao_same_world.add_charunit(wei_text, 10, 100)
    wei_same_world.add_charunit(yao_text, 37, 100)
    wei_same_world.add_charunit(wei_text, 11, 400)
    wei_same_world.add_charunit(zia_text, 27, 250)
    zia_same_world.add_charunit(yao_text, 14, 100)
    zia_same_world.add_charunit(zia_text, 38, 400)
    texas_text = "Texas"
    texas_road = yao_same_world.make_l1_road(texas_text)
    yao_same_world.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
