...
def create_example_real1() -> RealUnit:
    ...
    yao_duty_agenda.set_guy_credor_pool(101)
    yao_duty_agenda.set_guy_debtor_pool(1000)

    yao_duty_agenda.add_guyunit(yao_text, 34, 600)
...
def create_example_real2() -> RealUnit:
    ...
    yao_duty_agenda.set_guy_credor_pool(101)
    wei_duty_agenda.set_guy_credor_pool(75)
    zia_duty_agenda.set_guy_credor_pool(52)
    yao_duty_agenda.set_guy_debtor_pool(1000)
    wei_duty_agenda.set_guy_debtor_pool(750)
    zia_duty_agenda.set_guy_debtor_pool(500)

    yao_duty_agenda.add_guyunit(yao_text, 34, 600)
    yao_duty_agenda.add_guyunit(zia_text, 57, 300)
    yao_duty_agenda.add_guyunit(wei_text, 10, 100)
    wei_duty_agenda.add_guyunit(yao_text, 37, 100)
    wei_duty_agenda.add_guyunit(wei_text, 11, 400)
    wei_duty_agenda.add_guyunit(zia_text, 27, 250)
    zia_duty_agenda.add_guyunit(yao_text, 14, 100)
    zia_duty_agenda.add_guyunit(zia_text, 38, 400)
    texas_text = "Texas"
    texas_road = yao_duty_agenda.make_l1_road(texas_text)
    yao_duty_agenda.add_l1_idea(ideaunit_shop(texas_text, _problem_bool=True))
