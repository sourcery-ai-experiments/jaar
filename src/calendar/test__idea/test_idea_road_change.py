...
def test_idea_find_replace_road_Changes_walk():
    ...
    bloomers_road = f"{root_label()},{old_person},{bloomers_text}"
    roses_text = "roses"
    roses_road = f"{root_label()},{old_person},{bloomers_text},{roses_text}"
    ...
    # WHEN
    new_person = "person1"
    old_person_road = f"{root_label()},{old_person}"
    new_person_road = f"{root_label()},{new_person}"
    idea_x.find_replace_road(old_road=old_person_road, new_road=new_person_road)

    # THEN
    new_bloomers_road = f"{root_label()},{new_person},{bloomers_text}"
    new_roses_road = f"{root_label()},{new_person},{bloomers_text},{roses_text}"
