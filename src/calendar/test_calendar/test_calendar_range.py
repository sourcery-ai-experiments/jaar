...
def test_calendarAddingIdeaWithAddinCorrectlyTransformsRangeScenario1():
    ...
    y_idea = calendar_x.get_idea_kid(road=rx1_road)
    ...
    x_idea = calendar_x.get_idea_kid(road=rcA_road)

    assert x_idea._begin == 10
    assert x_idea._close == 25

    # When
    calendar_x.edit_idea_attr(road=rcA_road, addin=7)
...
def test_calendarAddingIdeaWithAddinCorrectlyTransformsRangeScenario2():
    ...
    # When
    calendar_x.edit_idea_attr(road=rcA_road, addin=15, denom=5)
