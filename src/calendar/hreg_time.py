...
class SuffFactUnitHregTime:
    ...
    _every_x_months: int = None  # builds mycalendar,time,months
    _on_x_monthday: int = None  # " build mycalendar,time,month,monthday
    _every_x_years: int = None  # builds mycalendar,time,years
