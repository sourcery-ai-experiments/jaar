...
def test_create_empty_world_ReturnsCorrectObj():
    ...
    role_zia_charunit = yao_same.get_char(zia_text)
    ...
    yao_same.set_char_credor_pool(zia_credor_pool, True)
    yao_same.set_char_debtor_pool(zia_debtor_pool, True)
    ...
    assert yao_empty_job._char_credor_pool != yao_same._char_credor_pool
    assert yao_empty_job._char_credor_pool is None
    assert yao_empty_job._char_debtor_pool != yao_same._char_debtor_pool
...
def test_get_default_live_world_ReturnsCorrectObj():
    ...
    assert default_live_world._char_credor_pool is None
    assert default_live_world._char_debtor_pool is None
    assert default_live_world._max_tree_traverse == sue_max_tree_traverse
    assert len(default_live_world.get_chars_dict()) == 1
