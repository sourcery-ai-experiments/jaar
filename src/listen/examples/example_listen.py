...
def get_example_zia_speaker() -> AgendaUnit:
    ...
    yao_text = "Yao"
    zia_speaker.add_otherunit(yao_text, debtor_weight=12)
    ...
    zia_speaker.set_other_pool(100)
    return zia_speaker
...
def get_example_bob_speaker() -> AgendaUnit:
    ...
    yao_text = "Yao"
    bob_speaker.add_otherunit(yao_text, debtor_weight=12)
    ...
    bob_speaker.set_other_pool(100)
    return bob_speaker
...
def get_example_yao_speaker() -> AgendaUnit:
    ...
    yao_speaker.set_other_pool(100)
