...
def get_example_zia_speaker() -> WorldUnit:
    ...
    yao_text = "Yao"
    zia_speaker.add_personunit(yao_text, debtor_weight=12)
    ...
    zia_speaker.set_person_pool(100)
    return zia_speaker
...
def get_example_bob_speaker() -> WorldUnit:
    ...
    yao_text = "Yao"
    bob_speaker.add_personunit(yao_text, debtor_weight=12)
    ...
    bob_speaker.set_person_pool(100)
    return bob_speaker
...
def get_example_yao_speaker() -> WorldUnit:
    ...
    yao_speaker.add_personunit(yao_text, debtor_weight=12)
    yao_speaker.add_personunit(zia_text, debtor_weight=36)
    yao_speaker.add_personunit(bob_text, debtor_weight=48)
    yao_speaker.set_person_pool(100)
