...
from src.listen.examples.example_listen_quarks import get_quark_example_oathunit_knee
...
def test_UserHub_del_atom_file_DeletesatomjsonAndNotQuarkUnitjsons(
    ...
    sue_atomunit._nucunit.set_quarkunit(get_quark_example_oathunit_knee())
    zero_int = 0
    assert sue_userhub.atom_file_exists(six_int) is False
