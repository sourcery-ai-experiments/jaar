...
def test_listen_to_agenda_role_job_agenda_AddsTasksToJob_WorldWhenNo_suffbeliefIsSet(
    ...
    zia_job.add_personunit(yao_text, debtor_weight=12)
...
def test_listen_to_agenda_role_job_agenda_ProcessesIrrationalWorld(
    ...
    assert len(new_yao_job.get_agenda_dict()) == 2
    zia_personunit = new_yao_job.get_person(zia_text)
    sue_personunit = new_yao_job.get_person(sue_text)
...
def test_listen_to_agenda_role_job_agenda_ListensToOwner_role_AndNotOwner_job(
    ...
    yao_role.add_personunit(yao_text, yao_credor_weight, yao_debtor_weight)
    zia_text = "Zia"
    zia_credor_weight = 47
    zia_debtor_weight = 41
    yao_role.add_personunit(zia_text, zia_credor_weight, zia_debtor_weight)
