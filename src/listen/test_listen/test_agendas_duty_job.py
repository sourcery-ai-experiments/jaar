...
def test_listen_to_agenda_duty_job_agenda_AddsTasksToJobWorldWithDetailsDecidedBy_debtor_weight(
    ...
    new_yao_home1 = create_listen_basis(yao_duty)
    assert new_yao_home1.idea_exists(cook_road()) is False

    # WHEN
    listen_to_agendas_duty_job(new_yao_home1, sue_dakota_userhub)
    ...
    new_yao_home2 = create_listen_basis(yao_duty)
    assert new_yao_home2.idea_exists(cook_road()) is False

    # WHEN
    listen_to_agendas_duty_job(new_yao_home2, sue_dakota_userhub)
