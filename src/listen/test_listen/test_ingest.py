...
def test_allocate_irrational_debtor_weight_CorrectlySetsAgendaAttr():
    ...
    zia_guyunit = yao_agenda.get_guy(zia_text)
    ...
    # THEN
    assert zia_guyunit._irrational_debtor_weight == zia_debtor_weight
...
def test_generate_perspective_intent_CorrectlyGrabsIntentTasks():
    ...
    yao_speaker.add_guyunit(yao_text)
    yao_speaker.set_guy_pool(20)
    casa_text = "casa"
