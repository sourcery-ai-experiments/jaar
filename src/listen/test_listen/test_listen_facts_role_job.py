...
def test_listen_to_facts_role_job_GetsFactsFromSrcAgendaSelfNotSpeakerSelf(
    env_dir_setup_cleanup,
):
    # GIVEN
...
def test_listen_to_facts_role_job_ConfirmNoFactPickedFromOwnersSpeakerDirAgenda_v1(
    env_dir_setup_cleanup,
):
    # GIVEN
    yao_role = get_example_yao_speaker()
...
def test_listen_to_facts_role_job_ConfirmNoFactPickedFromOwnersSpeakerDirAgenda_v2(
    env_dir_setup_cleanup,
):
    # GIVEN
    zia_job = get_example_zia_speaker()
