...
def test_listen_to_intent_role_job_intent_AddsTasksToJobAgendaWhenNo_suffbeliefIsSet(
    ...
    zia_job.add_guyunit(yao_text, debtor_weight=12)
...
def test_listen_to_intent_role_job_intent_ProcessesIrrationalAgenda(
    ...
    assert len(new_yao_job.get_intent_dict()) == 2
    zia_guyunit = new_yao_job.get_guy(zia_text)
    sue_guyunit = new_yao_job.get_guy(sue_text)
...
def test_listen_to_intent_role_job_intent_ListensToOwner_role_AndNotOwner_job(
    ...
    yao_role.add_guyunit(yao_text, yao_credor_weight, yao_debtor_weight)
    zia_text = "Zia"
    zia_credor_weight = 47
    zia_debtor_weight = 41
    yao_role.add_guyunit(zia_text, zia_credor_weight, zia_debtor_weight)
