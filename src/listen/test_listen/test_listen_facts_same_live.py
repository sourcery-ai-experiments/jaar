...
def test_listen_to_facts_role_job_SetsSingleFactUnit_v1(env_dir_setup_cleanup):
    ...
    sue_texas_userhub.save_job_truth(zia_job)
...
def test_listen_to_facts_role_job_GetsFactsFromSrcTruthSelfNotSpeakerSelf(
    env_dir_setup_cleanup,
):
    # GIVEN
    ...
    sue_texas_userhub.save_job_truth(old_yao_job)
...
def test_listen_to_facts_role_job_ConfirmNoFactPickedFromOwnersSpeakerDirTruth_v1(
    env_dir_setup_cleanup,
):
    # GIVEN
    yao_role = get_example_yao_speaker()
...
def test_listen_to_facts_role_job_ConfirmNoFactPickedFromOwnersSpeakerDirTruth_v2(
    env_dir_setup_cleanup,
):
    # GIVEN
    zia_job = get_example_zia_speaker()
    ...
    sue_texas_userhub.save_job_truth(bob_job)
...
#     yao_text = "Yao"
#     sue_text = "Sue"
#     sue_speaker = truthunit_shop(yao_text)
#     casa_text = "casa"
...
#     sue_texas_userhub = get_texas_userhub()
#     sue_texas_userhub.save_job_truth(sue_text, sue_speaker.get_json(), True)
#     yao_role = truthunit_shop(yao_text)
...
#     # WHEN
#     yao_job = truthunit_shop(yao_text)
