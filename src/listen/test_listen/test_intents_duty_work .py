...
def test_listen_to_intents_duty_work_AddsTasksToAgendaWhenNo_suffbeliefIsSet(
    ...
    yao_duty.set_other_pool(zia_pool)
...
def test_listen_to_intents_duty_work_ProcessesIrrationalAgenda(env_dir_setup_cleanup):
    ...
    yao_duty.add_otherunit(zia_text, zia_credor_weight, zia_debtor_weight)
    yao_duty.add_otherunit(sue_text, sue_credor_weight, sue_debtor_weight)
    yao_pool = 92
...
def test_listen_to_intents_duty_work_ListensToOwner_duty_AndNotOwner_work(
    ...
    yao_duty.add_otherunit(yao_text, yao_credor_weight, yao_debtor_weight)
    zia_text = "Zia"
    zia_credor_weight = 47
    zia_debtor_weight = 41
    yao_duty.add_otherunit(zia_text, zia_credor_weight, zia_debtor_weight)
