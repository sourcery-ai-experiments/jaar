...
def test_HubUnit_get_econ_roads_RaisesErrorWhen__econs_justified_IsFalse(
    ...
    sue_suis_world.add_idea(ideaunit_shop(dallas_text), texas_road)
    sue_suis_world.edit_idea_attr(texas_road, healerhold=healerhold_shop({sue_text}))
    sue_suis_world.edit_idea_attr(dallas_road, healerhold=healerhold_shop({sue_text}))
    sue_suis_world.calc_world_metrics()
    assert sue_suis_world._econs_justified is False
    ...
    assert (
        str(excinfo.value)
        == f"Cannot get_econ_roads from '{sue_text}' suis world because 'WorldUnit._econs_justified' is False."
    )
...
def test_HubUnit_get_econ_roads_RaisesErrorWhen__econs_buildable_IsFalse(
    ...
    sue_suis_world.edit_idea_attr(texas_road, healerhold=healerhold_shop({sue_text}))
    sue_suis_world.calc_world_metrics()
    assert sue_suis_world._econs_justified
    assert sue_suis_world._econs_buildable is False
    sue_hubunit.save_suis_world(sue_suis_world)
    ...
    assert (
        str(excinfo.value)
        == f"Cannot get_econ_roads from '{sue_text}' suis world because 'WorldUnit._econs_buildable' is False."
    )
...
def test_HubUnit_get_econ_roads_ReturnsObj(env_dir_setup_cleanup):
    ...
    sue_suis_world.calc_world_metrics()
    # display_ideatree(sue_suis_world, mode="Econ").show()
    sue_hubunit.save_suis_world(sue_suis_world)
...
def test_HubUnit_save_all_suis_dutys_CorrectlySetsdutys(
    env_dir_setup_cleanup,
):
    # GIVEN
    sue_text = "Sue"
    ...
    # WHEN
    sue_hubunit.save_all_suis_dutys()
...
def test_HubUnit_create_suis_treasury_db_files_CreatesDatabases(env_dir_setup_cleanup):
    # GIVEN
    sue_text = "Sue"
    sue_hubunit = hubunit_shop(env_dir(), None, sue_text, None)
    sue_hubunit.save_suis_world(sue_hubunit.default_suis_world())
    ...
    # WHEN
    sue_hubunit.create_suis_treasury_db_files()
