...
def test_road_find_replace_road_key_dict_ReturnsCorrectDict_ChangeHealingKindScenario():
    # GIVEN
    old_healing_kind = "El Paso"
    healer_text = "healer"
    old_healer_road = f"{old_healing_kind},{healer_text}"
    ...
    # WHEN
    new_healing_kind = "Austin"
    new_healer_road = f"{new_healing_kind},{healer_text}"
