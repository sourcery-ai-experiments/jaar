...
def test_road_find_replace_road_key_dict_ReturnsCorrectDict_ChangeHealKindScenario():
    # GIVEN
    old_heal_kind = "El Paso"
    owner_text = "owner"
    old_owner_road = f"{old_heal_kind},{owner_text}"
    ...
    # WHEN
    new_heal_kind = "Austin"
    new_owner_road = f"{new_heal_kind},{owner_text}"
...
def test_road_get_default_heal_root_label_ReturnsCorrectObj():
    assert root_label() == "A"
