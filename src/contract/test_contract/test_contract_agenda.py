...
def test_get_agenda_with_7amItem():
    ...
    # WHEN
    day24hr_road = f"{a1._economy_tag},timetech,24hr day"
    day24hr_open = 0.0
    day24hr_nigh = 8.0
...
def test_get_agenda_does_not_return_promise_items_outside_range():
    ...
    a1.add_idea(idea_kid=c_idea, walk=a1._economy_tag)
    c_road = f"{a1._economy_tag},{c_label}"
    jajatime = f"{a1._economy_tag},time,jajatime"
    jajaday = f"{a1._economy_tag},time,jajatime,day"
...
def test_exammple_agenda_exists():
    ...
    min_text = "day_minute"
    min_road = f"{a1._economy_tag},{min_text}"
...
def test_exammple_AgendaHasCorrectAttributes():
    ...
    day_min_road = f"{a1._economy_tag},{day_min_text}"
    ...
    weekday_road = f"{a1._economy_tag},{weekday_text}"
    monday_text = "Monday"
...
def test_exammple_AgendaCanFiltersOnBase():
    ...
    # a1.edit_idea_attr(
    #     road="{a1._economy_tag},sufffacts,cleaning,laundry wednesday",
...
def test_set_agenda_task_as_complete_RangeWorksCorrectly():
    ...
    run_text = "run"
    run_road = f"{a1._economy_tag},{run_text}"
    time_text = "time"
    time_road = f"{a1._economy_tag},{time_text}"
    day_text = "day"
    day_road = f"{time_road},{day_text}"

    a1.add_idea(idea_kid=IdeaKid(_label=run_text, promise=True), walk=a1._economy_tag)
...
def test_weekdayAgendaItemsCorrectlyReturned():
    ...
    a1.add_idea(IdeaKid(_label=things_text), walk=a1._economy_tag)
    t_road = f"{a1._economy_tag},{things_text}"
    clean = "clean"
    run = "run"
    swim = "swim"
    jog = "jog"
...
def test_contract_create_agenda_item_CorrectlyCreatesAllContractAttributes():
    ...
    clean_things_road = Road(f"{a1._economy_tag},{clean_things_text}")
    ...
    home_text = "home"
    home_road = Road(f"{a1._economy_tag},{home_text}")
    ...
    a1.set_time_hreg_ideas(c400_count=7)
    daytime_road = Road(f"{a1._economy_tag},time,jajatime,day")
    open_8am = 480
    nigh_8am = 480
...
def test_Issue116Resolved_correctlySetsTaskAsTrue():
    ...
    jajatime_road = f"{a1._economy_tag},time,jajatime"
    ...
    night_road = f"{a1._economy_tag},D&B,{night_text}"
