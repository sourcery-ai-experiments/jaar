...
def test_get_time_():
    ...
    #         print(
    #             f"{idea_x._walk=} \t{idea_x._label=} {idea_x._begin=} {idea_x._close=} {idea_x._addin=}"
    #         )
...
#     h_cx = examples.get_contract_base_time_example()
#     c400_count = 6
...
# work_idea = contract_x._kids["work"]
...
# cx = examples.get_contract_gregorian_years()
