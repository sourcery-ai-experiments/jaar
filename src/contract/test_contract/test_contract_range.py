...
def test_contractAddingIdeaWithAddinCorrectlyTransformsRangeScenario1():
    ...
    cx.add_idea(walk=cx._healing_handle, idea_kid=idea_kid_l1)
    l1_road = f"{cx._healing_handle},{l1}"
...
def test_get_idea_ranged_kids_CorrectlyReturnsAllChildren():
    ...
    # WHEN
    weekunit_road = f"{cx._healing_handle},time,tech,week"
...
def test_get_idea_ranged_kids_CorrectlyReturnsSomeChildrenScen2():
    ...
    # WHEN THEN
    week_road = f"{cx._healing_handle},time,tech,week"
