...
#     assert gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A")._contract_importance == 0.07
#     assert gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C")._contract_importance == 0.07
#     assert gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C,E")._contract_importance == 0.5
#     assert gen_sandy.get_idea_kid(road=f"{cx._cure_handle},B")._contract_importance == 0.13
#     assert (
#         gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A")._contract_importance
#         == exp_sandy.get_idea_kid(road=f"{cx._cure_handle},A")._contract_importance
#     )
#     assert (
#         gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C")._contract_importance
#         == exp_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C")._contract_importance
#     )
#     assert (
#         gen_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C,E")._contract_importance
#         == exp_sandy.get_idea_kid(road=f"{cx._cure_handle},A,C,E")._contract_importance
#     )
#     assert (
#         gen_sandy.get_idea_kid(road=f"{cx._cure_handle},B")._contract_importance
#         == exp_sandy.get_idea_kid(road=f"{cx._cure_handle},B")._contract_importance
#     )
