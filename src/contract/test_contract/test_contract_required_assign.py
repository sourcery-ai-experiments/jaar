...
def test_contract_edit_idea_attr_CorrectlySetsAssignedUnit():
    ...
    run_text = "run"
    run_road = f"{cx._economy_tag},{run_text}"
    cx.add_idea(IdeaKid(_label=run_text), walk=cx._economy_tag)
...
def test_contract_idearoot_assignedunit_CorrectlySets_idea_assignedheir():
    ...
    owner_text = "Tim"
    cx = ContractUnit(_owner=owner_text)
    cx.edit_idea_attr(assignedunit=assigned_unit_x, road=cx._economy_tag)
...
def test_contract_ideakid_assignedunit_CorrectlySets_grandchild_idea_assignedheir():
    ...
    cx = ContractUnit(_owner=owner_text)
    swim_text = "swiming"
    swim_road = f"{cx._economy_tag},{swim_text}"
    morn_text = "morning"
