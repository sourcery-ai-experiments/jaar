...
def test_idea_core_exists():
    ...
    assert new_obj._contract_importance is None
    assert new_obj._contract_coin_onset is None
    assert new_obj._contract_coin_cease is None
...
def test_idea_core_set_requiredheirsCorrectlyTakesFromOutside():
    ...
    idea.set_requiredheirs(requiredheirs=requiredheirs, contract_idea_dict=None)
...
def test_idea_core_set_requiredheirsCorrectlyTakesFromSelf():
    ...
    assert idea._requiredheirs is None
    idea.set_requiredheirs(requiredheirs=None, contract_idea_dict=None)
    assert idea._requiredheirs == requiredheirs
...
def test_idea_get_requiredheir_correctlyReturnsRequiredHeir():
    ...
    idea_x.set_requiredheirs(requiredheirs=required_heirs_x, contract_idea_dict=None)
...
def test_idea_set_assignedunit_empty_if_null():
    ...
    # WHEN
    idea_x.set_assignedheir(parent_assignheir=None, contract_groups=None)
