...
from src.market.clerk import ClerkUnit, clerkunit_shop
...
def test_ClerkUnit_exists():
    ...
    # WHEN
    bob_clerkadmin = ClerkUnit(bob_text, env_dir, get_temp_market_id())

    # THEN
    assert bob_clerkadmin._clerk_id != None
    assert bob_clerkadmin._env_dir != None
    assert bob_clerkadmin._market_id != None
