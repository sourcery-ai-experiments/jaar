...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def set_acptfact_time_open_5daysago(self):
        ...
        road_minute = f"{self.agenda_x._culture_id},time,jajatime"
    ...
    def _commit_file_save(self):
        ...
        #     file_name=f"{self.agenda_x._culture_id}.json",
    ...
    def populate_intent_table_row(self, row, intent_item):
        ...
        if ax._requiredunits.get(f"{self.agenda_x._culture_id},time,jajatime") != None:
            jajatime_required = ax._requiredunits.get(
                f"{self.agenda_x._culture_id},time,jajatime"
            )
    ...
    def intent_task_display(self, intent_item):
        ...
        if (
            intent_item._requiredunits.get(f"{self.agenda_x._culture_id},time,jajatime")
            != None
        ):
            ...
            sufffact_x = jajatime_required.sufffacts.get(
                f"{self.agenda_x._culture_id},time,jajatime,day"
            )
            if sufffact_x != None:
