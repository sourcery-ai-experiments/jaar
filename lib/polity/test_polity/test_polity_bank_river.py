...
def test_polity_set_river_sphere_for_agent_CorrectlyPopulatesriver_tallyTable02(
    env_dir_setup_cleanup,
):
...
def test_polity_set_river_sphere_for_agent_CorrectlyPopulatesriver_tallyTable03(
    env_dir_setup_cleanup,
):
...
def test_polity_set_river_sphere_for_agent_CorrectlyDeletesPreviousRiver(
    env_dir_setup_cleanup,
):
    # GIVEN 4 agents, 100% of river flows to sal
    polity_name = get_temp_env_name()
