...
from lib.agent.brand import brandlink_shop
...
def test_agent_edit_idea_attr_IsAbleToEditAnyAncestor_Idea():
    ...
    # _brandlink: dict = None,
    agent_x._idearoot._kids[work_text]._brandlinks = {
        "fun": brandlink_shop(name="fun", creditor_weight=1, debtor_weight=7)
    }
    _brandlinks = agent_x._idearoot._kids[work_text]._brandlinks
    assert _brandlinks == {
        "fun": brandlink_shop(name="fun", creditor_weight=1, debtor_weight=7)
    }
    agent_x.edit_idea_attr(
        road=work_road,
        brandlink=brandlink_shop(name="fun", creditor_weight=4, debtor_weight=8),
    )
    assert agent_x._idearoot._kids[work_text]._brandlinks == {
        "fun": brandlink_shop(name="fun", creditor_weight=4, debtor_weight=8)
    }
